...
var mybotSearchcx = '014298403546801028055:a8tfeuwzoce';
mybotLang = 'english';
mybottlang = 'en';
botSearchDisplayText = 'Here is what I have got for you!';
botSearchDisplayTextNF = 'We could not find anything with this query!';
botSearchPlaceholder = 'Ask Me Anything...';
imageSearchExp = 1;
mybotslickClose = 0;
mybotslickCloseText = "Close this slide";
...
mybotlinkAppend = '?utm_source=Unibots&utm_medium=Direct&utm_campaign=123telugu';
...
mybotCat4 = 'Gallery';
mybotCat5 = 'Videos';
mybotCat6 = 'Interviews';
mybotCatMore = 'More Categories';

mybotCat1e = '\u0c35\u0c3e\u0c30\u0c4d\u0c24\u0c32\u0c41';
mybotCat2e = '\u0c30\u0c3e\u0c1c\u0c15\u0c40\u0c2f \u0c35\u0c3e\u0c30\u0c4d\u0c24\u0c32\u0c41';
mybotCat3e = '\u0c38\u0c2e\u0c40\u0c15\u0c4d\u0c37\u0c32\u0c41';
mybotCat4e = '\u0c17\u0c4d\u0c2f\u0c3e\u0c32\u0c30\u0c40';
mybotCat5e = '\u0c35\u0c40\u0c21\u0c3f\u0c2f\u0c4b\u0c32\u0c41';
mybotCat6e = '\u0c15\u0c4d\u0c30\u0c40\u0c21\u0c32\u0c41';
...
function function1(){
openNewsCategoryWise('news',0,mybotLang,mybotCat1,mybotCat1);};
function function2(){
openNewsCategoryWise('polls',0,mybotLang,mybotCat2,mybotCat2);};
function function3(){
openNewsCategoryWise('reviews',0,mybotLang,mybotCat3,mybotCat3);};
function function4(){
openNewsCategoryWise('gallery',0,mybotLang,mybotCat4,mybotCat4);};
function function5(){
openNewsCategoryWise('videos',0,mybotLang,mybotCat5,mybotCat5);};
function function6(){
openNewsCategoryWise('interviews',0,mybotLang,mybotCat6,mybotCat6);};
function function7(){
changeNewsCategories();};

function function1e(){
openNewsCategoryWise('newse',0,mybotLang,mybotCat1e,mybotCat1e);};
function function2e(){
openNewsCategoryWise('politicse',0,mybotLang,mybotCat2e,mybotCat2e);};
function function3e(){
openNewsCategoryWise('reviewe',0,mybotLang,mybotCat3e,mybotCat3e);};
function function4e(){
openNewsCategoryWise('gallerye',0,mybotLang,mybotCat4e,mybotCat4e);};
function function5e(){
openNewsCategoryWise('videos',0,mybotLang,mybotCat5e,mybotCat5e);};
function function6e(){
openNewsCategoryWise('interviewse',0,mybotLang,mybotCat6e,mybotCat6e);};
function function7e(){
changeNewsCategories();};
...
mybotBundle1e = '<div class="botSmartButton"><span class="botSmartButtonSpan" onclick="function1e()">'+mybotCat1e+'</span><span class="botSmartButtonSpan2" onclick="function2e()">'+mybotCat2e+'</span></div><div class="botSmartButton"><span class="botSmartButtonSpan" onclick="function3e()">'+mybotCat3e+'</span><span class="botSmartButtonSpan2" onclick="function7e()">'+mybotCatMoree+'</span></div>';
...
mybotClosevar = '<img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/123telugu/close.svg">';
mybotCloseInVar = '<img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/123telugu/close.svg" style="width: 20px; display: block;">';

mybotFace = '<div class="mybotcontainer" id="botfaceclosed"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/123telugu/logo-01.svg" class="mybotcard mybotcard1 mybotimgprofile"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/123telugu/news-01.svg" class="mybotcard mybotcard2 mybotimgprofile"></div>';

mybotFaceOpen = '<div class="mybotcontainer bot_p_img" id="botfaceopen"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/123telugu/logo-01.svg" class="mybotcard mybotcard1"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/123telugu/news-01.svg" class="mybotcard mybotcard2"></div>';

function mybotCustomFunction() {
  if(typeof mybotspecialEvent !== 'undefined' && mybotspecialEvent == 1){
    mybotFace = '<div class="mybotcontainer" id="botfaceclosed"><div class="mybotcard"><div class="mybotfront"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/gandhi.png" class="mybotimgprofile mybotCardImg"></div><div class="mybotback"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/gandhi.png" class="mybotimgprofile mybotCardImg"></div></div></div>';
  }
  boturl = window.location.href;
  boturl = boturl.split('https://www.123telugu.com/telugu/');
  if((boturl.length == 2) || (boturl == "localhost")){
    myBotMenuCustomTopText='\u0c39\u0c3e\u0c2f\u0c4d\u0021 \u0c10 \u0c05\u0c02 \u0c67\u0c68\u0c69\u0c24\u0c46\u0c32\u0c41\u0c17\u0c41 \u0c2c\u0c3e\u0c1f\u0c4d\u002e \u0c10 \u0c05\u0c02 \u0c39\u0c3f\u0c2f\u0c30\u0c4d \u0c24\u0c4b \u0c17\u0c48\u0c21\u0c4d \u0c24\u0c4d\u0c30\u0c41 \u0c26\u0c3f \u0c35\u0c46\u0c2c\u0c4d\u0c38\u0c48\u0c1f\u0c41\u002e \u0c39\u0c3f\u0c2f\u0c30\u0c4d \u0c05\u0c30\u0c4d \u0c38\u0c02 \u0c2a\u0c3e\u0c2a\u0c41\u0c32\u0c30\u0c4d \u0c1f\u0c3e\u0c2a\u0c3f\u0c15\u0c4d\u0c38\u0c4d \u0c10 \u0c39\u0c35\u0c46 \u0c2b\u0c4c\u0c02\u0c21\u0c4d \u0c2b\u0c30\u0c4d \u0c2f\u0c41\u002e';
    myBotMenuCustomTopTextCats = '\u0c2e\u0c40\u0c30\u0c41\u0020\u0c0e\u0c02\u0c1a\u0c41\u0c15\u0c4b\u0c35\u0c21\u0c3e\u0c28\u0c3f\u0c15\u0c3f\u0020\u0c07\u0c15\u0c4d\u0c15\u0c21\u0020\u0c15\u0c4a\u0c28\u0c4d\u0c28\u0c3f\u0020\u0c35\u0c30\u0c4d\u0c17\u0c3e\u0c32\u0c41\u0020\u0c09\u0c28\u0c4d\u0c28\u0c3e\u0c2f\u0c3f\u0021';
    mybotContextTitle = '123telugu';
    mybotSearchKey = 'AIzaSyACypoI-jiI9LnTHKy2-pEaURiB7QTw3VQ';
    mybotSearchcx = '014298403546801028055:a8tfeuwzoce';
    mybotLang = 'telugu';
    mybottlang = 'te';
    ...
    document.getElementById('newsBotBundle1').innerHTML=mybotBundle1e;
    document.getElementById('newsBotBundle2').innerHTML=mybotBundle2e;
...
function mybotClickCount(count){
	if(mybotClickCountEnabled){
		...
		url = 'https://api.warw.in/123telugu/bot_open';
...
function botProfane(text, count, search, charCode) {
	...
	var request = new XMLHttpRequest();
	url = 'https://api.warw.in/123telugu/profane/'+text;
	request.open('GET', url, true);
	request.setRequestHeader('Auth-Token', AUTH_TOKEN);
	request.onload = function() {
		if (request.status >= 200 && request.status < 400) {
...
function mybotCategoryClickCount(title, count){
	...
	var request = new XMLHttpRequest();
	url = 'https://api.warw.in/123telugu/cat_click';
	request.open('POST', url, true);
	request.setRequestHeader('Auth-Token', AUTH_TOKEN);
...
function updateAuthToken(callback) {
	var request = new XMLHttpRequest();
	request.open('GET', 'https://api.warw.in/123telugu/get_token', true);
	request.onload = function() {
		if (request.status >= 200 && request.status < 400) {
			var data = request.responseText;
			data = JSON.parse(data);
...
function openNewsCategoryWise(category, count, lang, buttonText, displayText) {
	...
	var request = new XMLHttpRequest();
	url = 'https://api.warw.in/123telugu/get_articles/'+cat;
	request.open('GET', url, true);
	request.setRequestHeader('Auth-Token', AUTH_TOKEN);
	request.onload = function() {
		if (request.status >= 200 && request.status < 400) {
...
function addReaction(position, reaction, count, skipRequest) {
	...
	if(skipRequest == false) {
		var request = new XMLHttpRequest();
		request.open('POST', 'https://api.warw.in/123telugu/add_reaction', true);
		request.setRequestHeader('Auth-Token', AUTH_TOKEN);
		request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		request.onload = function() {
			if (request.status >= 200 && request.status < 400) {
...
function mybotSearchStore(count, term){
	...
	var request = new XMLHttpRequest();
	url = 'https://api.warw.in/123telugu/search';
	request.open('POST', url, true);
	request.setRequestHeader('Auth-Token', AUTH_TOKEN);
	request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	request.onload = function() {
