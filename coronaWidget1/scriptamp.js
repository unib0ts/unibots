...
mybotGACode = 'UA-159929110-22';

mybotClientName = 'telegraph';
mybotLocalDataPlacement = 0;
mybotLastSlideLocalDataPresent = 0;
mybotDynamicRedirectLinkEnabled = 1;
mybotAppendReferLink = '?ref=corona-counter-widget';
...
mybotBottomBarContentLive = '<div class="mybotBottomBarLogo mybotBottomBarLive"><span class="mybotPoweredBy">Virus scan-</span><span class="mybotLiveCasesText mybotPoweredByBrand"> Live</span></div>';

function mybotCustomFunction() {
  document.getElementById('adSmall').innerHTML=mybotadSmall;
  document.getElementById('gabywa').innerHTML=mybotgabywa;
  // document.getElementById('mybotCloseUCB').innerHTML=mybotClosevar;
  // document.getElementById('mybotClose').innerHTML=mybotClosevar;
  // document.querySelector('.mybotPoweredByBrand').innerHTML='UNIBOTS';
  document.getElementById('mybotWorldCases').innerText='World';
  document.getElementById('mybotWorldDeathsCases').innerText='World Deaths';
  document.getElementById('mybotCountryName').innerText='India';
  document.getElementById('mybotCountryName2').innerText='India Deaths';
...
if(mybotampEnabled == 1){
    ...
    document.getElementById('mybotstage').classList.add('mybotAmpStage');
  }
}
