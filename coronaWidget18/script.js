...
mybotGACode = 'UA-159929110-12';

mybotCountryNameLang = '\u092d\u093e\u0930\u0924 \u092e\u0947\u0902 \u092e\u093e\u092e\u0932\u0947';
mybotCountryName2Lang = '\u092d\u093e\u0930\u0924 \u092e\u0947\u0902 \u092e\u094c\u0924';
...
mybotClosevar = '<img src="https://api.warw.in/coronaWidget17/img/close.svg">';
// mybotTopBarContent = '<span class="">'+mybotTopBarText+'</span>';
...
mybotFace4Content = '';
mybotFace6Content = '';
mybotFace5Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent"><div class="mybotSummary"><span class="mybotLocation" id="mybotPrecautionText"></span><div class="mybotCount" id="mybotPrecautionTextCount"></div></div></div><div class="mybotBottomBar mybotBottomBarLive"><span class="">COVID-19 Cases</span></div>';
...
function mybotCustomFunction() {
 ...
 // document.getElementById('mybotPrecautionText').innerText='\u09ac\u09bf\u09b6\u09cd\u09ac\u09c7 \u0986\u0995\u09cd\u09b0\u09be\u09a8\u09cd\u09a4';
  ...
  document.getElementById('mybotWorldCases').innerHTML=mybotCountryNameLang;
  document.getElementById('mybotWorldDeathsCases').innerHTML=mybotCountryName2Lang;
  document.getElementById('mybotPrecautionText').innerHTML=mybotCountryNameLang;
  document.querySelector('.mybotface1, .mybotface3 ,.mybotface5').addEventListener('click', function() {
    window.open('https://www.prabhatkhabar.com/national/coronavirus-outbreak-in-india-live-updates-of-curfew-deaths-infected-cases-lockdown-in-maharashtra-delhi-rajasthan-up-bihar-jharkhand-know-all-latest-information?utm_source=unibots&utm_medium=widget&utm_campaign=coronavirus', '_self');
  });
  document.querySelector('.mybotface2, .mybotface6').addEventListener('click', function() {
    window.open('https://epaper.prabhatkhabar.com/?utm_source=unibots&utm_medium=widget&utm_campaign=coronavirus', '_self');
  });
  document.querySelector('.mybotface4').addEventListener('click', function() {
    window.open('https://www.prabhatkhabar.com/get-apps/?utm_source=unibots&utm_medium=widget&utm_campaign=coronavirus', '_self');
  });
  // if(mobileCheck()){
...
function loadAdCustom() {
  ...
  s2.src = "https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/script/adScriptPBK.js";
...
function mybotClickCount(count){
	if(mybotClickCountEnabled){
		...
		url = 'https://api.warw.in/coronaWidget17/bot_open';
...
function updateAuthToken(callback) {
	var request = new XMLHttpRequest();
	request.open('GET', 'https://api.warw.in/coronaWidget17/get_token', true);
	request.onload = function() {
		if (request.status >= 200 && request.status < 400) {
			var data = request.responseText;
			data = JSON.parse(data);
...
function getScore() {
	var request = new XMLHttpRequest();
	url = 'https://api.warw.in/coronaWidget17/'+mybotStatAPI;
	// console.log(url);
	request.open('GET', url, true);
	request.onload = function() {
		if (request.status >= 200 && request.status < 400) {
