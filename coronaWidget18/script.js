...
function mybotCustomFunction() {
 ...
 // document.getElementById('mybotPrecautionText').innerText='\u09ac\u09bf\u09b6\u09cd\u09ac\u09c7 \u0986\u0995\u09cd\u09b0\u09be\u09a8\u09cd\u09a4';
  ...
  document.querySelector('.mybotface1, .mybotface3 ,.mybotface5').addEventListener('click', function() {
    window.open('https://www.prabhatkhabar.com/national/coronavirus-outbreak-live-update-latest-news-of-india-and-global-covid-19?utm_source=unibots&utm_medium=widget&utm_campaign=coronavirus', '_self');
  });
