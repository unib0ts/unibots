mybotMultiIconTimestamps = [
  [1617975000, 1622397600]
];
mybotMatchEnabledCrnFlag =0;
var mybotMultipleIconsEnabled=1;
// mybotloadCricWidgetScript = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/iplbowl91/script.js';
...
if (botsiteurl == 'tv9gujarati.com') {
  mybotStateData =1;
  mybotStateName = 'Gujarat';
}
else if (botsiteurl == 'www.tv9hindi.com' || botsiteurl == 'veegam.tv9hindi.com' || botsiteurl == 'www.veegam.tv9hindi.com') {
  mybotStateData =0;
  mybotStateName = 'Andhra Pradesh';
}
else if (botsiteurl == 'tv9kannada.com') {
  mybotStateData =1;
  mybotStateName = 'Karnataka';
}
else if (botsiteurl == 'www.tv9marathi.com') {
  mybotStateData =1;
  mybotStateName = 'Maharashtra';
}
else if (botsiteurl == 'tv9telugu.com') {
  mybotStateData =1;
  mybotStateName = 'Andhra Pradesh';
}
else if (botsiteurl == 'www.tv9bangla.com') {
  mybotStateData =1;
  mybotStateName = 'West Bengal';
}
else if (botsiteurl == 'tv9news.com') {
  mybotStateData =0;
  // mybotStateName = 'Andhra Pradesh';
}
...
mybotGACode = 'G-D8VH399PDP';

mybotadSmall = '<div id="div-gpt-ad-1601027213539-0"></div>';
mybotadSmallM = '';
...
mybotFace1Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent styles-m__seven-story-7s__2DyWO bg-diamond-dark"><div class="mybotSummary"><span class="mybotLocation" id="mybotStateCasesTxt"></span><div class="mybotCount" id="mybotStateCases"></div></div></div><div class="mybotBottomBar"><span class="">COVID-19 Cases</span></div>';
mybotFace2Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent styles-m__seven-story-7s__2DyWO bg-diamond-dark"><div class="mybotSummary"><span class="mybotLocation" id="mybotStateRecoveredTxt">World Deaths</span><div class="mybotCount" id="mybotStateRecovered"></div></div></div><div class="mybotBottomBar"><span class="">COVID-19 Cases</span></div>';
mybotFace3Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent styles-m__seven-story-7s__2DyWO bg-diamond-dark"><div class="mybotSummary"><span class="mybotLocation" id="mybotCountryName"></span><div class="mybotCount" id="mybotCountryCount"></div></div></div><div class="mybotBottomBar"><span class="">COVID-19 Cases</span></div>';
mybotFace4Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent styles-m__seven-story-7s__2DyWO bg-diamond-dark"><div class="mybotSummary"><span class="mybotLocation" id="mybotCountryRecoveredTxt"></span><div class="mybotCount" id="mybotCountryRecovered"></div></div></div><div class="mybotBottomBar"><span class="">COVID-19 Cases</span></div>';
mybotFace5Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent styles-m__seven-story-7s__2DyWO bg-diamond-dark"><div class="mybotSummary"><span class="mybotLocation" id="mybotWorldCases">World Cases</span><div class="mybotCount" id="mybotWorldCount"></div></div></div><div class="mybotBottomBar"><span class="">COVID-19 Cases</span></div>';
mybotFace6Content = '';
mybotFace6ContentCutstm = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent styles-m__seven-story-7s__2DyWO bg-diamond-dark"><div class="mybotSummary"><span class="mybotLocation" id="">Stay Safe</span><div class="mybotCount" id=""></div></div></div><div class="mybotBottomBar"><span class="">COVID-19 Cases</span></div>';

function mybotCustomFunction() {
  botsiteurl=window.location.hostname;
  document.getElementById('gabywa').innerHTML=mybotgabywa;
  document.getElementById('mybotClose').innerHTML=mybotClosevar;
  if (botsiteurl == 'tv9gujarati.com' || botsiteurl == 'tv9kannada.com' || botsiteurl == 'tv9telugu.com' || botsiteurl == 'www.tv9bangla.com' || botsiteurl == 'www.tv9marathi.com') {
    ...
    document.querySelector('.mybotface2').innerHTML='';
    document.querySelector('.mybotface6').innerHTML=mybotFace6ContentCutstm;
  }


   if (!mobileCheck()) {
     document.getElementById('dragItem').style.bottom="80px";
   }
 if (botsiteurl == 'tv9gujarati.com') {
   if (mobileCheck()) {
     document.getElementById('adSmall').innerHTML='';
     if (document.getElementById('ub-ads')) {
      document.getElementById('ub-ads').innerHTML = '<div id="div-gpt-ad-1618307155135-0"></div>';
     }
   }else {
    document.getElementById('adSmall').innerHTML='<div id="div-gpt-ad-1618307202658-0"></div>';
   }
   document.querySelector('.mybotface6').style.background="url('https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/coronaWidget190/tv9gujrati.jpg')";
 }
 if (botsiteurl == 'www.tv9hindi.com' || botsiteurl == 'veegam.tv9hindi.com' || botsiteurl == 'www.veegam.tv9hindi.com') {
   if (mobileCheck()) {
     document.getElementById('adSmall').innerHTML='';
     if (document.getElementById('ub-ads')) {
      document.getElementById('ub-ads').innerHTML = '<div id="div-gpt-ad-1618307254033-0"></div>';
     }
   }else {
    document.getElementById('adSmall').innerHTML='<div id="div-gpt-ad-1618307321739-0"></div>';
   }
   document.querySelector('.mybotface2').style.background="url('https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/coronaWidget190/tv9hindi.jpg')";
 }
 if (botsiteurl == 'tv9kannada.com') {
   if (mobileCheck()) {
     document.getElementById('adSmall').innerHTML='';
     if (document.getElementById('ub-ads')) {
      document.getElementById('ub-ads').innerHTML = '<div id="div-gpt-ad-1618307365902-0"></div>';
     }
   }else {
    document.getElementById('adSmall').innerHTML='<div id="div-gpt-ad-1618307397992-0"></div>';
   }
   document.querySelector('.mybotface6').style.background="url('https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/coronaWidget190/tv9kannada.jpg')";
 }
 if (botsiteurl == 'www.tv9marathi.com') {
   if (mobileCheck()) {
     document.getElementById('adSmall').innerHTML='';
     if (document.getElementById('ub-ads')) {
      document.getElementById('ub-ads').innerHTML = '<div id="div-gpt-ad-1618307427794-0"></div>';
     }
   }else {
    document.getElementById('adSmall').innerHTML='<div id="div-gpt-ad-1618307454537-0"></div>';
   }
   document.querySelector('.mybotface6').style.background="url('https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/coronaWidget190/tv9marathi.jpg')";
 }
 if (botsiteurl == 'tv9telugu.com') {
 if (mobileCheck()) {
   document.getElementById('adSmall').innerHTML='';
   if (document.getElementById('ub-ads')) {
    document.getElementById('ub-ads').innerHTML = '<div id="div-gpt-ad-1618307494648-0"></div>';
   }
 }else {
  document.getElementById('adSmall').innerHTML='<div id="div-gpt-ad-1618307531030-0"></div>';
 }
 document.querySelector('.mybotface6').style.background="url('https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/coronaWidget190/tv9telugu.jpg')";
}
 if (botsiteurl == 'www.tv9bangla.com') {
if (mobileCheck()) {
 document.getElementById('adSmall').innerHTML='';
 if (document.getElementById('ub-ads')) {
  document.getElementById('ub-ads').innerHTML = '<div id="div-gpt-ad-1618386943569-0"></div>';
 }
}else {
document.getElementById('adSmall').innerHTML='<div id="div-gpt-ad-1618386989043-0"></div>';
}
document.querySelector('.mybotface6').style.background="url('https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/coronaWidget190/tv9bangla.png')";
}
 if (botsiteurl == 'tv9news.com') {
   if (mobileCheck()) {
   document.getElementById('adSmall').innerHTML='';
     if (document.getElementById('ub-ads')) {
      document.getElementById('ub-ads').innerHTML = '<div id="div-gpt-ad-1618386943569-0"></div>';
     ...
     document.querySelector('.mybotface2').style.background="url('https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/coronaWidget190/tv9news.jpg')";
 }
 ...
 //       if (botsiteurl == 'tv9gujarati.com') {
 //          window.open('https://www.tv9gujarati.com/sports/cricket-news/series/ipl-2021/live-score?utm_source=unibots&utm_medium=iplwidget', '_blank');
 //      }
 //     if (botsiteurl == 'www.tv9hindi.com' || botsiteurl == 'veegam.tv9hindi.com' || botsiteurl == 'www.veegam.tv9hindi.com') {
 //         window.open('https://www.tv9hindi.com/sports/cricket-news/series/ipl-2021/live-score?utm_source=unibots&utm_medium=iplwidget', '_blank');
 //      }
 //      if (botsiteurl == 'tv9kannada.com') {
 //        window.open('https://www.tv9kannada.com/sports/cricket-news/series/ipl-2021/live-score?utm_source=unibots&utm_medium=iplwidget', '_blank');
 //     }
 //     if (botsiteurl == 'www.tv9marathi.com') {
 //         window.open('https://www.tv9marathi.com/sports/cricket-news/series/ipl-2021/live-score?utm_source=unibots&utm_medium=iplwidget', '_blank');
 //      }
 //    if (botsiteurl == 'tv9telugu.com') {
 //        window.open('https://www.tv9telugu.com/sports/cricket-news/series/ipl-2021/live-score?utm_source=unibots&utm_medium=iplwidget', '_blank');
 //     }
 //     if (botsiteurl == 'www.tv9bangla.com') {
 //         window.open('https://www.tv9bangla.com/sports/cricket-news/series/ipl-2021/live-score?utm_source=unibots&utm_medium=iplwidget', '_blank');
 //      }
 //      if (botsiteurl == 'tv9news.com') {
 //          window.open('https://tv9news.com/sports/cricket-news/series/ipl-2021/live-score?utm_source=unibots&utm_medium=iplwidget', '_blank');
 //       }
 //    }
 //    setTimeout(function(){
...
function loadAdCustom() {
  var s3 = document.createElement('script');
		 ...
		 s0.onload=function(){
		   ...
		   url = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/script/adScriptTv9telugu.js?cb='+cachebuster;
...
function placeBotAndAd(){
   ...
   document.getElementById('mybot-ad-tag').style.display = 'none';
	...
	if (botPosition=='right' || typeof botPosition==='undefined' ){
		...
		stageElement.classList.add("mybotstage");
	}
...
function mybotStart(){
	if(typeof mybotMatchEnabledCrnFlag !== 'undefined' && mybotMatchEnabledCrnFlag ==1){
...
function putData(mybotDataSet) {
 if (typeof mybotCustomData !== 'undefined' && mybotCustomData == 1) {
	 if (mybotDataSet["data"].num !== undefined) {
		 mybotCustomdata = mybotDataSet["data"]["num"];
		 mybotCustomdata_num1 = mybotCustomdata.num1;
		 mybotCustomdata_num2 = mybotCustomdata.num2;
		 mybotCustomdata_num3 = mybotCustomdata.num3;
		 mybotCustomdata_num4 = mybotCustomdata.num4;
		 mybotCustomdata_num5 = mybotCustomdata.num5;
		 if(mybotCustomdata_num1 != 'none'){
			 document.getElementById('mybotCustomdataNum1').innerText = mybotCustomdata_num1;
		 }
		 if(mybotCustomdata_num2 != 'none'){
			 document.getElementById('mybotCustomdataNum2').innerText = mybotCustomdata_num2;
		 }
		 if(mybotCustomdata_num3 != 'none'){
			 document.getElementById('mybotCustomdataNum3').innerText = mybotCustomdata_num3;
		 }
		 if(mybotCustomdata_num4 != 'none'){
			 document.getElementById('mybotCustomdataNum4').innerText = mybotCustomdata_num4;
		 }
		 if(mybotCustomdata_num5 != 'none'){
			 document.getElementById('mybotCustomdataNum5').innerText = mybotCustomdata_num5;
		 }
	 }
		...
		if(mybotDataSet["data"].text !== undefined){
			...
			if(text1 != 'none'){
				document.getElementById('mybotCustomdataText1').innerText = text1;
			}
			if(text2 != 'none'){
				document.getElementById('mybotCustomdataText2').innerText = text2;
			}
			if(text3 != 'none'){
				document.getElementById('mybotCustomdataText3').innerText = text3;
			}
			if(text4 != 'none'){
				document.getElementById('mybotCustomdataText4').innerText = text4;
			}
			if(text5 != 'none'){
				document.getElementById('mybotCustomdataText5').innerText = text5;
			}
			if(text6 != 'none'){
				if (document.getElementById('mybotCustomdataText6')) {
				 document.getElementById('mybotCustomdataText6').innerText = text6;
				}
			}
		}
		if(typeof mybotCustomMultipleRedirectLinks !== undefined && mybotCustomMultipleRedirectLinks ==1){
			redirectLink1 = mybotDataSet["data"].link.link1;
			redirectLink2 = mybotDataSet["data"].link.link2;
			redirectLink3 = mybotDataSet["data"].link.link3;
			redirectLink4 = mybotDataSet["data"].link.link4;
			redirectLink5 = mybotDataSet["data"].link.link5;
			redirectLink6 = mybotDataSet["data"].link.link6;
			document.querySelector('.mybotface1').addEventListener('click', function() {
				window.open(redirectLink1, '_blank');
			});
			document.querySelector('.mybotface2').addEventListener('click', function() {
				window.open(redirectLink2, '_blank');
			});
			document.querySelector('.mybotface3').addEventListener('click', function() {
				window.open(redirectLink3, '_blank');
			});
			document.querySelector('.mybotface4').addEventListener('click', function() {
				window.open(redirectLink4, '_blank');
			});
			document.querySelector('.mybotface5').addEventListener('click', function() {
				window.open(redirectLink5, '_blank');
			});
			if (redirectLink6 !='none') {
				document.querySelector('.mybotface6').addEventListener('click', function() {
				 window.open(redirectLink6, '_blank');
			 });
			}
		}
	}
	else if (typeof mybotCurrencyData !== 'undefined' && mybotCurrencyData == 1) {
		bitcoin_price = mybotDataSet["data"].Bitcoin.price;
		gas_price = mybotDataSet["data"].Gas.price;
		gold_price = mybotDataSet["data"].Gold.price;
		gold_sell = mybotDataSet["data"].Gold.sell;
		oil_price = mybotDataSet["data"].Oil.price;
		usd_exchangerate = mybotDataSet["data"].USD.buyTransfer;
		usd_sell = mybotDataSet["data"].USD.sell;

		// document.getElementById('mybotGoldPrice').innerText = gold_price;
		document.getElementById('mybotGoldSell').innerText = gold_sell;
		// document.getElementById('mybotUSDexchangeRate').innerText = usd_exchangerate;
		document.getElementById('mybotUSDSell').innerText = usd_sell;
		document.getElementById('mybotBitcoinPrice').innerText = bitcoin_price;
		document.getElementById('mybotOilPrice').innerText = oil_price;
		document.getElementById('mybotGasPrice').innerText = gas_price;
	}
	else if(typeof mybotAnotherCountryData !== 'undefined' && mybotAnotherCountryData == 1){
		...
		if (typeof mybotCustomText !== 'undefined' && mybotCustomText == 1) {
			...
			if (document.getElementById('mybotCountryRecovered')) {
		...
		if (typeof mybotCountryname2 !=='undefined'){
		  ...
		  country2_name = mybotCountrydata2.location;
			...
			if (typeof mybotStateName2 !=='undefined'){
				...
				if (document.getElementById('mybotState2Recovered')) {
					document.getElementById('mybotState2Recovered').innerText = state2_recovered;
				}
				if (document.getElementById('mybotState2RecoveredTxt')) {
...
function mybotloadNewsbotWidget(){
  ...
  el[0].parentNode.removeChild(el[0]);
	...
	var cachebuster = Math.round(new Date().getTime() / 1000);
	url = mybotloadNewsbotScript+'?cb='+cachebuster;
	s = document.createElement('script');
	s.src = url;
  document.getElementsByTagName('head')[0].appendChild(s);
}

function mybotloadCricWidgetCrn(){
  el = document.getElementsByTagName('mybot');
  el[0].parentNode.removeChild(el[0]);
