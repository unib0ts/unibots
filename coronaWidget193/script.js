...
mybotadSmallT = '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><ins class="adsbygoogle" style="display:inline-block;width:300px;height:100px" data-ad-client="ca-pub-6376205116838079" data-ad-slot="4976929044"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});</script>';
mybotadSmall = '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><ins class="adsbygoogle" style="display:inline-block;width:320px;height:50px" data-ad-client="ca-pub-6376205116838079" data-ad-slot="8780442689"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});</script>';
mybotadTarget = '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><ins class="adsbygoogle" style="display:inline-block;width:125px;height:125px" data-ad-client="ca-pub-6376205116838079" data-ad-slot="3117052467"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});</script>';
...
function mybotCustomFunction() {
 ...
 if (!mobileCheck()) {
   ...
   if (document.getElementById('unibots-ad')) {
     document.getElementById('unibots-ad').innerHTML=mybotadSmallT;
     loadAd('unibots-ad')
   }
   document.getElementById("ub_ads").style.left = '5px';
   document.getElementById("ub_ads").style.right = 'unset';
 }
 //ads timeout
 ...
 document.getElementById("dragItem").style.display = "none";
   ...
   setTimeout(function () {
     ...
     setTimeout(function () {
      ...
      document.getElementById("dragItem").style.display = "none";
       if (!mobileCheck()) {
         document.getElementById('ub_ads').innerHTML='<div id="div-gpt-ad-1618241175552-0"></div>';
          document.getElementById('adSmall').innerHTML='<div id="div-gpt-ad-1618224026370-0"></div>';
       }else {
         document.getElementById('ub_ads').innerHTML='<div id="div-gpt-ad-1618241175552-0"></div>';
         if (document.getElementById('unibots-ad')) {
           document.getElementById('unibots-ad').innerHTML='<div id="div-gpt-ad-1618055682084-0"></div>';
         }
       }
       loadAdCustomUb();
	...
	// if (document.getElementById('unibots-ad')) {
		var s3 = document.createElement('script');
	 	 ...
	 	 s0.onload=function(){
	 	   ...
	 	   url = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/script/adScriptAJ.js?cb='+cachebuster;
