...
// mybotStateData =0;
// mybotStateName = 'Tamil Nadu';
mybotGACode = 'G-R0DQ8B1RNX';

mybotadSmall = '<div id="div-gpt-ad-1617354597382-0"></div>';
// mybotadSmall = '';
mybotqwscrptDesk = "(function(w,d,s,o,f,js,fjs){w[o]=w[o]||function(){(w[o].q=w[o].q||[]).push(arguments)};js=d.createElement(s),fjs=d.getElementsByTagName(s)[0];js.id=o;js.src=f;js.async=1;fjs.parentNode.insertBefore(js,fjs);js.onload = function(){loadAdCustomQW();}}(window,document,'script','_hw','https://quizbot.playdoto.com/widget.js'));_hw('init',{publisherId:'RAF',embed:true,embedElementId:'doto-quizbot',isDesktop:true,widgetPublisherTitle:'Crictracker'})";
mybotqwscrptMob = "(function(w,d,s,o,f,js,fjs){w[o]=w[o]||function(){(w[o].q=w[o].q||[]).push(arguments)};js=d.createElement(s),fjs=d.getElementsByTagName(s)[0];js.id=o;js.src=f;js.async=1;fjs.parentNode.insertBefore(js,fjs);js.onload = function(){loadAdCustomQW();}}(window,document,'script','_hwm','https://quizbot.playdoto.com/widget.js'));_hwm('init',{publisherId:'RAF',embed:true,embedElementId:'doto-quizbot-m',isDesktop:false,widgetPublisherTitle:'Crictracker'});";
...
function mybotCustomFunction() {
  ...
  if (document.getElementById('unibots-qw')) {
    if (!mobileCheck()) {
      qw = document.createElement('p');
      qw.id = 'doto-quizbot';
      qw_scrpt = document.createElement('script');
      qw_scrpt.innerText= mybotqwscrptDesk;
      qw1 = document.getElementById('unibots-qw');
      qw.appendChild(qw_scrpt);
      qw1.appendChild(qw);
    }
    else {
      qw = document.createElement('p');
      qw.id = 'doto-quizbot-m';
      qw_scrpt = document.createElement('script');
      qw_scrpt.innerText= mybotqwscrptMob;
      qw1 = document.getElementById('unibots-qw');
      qw.appendChild(qw_scrpt);
      qw1.appendChild(qw);
    }
