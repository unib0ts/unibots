...
mybotGACode = 'UA-159929110-53';
mybotadSmall = '<div id="div-gpt-ad-1617891847140-0"></div>';
mybotCustomAD ='<script async src="https://securepubads.g.doubleclick.net/tag/js/gpt.js"></script> <script> window.googletag = window.googletag || {cmd: []}; googletag.cmd.push(function() { googletag.defineSlot("/1013527/DH_Unibots_HP_Display_Widget", [100, 50], "div-gpt-ad-1600420672300-0").addService(googletag.pubads()); googletag.pubads().enableSingleRequest(); googletag.enableServices(); }); </script><div id="div-gpt-ad-1600420672300-0" style="width: 100px; height: 50px;""> <script> googletag.cmd.push(function() { googletag.display("div-gpt-ad-1600420672300-0"); }); </script> </div>';
...
function loadAdCustom() {
	// if (document.getElementById('liveBlock').style.display=='none'||) {
     // loadAd('mybotright');
	// }
	if (mobileCheck()) {
		var s3 = document.createElement('script');
		 ...
		 s0.onload=function(){
			 ...
			 url = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/script/adScriptDeccanherald.js?cb='+cachebuster;
