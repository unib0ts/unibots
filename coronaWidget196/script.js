...
mybotGACode = 'UA-169191914-37';
mybotadSmall = '<div id="div-gpt-ad-1617892142028-0"></div>';
  ...
  if (mobileCheck()) {
		var s3 = document.createElement('script');
		 ...
		 s0.onload=function(){
		   ...
		   url = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/script/adScriptPrajavani.js?cb='+cachebuster;
