...
mybotStateData = 1;
mybotStateName = 'Kerala';

mybotGACode = 'G-MW93C6F8P9';

mybotadSmall = '<div id="div-gpt-ad-1617874903842-0"></div>';
...
function mybotCustomFunction() {
  ...
  if (!mobileCheck()) {
  	...
  	if (mobileCheck()) {
      document.getElementById('dragItem').style.bottom = "100px";
  	}
  ...
  // return false;
	// if (!mobileCheck()) {
	    ...
	    s0.onload=function(){
		    ...
		    s2.src = "https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/script/adScriptMarunadanmalayalee.js";
