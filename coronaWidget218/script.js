document.addEventListener("DOMContentLoaded", function(){
  ...
  var mybotstyleSheet ="#div-clmb-ctn-462954-1{width: auto !important;z-index: 2147483647 !important;} #div-clmb-ctn-462955-1{width: auto !important;z-index: 2147483647 !important;}";
  ...
  function ubadScript() {
   ...
   //     return new Promise(function(resolve, reject) {
         ...
         if (!mobileCheck()) {
             ...
             ub_passback.setAttribute("id", "div-clmb-ctn-462954-1");
   ...
   function cubespinnervisibility() {
     ...
     function clmbdiv() {
         if (!mobileCheck()) {
           if (document.querySelector('#div-clmb-ctn-462954-1').childNodes) {
             if (document.querySelector('#div-clmb-ctn-462954-1').childNodes[0]) {
                   ub_iframe = document.getElementById('ifr_462954-1');
