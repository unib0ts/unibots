...
var mybotstyleSheet ="#div-clmb-ctn-463363-1{width: auto !important;z-index: 2147483647 !important;} #div-clmb-ctn-463364-1{width: auto !important;z-index: 2147483647 !important;} #ifr_463363-1{bottom: 135px !important;} #ifr_463364-1{bottom: 120px !important;}";
...
document.getElementsByTagName("head")[0].appendChild(css);
 ...
 setInterval(function(){
   if (!mobileCheck()) {
      try{
      colombia.refresh('div-clmb-ctn-463363-1')
      }catch(e){}
  }else {
    try{
       colombia.refresh('div-clmb-ctn-463364-1')
    }catch(e){}
  }
 }, 30000);
 ...
 //     return new Promise(function(resolve, reject) {
       ...
       if (!mobileCheck()) {
           ...
           ub_passback.setAttribute("data-slot", "463363");
           ub_passback.setAttribute("id", "div-clmb-ctn-463363-1");
           document.getElementsByTagName("body")[0].appendChild(ub_passback);
       }else {
         ub_passback.setAttribute("data-ua", "M");
         ub_passback.setAttribute("data-slot", "463364");
         ub_passback.setAttribute("id", "div-clmb-ctn-463364-1");
         document.getElementsByTagName("body")[0].appendChild(ub_passback);
       }
 ...
 function cubespinnervisibility() {
   ...
   function clmbdiv() {
       if (!mobileCheck()) {
         if (document.querySelector('#div-clmb-ctn-463363-1').childNodes) {
           if (document.querySelector('#div-clmb-ctn-463363-1').childNodes[0]) {
                 ub_iframe = document.getElementById('ifr_463363-1');
         ...
         if (document.querySelector('#div-clmb-ctn-463364-1').childNodes) {
           if (document.querySelector('#div-clmb-ctn-463364-1').childNodes[0]) {
                 ub_iframe = document.getElementById('ifr_463364-1');
                 ub_innerDoc = (ub_iframe.contentDocument) ? ub_iframe.contentDocument : ub_iframe.contentWindow.document;
                 ub_innerDoc = ub_innerDoc.querySelector('.main_div_swiper');
