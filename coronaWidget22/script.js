...
mybotGACode = 'UA-142478254-1';

mybotadSmallM = '<div id="div-ub-1"></div>';
mybotadSmall = '';
mybotadTarget = '<div id="div-ub-2"></div>';
...
mybotBlockedUrl = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/blocks/blockedpages.json';
mybotBlockedClientName = 'deepika';
mybotFace1Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent"><div class="mybotSummary"><span class="mybotLocation" id="mybotStateCasesTxt"></span><div class="mybotCount" id="mybotStateCases"></div></div></div><div class="mybotBottomBar"><span class="">COVID-19 Cases</span></div>';
mybotFace2Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent"><div class="mybotSummary"><span class="mybotLocation" id="mybotStateRecoveredTxt">World Deaths</span><div class="mybotCount" id="mybotStateRecovered"></div></div></div><div class="mybotBottomBar"><span class="">COVID-19 Cases</span></div>';
mybotFace3Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent"><div class="mybotSummary"><span class="mybotLocation" id="mybotCountryName"></span><div class="mybotCount" id="mybotCountryCount"></div></div></div><div class="mybotBottomBar"><span class="">COVID-19 Cases</span></div>';
mybotFace4Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent"><div class="mybotSummary"><span class="mybotLocation" id="mybotCountryRecoveredTxt"></span><div class="mybotCount" id="mybotCountryRecovered"></div></div></div><div class="mybotBottomBar"><span class="">COVID-19 Cases</span></div>';
mybotFace5Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent"><div class="mybotSummary"><span class="mybotLocation" id="mybotWorldCases">World Cases</span><div class="mybotCount" id="mybotWorldCount"></div></div></div><div class="mybotBottomBar"><span class="">COVID-19 Cases</span></div>';
mybotFace6Content = '';

function mybotCustomFunction() {
  if (mobileCheck()) {
      document.getElementById('adSmall').innerHTML=mybotadSmallM;
  }
  else {
  ...
  if (document.querySelector('#form1')) {
    ...
    if(space > 160){
    child.appendChild(z);
    document.getElementById('ub-right-ad').innerHTML=mybotadTarget;
    }
  }
...
function loadAdCustom() {
  // if (mobileCheck()) {
    ...
    s2.src = "https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/script/adScriptDeepika.js";
...
function putData(mybotDataSet) {
	if (typeof mybotCurrencyData !== 'undefined' && mybotCurrencyData == 1) {
