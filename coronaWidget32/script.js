...
mybotGACode = 'UA-159929110-21';

mybotClientName = 'abp';
mybotLocalDataPlacement = 1;
...
// mybotPublisherLogo = '<img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/coronaWidget32/ABP-APP-LOGO.png">';

mybotgabywa = '<script async src="https://www.googletagmanager.com/gtag/js?id='+mybotGACode+'"></script><script>window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag("js", new Date());gtag("config", "'+mybotGACode+'");</script>';

mybotClosevar = '<img src="https://api.warw.in/coronaWidget1/img/close.svg">';
mybotTopBarText ='\u09a8\u099c\u09b0\u09c7 \u0995\u09b0\u09cb\u09a8\u09be';

mybotTopBarContent = '<span class="mybotPoweredByBrand">'+mybotTopBarText+'</span>';
...
mybotFace5Content = '';
mybotFace6Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent"><div class="mybotSummary"><span class="mybotLocation" id="mybotPrecautionText"></span><div class="mybotCount" id="mybotPrecautionTextCount"></div></div></div><div class="mybotBottomBar mybotBottomBarLive"><span class="">COVID-19 Cases</span></div>';
...
function mybotCustomFunction() {
  ...
  document.getElementById('mybotWorldCases').innerText='\u09ad\u09be\u09b0\u09a4\u09c7 \u0986\u0995\u09cd\u09b0\u09be\u09a8\u09cd\u09a4';
  document.getElementById('mybotFace2TempContent').innerText = '\u09ac\u09be\u0982\u09b2\u09be\u09df \u0986\u0995\u09cd\u09b0\u09be\u09a8\u09cd\u09a4';
  document.getElementById('mybotWorldDeathsCases').innerText='\u09ad\u09be\u09b0\u09a4\u09c7 \u09ae\u09c3\u09a4\u09cd\u09af\u09c1';
  document.getElementById('mybotCountryName').innerText='\u09b8\u09c1\u09b8\u09cd\u09a5 \u09b9\u09df\u09c7\u099b\u09c7\u09a8';
  document.getElementById('mybotPrecautionText').innerText='\u09ac\u09bf\u09b6\u09cd\u09ac\u09c7 \u09b8\u0982\u0995\u09cd\u09b0\u09be\u09ae\u09bf\u09a4';

  // document.getElementById('mybotWorldCases').innerText='India Cases';
  // document.getElementById('mybotFace2TempContent').innerText = 'Bengal Cases';
  // document.getElementById('mybotWorldDeathsCases').innerText='India Deaths';
  // document.getElementById('mybotCountryName').innerText='Healed';
  // document.getElementById('mybotPrecautionText').innerText='World Cases';
