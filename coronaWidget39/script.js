...
function mybotCustomFunction() {
  ...
  document.querySelector('.mybotface6').innerHTML=mybotBottomBarContentLive;
	  ...
	  // }
		...
		if(mybotDataSet["data"].text !== undefined){
 		...
 		if(typeof mybotAnothercountryData !== "undefined" && mybotAnothercountryData == 1){
			...
			local_cases = mybotDataSet["data"].thirdlocation.cases;
			local_deaths = mybotDataSet["data"].thirdlocation.deaths;
			world_cases = mybotDataSet["data"].world.cases;
			world_death = mybotDataSet["data"].world.deaths;
			...
			document.getElementById('mybotCountryCasesText').innerText = capitalizeFLetter(local_text)+" Cases";
			document.getElementById('mybotCountryCasesCount').innerText = local_cases;
			document.getElementById('mybotCountryDeathsText').innerText = capitalizeFLetter(local_text)+" Deaths";
			document.getElementById('mybotCountryDeathsCount').innerText = local_deaths;
		}
		else {
			country_cases = mybotDataSet["data"].country.cases;
			country_death = mybotDataSet["data"].country.deaths;
