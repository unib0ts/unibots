...
mybotGACode = 'UA-162275121-24';

var googletag = googletag || {};
googletag.cmd = googletag.cmd || [];

mybotClientName = 'gulftimes';
mybotLocalDataPlacement = 0;
mybotLastSlideLocalDataPresent = 1;
mybotSecondSlideLocalDataPresent = 1;
...
mybotFace4Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent"><div class="mybotSummary"><span class="mybotLocation" id="mybotPrecautionText"></span><div class="mybotCount" id="mybotPrecautionTextCount"></div></div></div><div class="mybotBottomBar mybotBottomBarLive"><span class="">COVID-19 Cases</span></div>';
mybotFace5Content = '<div class="mybotTopBar"><span class="mybotPoweredBy">Powered By</span><span class="mybotPoweredByBrand">Unibots</span></div><div class="mybotContent"><div class="mybotSummary"><span class="mybotLocation" id="mybotFace2TempContent"></span><div class="mybotCount" id="mybotFace2TempCount"></div></div></div><div class="mybotBottomBar mybotBottomBarLive"><span class="">COVID-19 Cases</span></div>';
...
function mybotCustomFunction() {
  ...
  //   window.open('https://www.vtvgujarati.com/topic/corona-awareness?utm_source=unibots&utm_medium=widget&utm_campaign=coronavirus', '_blank');
  // });
 //  if(!mobileCheck()){
...
function loadAdCustom() {
  ...
  // s2.src = "https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/script/adScriptBrightbengal.js";
