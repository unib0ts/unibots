if(window.location.href == "https://www.dailythanthi.com/"){}
else{
  var ub_slot1;
  ...
  s1.innerHTML = "window.googletag = window.googletag || {cmd: []};googletag.cmd.push(function() {ub_slot1= googletag.defineSlot('/21928950349/Test_TN', [1, 1], 'div-gpt-ad-1617355134935-0').addService(googletag.pubads());googletag.pubads().enableSingleRequest();googletag.enableServices();});";
  ...
  function ub_checkAdRendered(){
  	adId = 'div-gpt-ad-1617355134935-0';
