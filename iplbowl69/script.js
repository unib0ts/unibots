...
unibotsDirectAds.cmd.push("tupaki");
 ...
 ubadScript();
   ...
   var mybotstyleSheet ="#mybot-adcover{display:block;width: max-content; height:100px;bottom: 0px !important;text-align: center;z-index: 90 !important;position: fixed !important;}@media screen and (max-width:635px) { #mybot-adcover{bottom: 0px;right:unset;}}";
