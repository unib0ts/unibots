...
mybotMatchEnabled = 1;
mybotloadCricWidgetScript = 'https://api.warw.in/cw6/js/script.js';
mybotMatchTimestamps = [
	[1579825800, 1579912200],
...
mybotspecialEvent = 0;
mybotMultiIconName = 'corona';
mybotMultiIconType = '.png';
mybotMultiIconNumber = 1;

mybotProfileheight= 1;

mybotMultipleIconsStartepoch = 1583557322;
mybotMultipleIconsEndepoch = 1583776922;
...
// mobileTopPixel = 300;
mybotImageReplaceText = '_TMBVPF.gif';
mybotImageReplaceTextNew = '_MEDVPF.gif';
mybotlinkAppend = '?utm_source=Unibots&utm_medium=Direct&utm_campaign=maalaimalar';
mybotlinkAppendFlag = 1;

var xDown = null;
var yDown = null;

mybotampEnabled = 0; //mybotMatchEnabledFlag, MobileTopPlacement, mybotIsBottomScrollStartDisapperEnabled Remove

//Normal - Disable When Amp Enabled
mybotAdLinkIn = 'https://securepubads.g.doubleclick.net/tag/js/gpt.js';
mybotAdInName = '21854674376/maalaimalar-300x250';
mybotAdInSize = '[300, 250]';
mybotAdInID = 'div-gpt-ad-1576564162921-0';

//AMP - Comment When Amp Disabled
// mybotAdLinkSmall = 'https://securepubads.g.doubleclick.net/tag/js/gpt.js';
// mybotAdSmallName = '/21804848220/ATD_Maalaimalar_AMP/ATD_320x50_P2';
// mybotAdSmallSize = '[320, 50]';
// mybotAdSmallID = 'div-gpt-ad-1564041246114-0';
//
// mybotAdLinkIn = 'https://securepubads.g.doubleclick.net/tag/js/gpt.js';
// mybotAdInName = '/21804848220/ATD_Maalaimalar_AMP/ATD_300x250_P1';
// mybotAdInSize = '[300, 250]';
...
//Normal - Disable When Amp Enabled
mybotadSmall = '<div id="ATD_ML_320x100"></div>';
...
// mybotFace = '<div class="mybotcard-container" id="botfaceclosed"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/maalaimalar/logo-med-01.png" class="mybotcard mybotcard1 mybotimgprofile"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest//main/diwali/70px1.gif" class="mybotcard mybotcard2 mybotimgprofile"></div>';
...
function mybotChangeIframeSize(){
  mybotChangeIframeInterval = setTimeout(function(){setInterval(function(){mybotampIncrease();}, 45000)}, 11000);
  mybotChangeIframeIntervalDec = setTimeout(function(){setInterval(function(){mybotampClose();}, 45000)}, 32000);
}

function loadAdCustom() {
    var s = document.createElement('script');
    s.src = "https://go.automatad.com/geo/ZYKw68/afihbs.js";
...
function openBotMenuCustom(){
	...
	var element = document.querySelector('.botBodyChat');
	scrollToMyBot(element, objDiv.scrollHeight, 1250);
	// if((typeof botSearchBottom =='undefined') && (botSearchBottom==0)){
	...
	request.onload = function() {
		if (request.status >= 200 && request.status < 400) {
			...
			if(data.error == true) {
				...
				tempvar.innerHTML = articlesHTML;
				botMessageBody.appendChild(tempvar);
				if((typeof botSearchBottom !=='undefined') && (botSearchBottom ==1)){
						botSearchWrapperAppend();
				}
...
function mybotSearchStore(count, term){
	...
	var request = new XMLHttpRequest();
	url = 'https://api.warw.in/maalaimalar/search';
	request.open('POST', url, true);
	request.setRequestHeader('Auth-Token', AUTH_TOKEN);
	request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	request.onload = function() {
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/maalaimalar/fb_put_auth_token';
request.open('POST', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.withCredentials = true;
request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/maalaimalar/get_fb_details';
request.open('POST', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
request.onload = function() {
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/maalaimalar/get_fb_code';
request.open('POST', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
request.onload = function() {
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/maalaimalar/generate_quiz';
request.open('GET', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.withCredentials = true;
request.onload = function() {
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/maalaimalar/get_score';
request.open('POST', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.withCredentials = true;
request.setRequestHeader("Content-type", "application/json");
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/maalaimalar/leaderboard';
request.open('GET', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.withCredentials = true;
request.onload = function() {
...
function mybotClickCountPlayQuiz(count) {
  if(mybotClickCountEnabled){
		...
		var request = new XMLHttpRequest();
		url = 'https://api.warw.in/maalaimalar/bot_play_quiz';
		request.open('GET', url, true);
		request.setRequestHeader('Auth-Token', AUTH_TOKEN);
		request.onload = function() {
			if (request.status >= 200 && request.status < 400) {
