  ...
  adUnitstemp = [
      ...
      },
    {
        ...
        bids: [
          ...
          { bidder: 'smartadserver', params: { siteId: '371038', pageId: '1306262', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAll: ["US", "CA"] },
...
if (!mobileCheckAdSript() && document.querySelector('.abp-storypage-article-left-wrap') != null) {
  adUnitstemp = {
      ...
      bids: [
        ...
        { bidder: 'criteointl', params: {networkId: '10545'} },
        { bidder: 'nobid', params: { siteId : '22049999632' } },
        { bidder: 'smartadserver', params: { siteId: '362092', pageId: '1289593', formatId: '93417', domain: 'https://prg8.smartadserver.com' }, labelAll: ["US", "CA"] },
        //{ bidder: 'sonobi', params: { placement_id: 'e061c85c1bf277a0a913', ad_unit: 'ragalahari_NB_728x90' } },
        { bidder: 'onetag', params: { pubId: '60c32c42465aac2' } },
        // { { bidder: 'adsolut', params: { zoneId: '107071', host: 'cpm.adsolut.in' } },
        // { bidder: 'rubicon', params: { accountId: '11734', siteId: '323588', zoneId: '1679924' } }
