...
var adUnits = [
    {
        code: '/21957769615/aglasem.com_NB_320x50',
        mediaTypes: {
            banner: {
                sizes: div_1_sizes
            }
        ...
        bids: [
        	...
        	{ bidder: 'oftmedia', params: { placementId: '19094316', allowSmallerSizes: true } },
          ...
          { bidder: 'openx', params: {unit: '541046572', delDomain: 'yieldbird-d.openx.net'} },
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21957769615/aglasem.com_NB_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21957769615/aglasem.com_NB_320x50'],
