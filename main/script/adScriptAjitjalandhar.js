...
const customConfigObjectA = {
 "buckets" : [{
  ...
  adUnits1 =
  {
      code: '/21956916242/ajitjalandhar.com_ipl_320x50',
      mediaTypes: {
          banner: {
              sizes: div_1_sizes
          }
      ...
      bids: [
       { bidder: 'appnexus', params: { placementId: '20215250' } }, /* one placementId for all sizes  my appnexus bidder */
       { bidder: 'sovrn', params: {tagid: '774101'} },
      //  { bidder: 'smartadserver', params: { siteId: '369197', pageId: '1301294', formatId: '93231', domain: 'https://prg8.smartadserver.com' } },
       ...
       { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '3206177'} },
       { bidder: 'criteo', params: {networkId: '10542'} },
       { bidder: 'criteointl', params: {networkId: '10545'} },
       // // { bidder: 'oftmedia', params: { placementId: '18671523' } },
       // { bidder: '33across', params: { siteId : 'c879m0WuGr6PjyaKlId8sQ', productId: 'siab' } }, /*All sizes*/
       { bidder: 'emx_digital', params: { tagid: '115863' } }, /* sizeless */
...
ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
     ...
     //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
      ...
      publisherDomain: 'http://www.ajitjalandhar.com/',
...
function googlePush(){
  ...
  mappings.adCode.push('/21956916242/ajitjalandhar.com_ipl_320x50');
  mappings.sizes.push(div_1_sizes);
  mappings.adId.push('div-gpt-ad-1600589974423-0');
  googletag.cmd.push(function() {
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1600589974423-0', ub_slot1, ['/21956916242/ajitjalandhar.com_ipl_320x50']);
      }
    });
  });
