...
// if(document.getElementById('newsbot-ads')){
  adUnits1 =
  {
      code: '/21928950349,22624210263/akilanews.com_ipl_320x50',
      mediaTypes: {
          banner: {
              sizes: div_1_sizes
          }
      ...
      bids: [
          { bidder: 'appnexus', params: { placementId: '21352700' } }, /* one placementId for all sizes  my appnexus bidder */
          { bidder: 'oftmedia', params: { placementId: '20846125' } },
          { bidder: '33across', params: { siteId : 'cWiLNIu30r7kDFrkHcnlxd', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
          ...
          { bidder: 'smartadserver', params: { siteId: '404703', pageId: '1370487', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"]},
...
//
//   slotID: 'div-gpt-ad-1617874979339-0',
//   slotName: '/21928950349,22624210263/akilanews.com_ipl_320x50',
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=akilanews';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
function googlePush(){
  ...
  mappings.adCode.push('/21928950349,22624210263/akilanews.com_ipl_320x50');
  mappings.sizes.push(div_1_sizes);
  mappings.adId.push('div-gpt-ad-1617874979339-0');
  apSlotTemp = {
  ...
  googletag.cmd.push(function() {
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1617874979339-0', ub_slot1, ['/21928950349,22624210263/akilanews.com_ipl_320x50']);
      }
    });
  });
    ...
    config: {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://akilanews.com/',
