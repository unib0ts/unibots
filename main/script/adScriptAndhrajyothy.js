...
// if(document.getElementById('newsbot-ads')){
  adUnits1 =
  {
      code: '/21928950349,22614650000/andhrajyothy_cube_320x50',
      mediaTypes: {
          banner: {
              sizes: div_1_sizes
          }
...
function googlePush(){
  ...
  mappings.adCode.push('/21928950349,22614650000/andhrajyothy_cube_320x50');
  mappings.sizes.push(div_1_sizes);
  mappings.adId.push('div-gpt-ad-1636394755885-0');
  googletag.cmd.push(function() {
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1636394755885-0', ub_slot1, ['/21928950349,22614650000/andhrajyothy_cube_320x50']);
      }
    });
  });
