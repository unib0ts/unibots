...
// if(document.getElementById('unibots-ad')){
  adUnits1 =
  {
      code: '/21957769615/auditionform.in_ub_320x50',
      mediaTypes: {
          banner: {
              sizes: div_1_sizes
          }
      ...
      bids: [
        { bidder: 'appnexus', params: { placementId: '23600113' } }, /* one placementId for all sizes  my appnexus bidder */
        //  	{ bidder: 'oftmedia', params: { placementId: '20846125' } },
         	{ bidder: '33across', params: { siteId : 'd7AI0su30r7kDFrkHcnlxd', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        //  	// { bidder: 'emx_digital', params: { tagid: '107931' } }, /* sizeless */
           { bidder: 'sovrn', params: {tagid: '984638'} },
        ...
        //  	// // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
           { bidder: 'nobid', params: { siteId : '22656451950'} },
...
//
//   slotID: 'div-gpt-ad-1634373906653-0',
//   slotName: '/21957769615/auditionform.in_ub_320x50',
...
// if(document.getElementById('unibots-ad')){
  ...
  mappings.adCode.push('/21957769615/auditionform.in_ub_320x50');
  mappings.sizes.push(div_1_sizes);
  mappings.adId.push('div-gpt-ad-1634373906653-0');
  googletag.cmd.push(function() {
    // callAPStagBids(); //Ap part
    // callAPSAds(mappings.adCode, mappings.slots);
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1634373906653-0', ub_slot1, ['/21957769615/auditionform.in_ub_320x50']);
      }
    });
  });
// }
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://www.auditionform.in/',
