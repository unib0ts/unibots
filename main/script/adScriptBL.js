...
if (document.getElementById('unibots-300x100_Img')) {
  var adUnits = [
      {
          code: '/21928950349/boomlive_ipl_300x100',
          mediaTypes: {
              banner: {
                  sizes: div_1_sizes
              }
          ...
          bids: [
          	...
          	{ bidder: '33across', params: { siteId : 'dkoemqNiqr64oSaKjGFx_2', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
          	// { bidder: 'emx_digital', params: { tagid: '107931' } }, /* sizeless */
            { bidder: 'sovrn', params: {tagid: '882924'} },
            { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '3579048'} },
            { bidder: 'openx', params: {unit: '544025998', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
          	{ bidder: 'rhythmone', params: { placementId: '205945'}}, /* one placementId for all sizes */
          	// // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
            { bidder: 'nobid', params: { siteId : '22358104671'} },
            // { bidder: 'criteo', params: {networkId: '10542'} },
            // { bidder: 'criteointl', params: {networkId: '10545'} },
            { bidder: 'adyoulike', params: { placement: '2c2ca1653a87dd3ebe409bd5efbd611b'}, labelAll: ["US"] },
            { bidder: 'smartadserver', params: { siteId: '404701', pageId: '1370485', formatId: '94416', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"]},
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=boomlive';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21928950349/boomlive_ipl_300x100'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1617874795105-0';
