...
var adUnits = [
    {
        code: '/21928950349/bollywoodtadka.in_NB_320x50',
        mediaTypes: {
          native: {
            image: {
              // sizes: [300, 100],
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19057771' } },
    ...
    },
    {
        ...
        bids: [
          ...
          //{ bidder: 'adsolut', params: {zoneId: '107071', host: 'cpm.adsolut.in'} },
        	{ bidder: '33across', params: { siteId : 'acFWzqWuGr6PjyaKlId8sQ', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        	//{ bidder: 'emx_digital', params: { tagid: '97448' } }, /* sizeless */
          { bidder: 'sovrn', params: {tagid: '713983'} },
          { bidder: 'openx', params: {unit: '543530176', delDomain: 'unibots-d.openx.net'}},
          { bidder: 'rhythmone', params: { placementId: '205945'} }, /* one placementId for all sizes */
          // { bidder: 'criteo', params: {networkId: '10542'} },
          // { bidder: 'criteointl', params: {networkId: '10545'} },
          { bidder: 'adyoulike', params: { placement: '2c2ca1653a87dd3ebe409bd5efbd611b'}, labelAll: ["US"] },
          { bidder: 'smartadserver', params: { siteId: '362099', pageId: '1289600', formatId: '93231', domain: 'https://prg8.smartadserver.com' }},
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=bollywoodtadka';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21928950349/bollywoodtadka.in_NB_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21928950349/bollywoodtadka.in_NB_320x50'],
    ...
    config: {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'bollywoodtadka.in',
