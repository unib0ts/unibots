...
if (mobileCheck === 'function') {
  if (!mobileCheck()) {
     if (document.getElementById('ads_giuabaiviet')) {
       adUnits = [
         {
 ...
 if (!mobileCheck()){
     if (document.getElementById('ads_giuabaiviet')){
       ...
       function refreshBid(ub_slot) {
         ubpbjs.que.push(function() {
           ubpbjs.requestBids({
             timeout: PREBID_TIMEOUT,
             adUnitCodes: ['/21957769615/bongdaz.com_nb_728x90_hb'],
     ...
     function refreshBid(ub_slot) {
       ubpbjs.que.push(function() {
         ubpbjs.requestBids({
           timeout: PREBID_TIMEOUT,
           adUnitCodes: ['/21957769615/bongdaz.com_nb_320x100'],
           bidsBackHandler: function() {
             googletag.cmd.push(function() {
               ubpbjs.que.push(function() {
                   ubpbjs.setTargetingForGPTAsync();
   ...
   if (document.getElementById('ads_giuabaiviet')){
     ...
     function refreshBid(ub_slot) {
       ubpbjs.que.push(function() {
         ubpbjs.requestBids({
           timeout: PREBID_TIMEOUT,
           adUnitCodes: ['/21957769615/bongdaz.com_nb_300x250_hb'],
           bidsBackHandler: function() {
             googletag.cmd.push(function() {
               ubpbjs.que.push(function() {
                   ubpbjs.setTargetingForGPTAsync();
   ...
   function refreshBid(ub_slot) {
     ubpbjs.que.push(function() {
       ubpbjs.requestBids({
         timeout: PREBID_TIMEOUT,
         adUnitCodes: ['/21957769615/bongdaz.com_nb_328x50'],
         bidsBackHandler: function() {
           googletag.cmd.push(function() {
             ubpbjs.que.push(function() {
                 ubpbjs.setTargetingForGPTAsync();
