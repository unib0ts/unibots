...
if (mobileCheck === 'function') {
  if (!mobileCheck()) {
       adUnits = [{
         code: '/21957769615/businessworld.in_NB_320x100',
         mediaTypes: {
           banner: {
             sizes: div_2_sizes
           }
         ...
         bids: [
           ...
           { bidder: 'smartadserver', params: { siteId: '362100', pageId: '1289601', formatId: '93416', domain: 'https://prg8.smartadserver.com' }, labelAll: ["US", "CA"] },
    ...
    adUnits = [
      ...
      // },
      {
        ...
        bids: [
          ...
          { bidder: 'smartadserver', params: { siteId: '362100', pageId: '1289601', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAll: ["US", "CA"] },
...
if(mobileCheck === 'function'){
  if(mobileCheck()){
    ...
    function ub_checkAd1Rendered(){
        ...
        var ub_slot2;
        googletag.cmd.push(function() {
            ub_slot2 = googletag.defineSlot('/21957769615/businessworld.in_NB_320x100', div_2_sizes, 'div-ub-2').addService(googletag.pubads());
            googletag.pubads().collapseEmptyDivs(true);
            googletag.pubads().setCentering(true);
            googletag.pubads().setPrivacySettings({ 'restrictDataProcessing': true });
            googletag.pubads().enableSingleRequest();
        ...
        function refreshBid(ub_slot) {
          ubpbjs.que.push(function() {
            ubpbjs.requestBids({
              timeout: PREBID_TIMEOUT,
              adUnitCodes: ['/21957769615/businessworld.in_NB_320x100'],
              bidsBackHandler: function() {
                googletag.cmd.push(function() {
                  ubpbjs.que.push(function() {
                      ubpbjs.setTargetingForGPTAsync();
