...
if(mobileCheck === 'function'){
 if (!mobileCheck()){
   if (document.querySelector('.home_page_ad')) {
     ...
     var ub_slot1;
     googletag.cmd.push(function() {
         ub_slot1 = googletag.defineSlot('/21956916242/bytegig.com_970x90', div_1_sizes, 'div-gpt-ad-1591009653748-0').addService(googletag.pubads());
     ...
     function refreshBid(ub_slot) {
       ubpbjs.que.push(function() {
         ubpbjs.requestBids({
           timeout: PREBID_TIMEOUT,
           adUnitCodes: ['/21956916242/bytegig.com_970x90'],
     ...
     function ub_checkAd1Rendered(){
       adId1 = 'div-gpt-ad-1591009653748-0';
     ...
     var ub_slot6;
     googletag.cmd.push(function() {
         ub_slot6 = googletag.defineSlot('/21956916242/bytegig.com_728x90_centersticky_desk', div_6_sizes, 'div-gpt-ad-1591010094567-0').addService(googletag.pubads());
         googletag.pubads().collapseEmptyDivs(true);
         googletag.pubads().setCentering(true);
         googletag.pubads().setPrivacySettings({ 'restrictDataProcessing': true });
         googletag.pubads().enableSingleRequest();
     ...
     function refreshBid(ub_slot) {
       ubpbjs.que.push(function() {
         ubpbjs.requestBids({
           timeout: PREBID_TIMEOUT,
           adUnitCodes: ['/21956916242/bytegig.com_728x90_centersticky_desk'],
           bidsBackHandler: function() {
             googletag.cmd.push(function() {
               ubpbjs.que.push(function() {
                   ubpbjs.setTargetingForGPTAsync();
     ...
     function ub_checkAd6Rendered(){
       adId6 = 'div-gpt-ad-1591010094567-0';
   ...
   function initAdserver() {
       ...
       googletag.cmd.push(function() {
           ubpbjs.que.push(function() {
               ubpbjs.setTargetingForGPTAsync();
               googletag.pubads().refresh([ub_slot7]);
           });
       });
   }
   // in case ubpbjs doesn't load
   ...
   var ub_slot7;
   googletag.cmd.push(function() {
       ub_slot7 = googletag.defineSlot('/21956916242/bytegig.com_320x50_centersticky_mob', div_7_sizes, 'div-gpt-ad-1591010157738-0').addService(googletag.pubads());
       googletag.pubads().collapseEmptyDivs(true);
       googletag.pubads().setCentering(true);
       googletag.pubads().setPrivacySettings({ 'restrictDataProcessing': true });
       googletag.pubads().enableSingleRequest();
   ...
   function refreshBid(ub_slot) {
     ubpbjs.que.push(function() {
   	  ubpbjs.requestBids({
   		  timeout: PREBID_TIMEOUT,
   		  adUnitCodes: ['/21956916242/bytegig.com_320x50_centersticky_mob'],
   		  bidsBackHandler: function() {
           googletag.cmd.push(function() {
             ubpbjs.que.push(function() {
                 ubpbjs.setTargetingForGPTAsync();
   ...
   ub_ad7RefreshFlag = 0;
   function ub_checkAd7Rendered(){
   	adId7 = 'div-gpt-ad-1591010157738-0';
   	var nodes = document.getElementById(adId7).childNodes[0].childNodes;
   	if(nodes.length && nodes[0].nodeName.toLowerCase() == 'iframe') {
       if(ub_ad7RefreshFlag != 1){
         setInterval(function() {
           ub_ad7RefreshFlag = 1;
           refreshBid(ub_slot7);
         }, REFRESH_TIMEOUT);
 ...
 if (document.getElementById('sidebar_first_ad')){
   ...
   var ub_slot2;
   googletag.cmd.push(function() {
       ub_slot2 = googletag.defineSlot('/21956916242/bytegig.com_300x250', div_2_sizes, 'div-gpt-ad-1591009710425-0').addService(googletag.pubads());
   ...
   function refreshBid(ub_slot) {
     ubpbjs.que.push(function() {
       ubpbjs.requestBids({
         timeout: PREBID_TIMEOUT,
         adUnitCodes: ['/21956916242/bytegig.com_300x250'],
         bidsBackHandler: function() {
           googletag.cmd.push(function() {
             ubpbjs.que.push(function() {
                 ubpbjs.setTargetingForGPTAsync();
   ...
   function ub_checkAd2Rendered(){
     adId2 = 'div-gpt-ad-1591009710425-0';
 ...
 if (document.getElementById('sidebar_second_ad')){
    ...
    var ub_slot3;
    googletag.cmd.push(function() {
        ub_slot3 = googletag.defineSlot('/21956916242/bytegig.com_300x250_2', div_3_sizes, 'div-gpt-ad-1591009768179-0').addService(googletag.pubads());
        // ub_slot5 = googletag.defineSlot('/21957769615/phunusuckhoe_nb_300x250_2', div_5_sizes, 'div-gpt-ad-1591008999017-0').addService(googletag.pubads());
        googletag.pubads().collapseEmptyDivs(true);
        googletag.pubads().setCentering(true);
        googletag.pubads().setPrivacySettings({ 'restrictDataProcessing': true });
    ...
    function refreshBid(ub_slot) {
      ubpbjs.que.push(function() {
        ubpbjs.requestBids({
          timeout: PREBID_TIMEOUT,
          adUnitCodes: ['/21956916242/bytegig.com_300x250_2'],
          bidsBackHandler: function() {
            googletag.cmd.push(function() {
              ubpbjs.que.push(function() {
                  ubpbjs.setTargetingForGPTAsync();
    ...
    function ub_checkAd3Rendered(){
      adId3 = 'div-gpt-ad-1591009768179-0';
 ...
 if (document.getElementById('article_top_ad')){
     ...
     var ub_slot4;
     googletag.cmd.push(function() {
         ub_slot4 = googletag.defineSlot('/21956916242/bytegig.com_728x90', div_4_sizes, 'div-gpt-ad-1591009847109-0').addService(googletag.pubads());
         // ub_slot5 = googletag.defineSlot('/21957769615/phunusuckhoe_nb_300x250_2', div_5_sizes, 'div-gpt-ad-1591008999017-0').addService(googletag.pubads());
         googletag.pubads().collapseEmptyDivs(true);
         googletag.pubads().setCentering(true);
         googletag.pubads().setPrivacySettings({ 'restrictDataProcessing': true });
     ...
     function refreshBid(ub_slot) {
       ubpbjs.que.push(function() {
         ubpbjs.requestBids({
           timeout: PREBID_TIMEOUT,
           adUnitCodes: ['/21956916242/bytegig.com_728x90'],
           bidsBackHandler: function() {
             googletag.cmd.push(function() {
               ubpbjs.que.push(function() {
                   ubpbjs.setTargetingForGPTAsync();
     ...
     function ub_checkAd4Rendered(){
       adId4 = 'div-gpt-ad-1591009847109-0';
 ...
 if (document.getElementById('article_bottom_ad')){
      ...
      googletag.cmd.push(function() {
          ...
          ub_slot5 = googletag.defineSlot('/21956916242/bytegig.com_728x90_2', div_5_sizes, 'div-gpt-ad-1591009923725-0').addService(googletag.pubads());
          googletag.pubads().collapseEmptyDivs(true);
          googletag.pubads().setCentering(true);
          googletag.pubads().setPrivacySettings({ 'restrictDataProcessing': true });
          googletag.pubads().enableSingleRequest();
      ...
      function refreshBid(ub_slot) {
        ubpbjs.que.push(function() {
          ubpbjs.requestBids({
            timeout: PREBID_TIMEOUT,
            adUnitCodes: ['/21956916242/bytegig.com_728x90_2'],
            bidsBackHandler: function() {
              googletag.cmd.push(function() {
                ubpbjs.que.push(function() {
                    ubpbjs.setTargetingForGPTAsync();
      ...
      ub_ad5RefreshFlag = 0;
      function ub_checkAd5Rendered(){
        adId5 = 'div-gpt-ad-1591009923725-0';
        var nodes = document.getElementById(adId5).childNodes[0].childNodes;
        if(nodes.length && nodes[0].nodeName.toLowerCase() == 'iframe') {
          if(ub_ad5RefreshFlag != 1){
            setInterval(function() {
