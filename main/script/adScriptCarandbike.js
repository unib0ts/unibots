...
mybotBlockedUrl = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/ubvideoblocks/blocksCarandbike.json';
...
if(typeof mybotBlockedPagesFlag !== 'undefined' && mybotBlockedPagesFlag ==1){
  ...
  ubadScript();
	...
	if (document.getElementById('div-gpt-ad-1612774908699-0')) {
		adUnits1 =
		{
				code: '/21956916242/carandbike.com_hb_320x50',
				mediaTypes: {
						banner: {
								sizes: div_1_sizes
						}
	  ...
	  //
		...
		//   slotName: '/21956916242/carandbike.com_hb_320x50',
...
function ubadScript() {
	  ...
	  mappings.adCode.push('/21956916242/carandbike.com_hb_320x50');
	  ...
	  googletag.cmd.push(function() {
	    ...
	    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
	      if (event.slot === ub_slot1) {
	        ub_checkAdRendered('div-gpt-ad-1614841227407-0', ub_slot1, ['/21956916242/carandbike.com_hb_320x50']);
	      }
	    });
	  });
	}
