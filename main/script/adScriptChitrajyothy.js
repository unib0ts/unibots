...
// if(document.getElementById('newsbot-ads')){
  adUnits1 =
  {
      code: '/21928950349/chitrajyothy_cube_320x50',
      mediaTypes: {
          banner: {
              sizes: div_1_sizes
          }
      ...
      bids: [
        ...
        //    { bidder: 'openx', params: {unit: '544022825', delDomain: 'unibots-d.openx.net'}},
        ...
        //    { bidder: 'nobid', params: { siteId : '22364737639'} },
           ...
           // { bidder: 'smartadserver', params: { siteId: '404714', pageId: '1370498', formatId: '93231', domain: 'https://prg8.smartadserver.com' }},
...
function googlePush(){
  ...
  mappings.adCode.push('/21928950349/chitrajyothy_cube_320x50');
  mappings.sizes.push(div_1_sizes);
  mappings.adId.push('div-gpt-ad-1636394784638-0');
  googletag.cmd.push(function() {
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1636394784638-0', ub_slot1, ['/21928950349/chitrajyothy_cube_320x50']);
      }
    });
  });
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://www.chitrajyothy.com/',
