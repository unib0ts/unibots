...
function mobileCheck() {
  ...
  if (document.querySelector('#UB_300x250')) {
    document.querySelector('#UB_300x250').innerHTML = "<div id='div-gpt-ad-1639393285549-0'></div>";
  }
  if (document.querySelector('#UB_300x600')) {
    document.querySelector('#UB_300x600').innerHTML = "<div id='div-gpt-ad-1639393310344-0'></div>";
  }
  if (document.querySelector('#UB_320x50')) {
    document.querySelector('#UB_320x50').innerHTML = "<div id='div-gpt-ad-1639393341643-0'></div>";
  }
  if (document.querySelector('#UB_336x280')) {
    document.querySelector('#UB_336x280').innerHTML = "<div id='div-gpt-ad-1639393361664-0'></div>";
  }
  if (document.querySelector('#UB_970x250')) {
    document.querySelector('#UB_970x250').innerHTML = "<div id='div-gpt-ad-1639393392689-0'></div>";
  }
    ...
    ubpbjs.que.push(function () {
      ...
      // });
        ...
        ubpbjs.setConfig({
            ...
            publisherDomain: "https://www.criclines.com/",
...
var mappings_full_hb_config_desktop = {
    adUnitNames: [
        "/22082859479,22432906626/criclines.com_ub_300x250",
        "/22082859479,22432906626/criclines.com_ub_300x600",
        "/22082859479,22432906626/criclines.com_ub_320x50",
        "/22082859479,22432906626/criclines.com_ub_336x280",
        "/22082859479,22432906626/criclines.com_ub_970x250",
    ],
    adId: [
          "div-gpt-ad-1639393285549-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1639393310344-0", //'/22140546871/bongdaplus.vn_in-article_336x280',
          "div-gpt-ad-1639393341643-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1639393361664-0", //'/22140546871/bongdaplus.vn_in-article_336x280',
          "div-gpt-ad-1639393392689-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
    ],
    sizes: [
        [300, 250],
        [300, 600],
