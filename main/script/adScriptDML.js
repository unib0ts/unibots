...
var adUnits = [
    {
        code: '/21956033520/dinamalar.com_NB_320x50',
        mediaTypes: {
            banner: {
                sizes: div_1_sizes
            }
        ...
        bids: [
        	{ bidder: 'appnexus', params: { placementId: '19057738', allowSmallerSizes: true } }, /* one placementId for all sizes  my appnexus bidder */
        	{ bidder: 'oftmedia', params: { placementId: '19094359', allowSmallerSizes: true } },
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21956033520/dinamalar.com_NB_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21956033520/dinamalar.com_NB_320x50'],
