...
adUnits = [
    ...
    },
    {
        ...
        bids: [
        	...
        	{ bidder: 'oftmedia', params: { placementId: '20846125' } },
        	{ bidder: '33across', params: { siteId : 'afgup6Buar6PWLaKlId8sQ', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        	{ bidder: 'emx_digital', params: { tagid: '97460' } }, /* sizeless */
          { bidder: 'sovrn', params: {tagid: '701549'} },
          { bidder: 'openx', params: {unit: '543530177', delDomain: 'unibots-d.openx.net'} },
          ...
          { bidder: 'smartadserver', params: { siteId: '362103', pageId: '1289604', formatId: '93231', domain: 'https://prg8.smartadserver.com' }},
          ...
          { bidder: 'rubicon', params: {accountId: '23976', siteId: '400078', zoneId: '2265124'} }
        ]
    }
];
...
//
//   slotID: 'div-ub-1',
//   slotName: '/21928950349/dailythanthi.com_NB_320x50',
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=dailythanthi';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
mappings.adCode.push('/21928950349/dailythanthi.com_NB_320x50');
...
googletag.cmd.push(function() {
  ...
  googletag.pubads().addEventListener('slotRenderEnded', function(event) {
    if (event.slot === ub_slot1) {
      ub_checkAdRendered('div-ub-1', ub_slot1, ['/21928950349/dailythanthi.com_NB_320x50']);
    }
  });
});
...
function ub_passback() {
  ...
  if (!mobileCheck()) {
      ...
      ub_passback.setAttribute("data-slot", "460181");
      ub_passback.setAttribute("id", "div-clmb-ctn-460181-1");
      ub_sticky = document.getElementById('adSmall');
      ub_sticky.appendChild(ub_passback);
  }else {
    ub_passback.setAttribute("data-ua", "M");
    ub_passback.setAttribute("data-slot", "460182");
    ub_passback.setAttribute("id", "div-clmb-ctn-460182-1");
    ub_sticky = document.getElementById('adSmall');
    ub_sticky.appendChild(ub_passback);
  }
}
    ...
    config: {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://www.dailythanthi.com/',
