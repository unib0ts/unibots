...
var mybotboturl = window.location.href;
...
var div_2_sizes = [[970, 250], [970, 90], [728, 90]];
...
if (typeof mobileCheck === "function") {
  // if (!mobileCheck()) {
  //   if (mybotboturl== 'https://danviet.vn/') {
  //
  //   }
  //  else {
...
if (mobileCheck()) {
    if (mybotboturl== 'https://danviet.vn/') {
     ...
     if (document.getElementById('zone-kdimga6l')) {
       adUnits1 =
         {
           ...
           bids: [
            ...
            // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
             ...
             { bidder: 'criteo', params: {networkId: '10542'} },
             { bidder: 'criteointl', params: {networkId: '10545'} },
             { bidder: 'smartadserver', params: { siteId: '362105', pageId: '1289606', formatId: '93418', domain: 'https://prg8.smartadserver.com' }, labelAll: ["US", "CA"] },
    ...
    adUnits1 =
      {
          ...
          bids: [
           ...
           // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
            ...
            { bidder: 'criteointl', params: {networkId: '10545'} },
            { bidder: 'adyoulike', params: { placement: '2c2ca1653a87dd3ebe409bd5efbd611b'}, labelAll: ["US"] },
            { bidder: 'smartadserver', params: { siteId: '362105', pageId: '1289606', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAll: ["US", "CA"] },
            //{ bidder: 'sonobi', params: { placement_id: 'e061c85c1bf277a0a913', ad_unit: 'ragalahari_NB_728x90' } },
            { bidder: 'onetag', params: { pubId: '60c32c42465aac2' } },
            // { bidder: 'criteo', params: {networkId: '4902'} },
            //{ bidder: 'adsolut', params: {zoneId: '107071', host: 'cpm.adsolut.in'} },
