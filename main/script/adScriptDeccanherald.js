...
// if(document.getElementById('unibots-ad')){
  adUnits1 =
  {
      code: '/21928950349,22560027500/deccanherald.com_ub_320x50',
      mediaTypes: {
          banner: {
              sizes: div_1_sizes
          }
...
//   slotName: '/21928950349,22560027500/deccanherald.com_ub_320x50',
...
// if(document.getElementById('unibots-ad')){
  ...
  mappings.adCode.push('/21928950349,22560027500/deccanherald.com_ub_320x50');
  ...
  googletag.cmd.push(function() {
    ...
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1617891847140-0', ub_slot1, ['/21928950349,22560027500/deccanherald.com_ub_320x50']);
      }
    });
  });
// }
