...
var adUnits = [
    {
        ...
        bids: [
          ...
          { bidder: 'smartadserver', params: { siteId: '371034', pageId: '1306258', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"]},
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=deccanherald';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21956916242/deccanherald.com_ipl_320x50', div_1_sizes, 'div-gpt-ad-1617891847140-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21956916242/deccanherald.com_ipl_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1617891847140-0';
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://deccanherald.com/',
