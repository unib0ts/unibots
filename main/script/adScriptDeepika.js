...
var adUnits = [];
    ...
    adUnits1 = {
           ...
           bids: [
             ...
             { bidder: 'rubicon', params: {accountId: '23976', siteId: '400078', zoneId: '2265118'} }
           ]
       },
    ...
    adUnits1 = {
       ...
       bids: [
         ...
         { bidder: 'emx_digital', params: { tagid: '147569' } }, /* sizeless */
          { bidder: 'sovrn', params: {tagid: '711906'} },
          { bidder: 'openx', params: {unit: '543530328', delDomain: 'unibots-d.openx.net'}},
         ...
         // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
          ...
          { bidder: 'smartadserver', params: { siteId: '362106', pageId: '1289607', formatId: '93231', domain: 'https://prg8.smartadserver.com' } },
    ...
    adUnits1 = {
      ...
      bids: [
        ...
        { bidder: 'emx_digital', params: { tagid: '97462' } }, /* sizeless */
         ...
         { bidder: 'rhythmone', params: { placementId: '205945' } }, /* one placementId for all sizes */
        // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
         { bidder: 'nobid', params: { siteId : '22358104701'} },
...
function ub_passback() {
    ...
    if (!mobileCheck()) {
        ...
        ub_passback.setAttribute("data-slot", "460179");
        ub_passback.setAttribute("id", "div-clmb-ctn-460179-1");
        ub_sticky = document.getElementById('adSmall');
        ub_sticky.appendChild(ub_passback);
    }else {
      ub_passback.setAttribute("data-ua", "M");
      ub_passback.setAttribute("data-slot", "460180");
      ub_passback.setAttribute("id", "div-clmb-ctn-460180-1");
      ub_sticky = document.getElementById('adSmall');
      ub_sticky.appendChild(ub_passback);
    }
  }
...
function googlePush(){
  ...
  mappings.adCode.push('/21928950349,22624156317/deepika_ipl_320x50');
  ...
  googletag.cmd.push(function() {
    ...
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-ub-1', ub_slot1, ['/21928950349,22624156317/deepika_ipl_320x50']);
      }
    });
  });
...
if (!mobileCheck() && (space > 160)) {
  ...
  mappings.adCode.push('/21928950349,22624156317/deepika.com_nb_160x600');
  ...
  googletag.cmd.push(function() {
    ...
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot2) {
        ub_checkAdRendered('div-ub-2', ub_slot2, ['/21928950349,22624156317/deepika.com_nb_160x600']);
      }
    });
  });
}
