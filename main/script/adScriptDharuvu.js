...
var adUnits = [
  // {
  //     code: '/21956238066/dharuvu.com_nb_320x50',
  //     mediaTypes: {
  //       native: {
  //         image: {
  //           // sizes: [300, 100],
  ...
  bids: [
    ...
    { bidder: 'smartadserver', params: { siteId: '362107', pageId: '1289608', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAll: ["US", "CA"] },
...
var ub_slot1;
googletag.cmd.push(function() {
  ub_slot1 = googletag.defineSlot('/21956238066/dharuvu.com_nb_320x50', div_1_sizes, 'div-gpt-ad-1593088518395-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21956238066/dharuvu.com_nb_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1593088518395-0';
...
function mainHbRun(){
  ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
      ...
      publisherDomain: 'http://www.dharuvu.com/',
