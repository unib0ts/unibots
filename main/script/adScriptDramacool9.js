...
function mobileCheck() {
  ...
  if (document.querySelector('#UB_300x250_1')) {
    document.querySelector('#UB_300x250_1').innerHTML = "<div id='div-gpt-ad-1639453879891-0'></div>";
  }
  if (document.querySelector('#UB_300x250_2')) {
    document.querySelector('#UB_300x250_2').innerHTML = "<div id='div-gpt-ad-1639453910647-0'></div>";
  }
  if (document.querySelector('#UB_728x90_1')) {
    document.querySelector('#UB_728x90_1').innerHTML = "<div id='div-gpt-ad-1639453931378-0'></div>";
  }
  if (document.querySelector('#UB_160x600_1')) {
    document.querySelector('#UB_160x600_1').innerHTML = "<div id='div-gpt-ad-1639453951517-0'></div>";
  }
    ...
    ubpbjs.que.push(function () {
      ...
      // });
        ...
        ubpbjs.setConfig({
            ...
            publisherDomain: "https://www.dramacool9.co/",
...
var hb_full_common_bidders = [
    { bidder: "appnexus", params: { placementId: "23796987" } }, /* one placementId for all sizes  my appnexus bidder */,
    // { bidder: 'oftmedia', params: { placementId: '4168843' } },
    { bidder: '33across', params: { siteId : 'aUpQ8SyU4r7kjgrkHcnlKl', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
...
var mappings_full_hb_config_desktop = {
    adUnitNames: [
        "/22126273586/dramacool9.co_pubfuture_160x600_1",
        "/22126273586/Dramacool9.co_pubfuture_300x250_1",
        "/22126273586/Dramacool9.co_pubfuture_300x250_2",
        "/22126273586/dramacool9.co_pubfuture_728x90_1"
    ],
    adId: [
          "div-gpt-ad-1639453879891-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1639453910647-0", //'/22140546871/bongdaplus.vn_in-article_336x280',
          "div-gpt-ad-1639453931378-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1639453951517-0" //'/22140546871/bongdaplus.vn_in-article_336x280',
    ],
    sizes: [
        [160, 600],
        [300, 250],
