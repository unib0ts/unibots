...
var adUnits = [
    {
        code: '/21928950349/dsrmedias.com_NB_320x50',
        mediaTypes: {
            banner: {
                sizes: div_1_sizes
            }
        ...
        bids: [
          ...
          { bidder: 'sovrn', params: {tagid: '714033'} },
          { bidder: 'openx', params: {unit: '541046587', delDomain: 'yieldbird-d.openx.net'} },
...
ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
     ...
     //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
      ...
      publisherDomain: 'www.dsrmedias.com',
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21928950349/dsrmedias.com_NB_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21928950349/dsrmedias.com_NB_320x50'],
