...
var adUnits = [{
  ...
  bids: [
    { bidder: 'appnexus', params: { placementId: '19054926', allowSmallerSizes: true } }, /* one placementId for all sizes  my appnexus bidder */
...
ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
     ...
     //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
      ...
      publisherDomain: 'https://www.freepressjournal.in/',
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21957769615/freepressjournal.in_NB_320x50'],
