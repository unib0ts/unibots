...
var adUnits = [
    {
        ...
        bids: [
        	{ bidder: 'appnexus', params: { placementId: '19054708', allowSmallerSizes: true } }, /* one placementId for all sizes  my appnexus bidder */
        	{ bidder: 'oftmedia', params: { placementId: '18671640', allowSmallerSizes: true } },
        	{ bidder: '33across', params: { siteId : 'asbDpqBuar6PWLaKlId8sQ:siab', productId: 'siab' } }, /*All sizes*/
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21928950349/facultyplus.com_nb_320x50'],
