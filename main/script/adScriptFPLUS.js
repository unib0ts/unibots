...
var adUnits = [{
  ...
  bids: [
    ...
    {
    	bidder: '33across',
    	params: {siteId: 'asbDpqBuar6PWLaKlId8sQ', productId: 'siab'}
    },
    {
    	bidder: 'emx_digital',
    	params: {tagid: '97470'}
...
googletag.cmd.push(function() {
  slot1 = googletag.defineSlot('/21928950349/facultyplus.com_nb_320x50', sizes, 'div-ub-1')
  ...
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  bidsBackHandler: function() {
			  ubpbjs.setTargetingForGPTAsync(['/21928950349/facultyplus.com_nb_320x50']);
