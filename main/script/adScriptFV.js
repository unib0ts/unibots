...
var adUnits = [
    {
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19028833', allowSmallerSizes: true } }, /* one placementId for all sizes  my appnexus bidder */
        	{ bidder: 'oftmedia', params: { placementId: '18677301', allowSmallerSizes: true } },
        	{ bidder: '33across', params: { siteId : 'aBehZsBuar6PWLaKlId8sQ:siab', productId: 'siab' } }, /*All sizes*/
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21928950349/freshersvoice.com_NB_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
var adUnits = [{
  ...
  bids: [
    ...
    {
    	bidder: '33across',
    	params: {siteId: 'aBehZsBuar6PWLaKlId8sQ', productId: 'siab'}
    },
    {
    	bidder: 'emx_digital',
    	params: {tagid: '97474'}
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21928950349/freshersvoice.com_NB_320x50'],
		  bidsBackHandler: function() {
			  ubpbjs.setTargetingForGPTAsync(['/21928950349/freshersvoice.com_NB_320x50']);
