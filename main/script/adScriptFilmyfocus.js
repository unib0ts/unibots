...
// if(document.getElementById('unibots-ad')){
  ...
  adUnits1 =
  {
      ...
      bids: [
        ...
        { bidder: 'ucfunnel', params: { adid : 'ad-BE78EE6EB26628EE077B9DE98322637E'} },
        { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '3028666'} },
        // { bidder: 'criteo', params: {networkId: '10542'} },
        // { bidder: 'criteointl', params: {networkId: '10545'} },
        { bidder: 'adyoulike', params: { placement: '2c2ca1653a87dd3ebe409bd5efbd611b'}, labelAll: ["US"] },
        { bidder: 'smartadserver', params: { siteId: '362115', pageId: '1289616', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"]},
...
//
//   slotID: 'div-gpt-ad-1588428540791-0',
//   slotName: '/21928950349,22560027500/filmyfocus.com_NB_320x50',
...
// if(document.getElementById('unibots-ad')){
  ...
  mappings.adCode.push('/21928950349,22560027500/filmyfocus.com_NB_320x50');
  mappings.sizes.push(div_1_sizes);
  mappings.adId.push('div-gpt-ad-1588428540791-0');
  googletag.cmd.push(function() {
    // callAPStagBids(); //Ap part
    // callAPSAds(mappings.adCode, mappings.slots);
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1588428540791-0', ub_slot1, ['/21928950349,22560027500/filmyfocus.com_NB_320x50']);
      }
    });
  });
// }
