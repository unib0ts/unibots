...
function initAdserver() {
    ...
    googletag.cmd.push(function() {
        ubpbjs.que.push(function() {
            ubpbjs.setTargetingForGPTAsync();
            console.log('ub init before refresh');
            googletag.pubads().refresh(mappings.slots);
            console.log('ub init after refresh');
        });
    });
}
...
function moreContent() {
       ...
       googletag.cmd.push(function() {
         ...
         var ub_div = document.createElement('div');
         ub_div.id = slot.getSlotElementId(); // auto-generated by GPT
         document.body.appendChild(ub_div);
