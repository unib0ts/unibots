...
var adUnits = [
  // {
  //     code: '/21956238066/headlinesoftoday.com_nb_320x50',
  //     mediaTypes: {
  //       native: {
  //         image: {
  //           // sizes: [300, 100],
  ...
  bids: [
    ...
    { bidder: 'appnexus', params: { placementId: '19054959' } }, /* one placementId for all sizes  my appnexus bidder */
    { bidder: 'sovrn', params: {tagid: '744363'} },
    // { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '2971089'} },
    { bidder: 'nobid', params: { siteId : '22052733076'} },
    { bidder: '33across', params: { siteId : 'ddZasyWuGr6PjyaKlId8sQ', productId: 'siab' } }, /*All sizes*/
...
ubpbjs.que.push(function() {
  ...
  ubpbjs.setConfig({
    ...
    publisherDomain: 'https://www.headlinesoftoday.com/',
...
var ub_slot1;
googletag.cmd.push(function() {
  ub_slot1 = googletag.defineSlot('/21956238066/headlinesoftoday.com_nb_320x50', div_1_sizes, 'div-gpt-ad-1593088563227-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21956238066/headlinesoftoday.com_nb_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1593088563227-0';
