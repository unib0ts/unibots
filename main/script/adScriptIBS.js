...
var adUnits = [
    {
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19055822' } },
    ...
    },
    {
        ...
        bids: [
          ...
          { bidder: 'smartadserver', params: { siteId: '362122', pageId: '1289623', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"] },
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=ibtimes';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
