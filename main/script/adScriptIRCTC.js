if(typeof customConfigObjectA === 'undefined'){
  ...
  // if((1<= currentTS) && (currentTS<=10)){
    if (document.getElementById('ATD_Ad_IR_320x50')) {
            adUnits1 =
            {
                ...
                bids: [
                 ...
                 // { bidder: 'oftmedia', params: { placementId: '21249046' } },
    ...
    if (document.getElementById('div-gpt-ad-1613413260012-0')) {
              adUnits1 =
              {
                  code: '/22082859479,22623808135/irctc.co.in_cb_300x250_1',
                  mediaTypes: {
                      banner: {
                          sizes: div_2_sizes
                      }
                  ...
                  bids: [
                   // { bidder: 'appnexus', params: { placementId: '20253127' } }, /* one placementId for all sizes  my appnexus bidder */
                   // // { bidder: 'sovrn', params: {tagid: '867074'} },
                   // // { bidder: 'smartadserver', params: { siteId: '372446', pageId: '1309517', formatId: '93232', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"] },
                   // // // //{ bidder: 'sonobi', params: { placement_id: 'e061c85c1bf277a0a913', ad_unit: 'ragalahari_NB_728x90' } },
                   // // { bidder: 'onetag', params: { pubId: '60c32c42465aac2' } },
                   ...
                   // { bidder: 'rhythmone', params: { placementId: '230378'}}, /* one placementId for all sizes */
                   // // // // // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
                   // { bidder: 'nobid', params: { siteId : '22316085852'} },
                    //{ bidder: 'adsolut', params: {zoneId: '107071', host: 'cpm.adsolut.in'} },
                    // { bidder: 'rubicon', params: {accountId: '11734', siteId: '323604', zoneId: '1680004'} }
                  ]
              };
  ...
  //               bids: [
  //                // { bidder: 'appnexus', params: { placementId: '20253127' } }, /* one placementId for all sizes  my appnexus bidder */
  //                // // { bidder: 'sovrn', params: {tagid: '867073'} },
  ...
  // function ubad1() {
    if (document.getElementById('ATD_Ad_IR_320x50')) {
      ...
      mappings.adCode.push('/22082859479,22623808135/irctc.co.in_hb_320x50');
      ...
      googletag.cmd.push(function() {
        ...
        googletag.pubads().addEventListener('slotRenderEnded', function(event) {
          if (event.slot === ub_slot1) {
            ub_checkAdRendered('div-gpt-ad-1601280866524-0', ub_slot1, ['/22082859479,22623808135/irctc.co.in_hb_320x50']);
          }
        });
      });
    }
    if (document.getElementById('div-gpt-ad-1613413260012-0')) {
      ...
      // apSlotTemp = {
      //   slotID: 'div-gpt-ad-1610698887085-0',
      //   slotName: '/22140546871/irctc.co.in_cb_300x250',
      //   sizes: mappings.sizes,
      // }
      // apSlots.push(apSlotTemp);

      mappings.slotNumbers.push(4);
      mappings.adCode.push('/22082859479,22623808135/irctc.co.in_cb_300x250_1');
      ...
      googletag.cmd.push(function() {
        ...
        googletag.pubads().addEventListener('slotRenderEnded', function(event) {
          if (event.slot === ub_slot4) {
            ub_checkAdRendered('div-gpt-ad-1613478315967-0', ub_slot4, ['/22082859479,22623808135/irctc.co.in_cb_300x250_1']);
          }
        });
      });
    }
  ...
  //           ub_checkAdRendered('div-gpt-ad-1626241363418-0', ub_slot2, ['/22082859479,22623808135/irctc.co.in_hb_320x50']);
  //         }
  //       });
  //     });
  //
  ...
  //
  //     // apSlotTemp = {
  //     //   slotID: 'div-gpt-ad-1613478315967-0',
  //     //   slotName: '/22082859479,22623808135/irctc.co.in_cb_300x250_1',
  //     //   sizes: mappings.sizes,
  //     // }
  //     // apSlots.push(apSlotTemp);
  //
  ...
  //           ub_checkAdRendered('div-gpt-ad-1613478315967-0', ub_slot5, ['/22082859479,22623808135/irctc.co.in_cb_300x250_1']);
  //         }
  //       });
  //     });
  //   }
  ...
  //     //   slotName: '/22142075243/irctc.co.in_hb_320x50',
  //     //   sizes: mappings.sizes,
  //     // }
  //     // apSlots.push(apSlotTemp);
  //
  ...
  //           ub_checkAdRendered('div-gpt-ad-1602953590737-0', ub_slot3, ['/22082859479,22623808135/irctc.co.in_hb_320x50']);
  //         }
  //       });
  //     });
  //   }
  ...
  //           ub_checkAdRendered('div-gpt-ad-1613478315967-0', ub_slot6, ['/22082859479,22623808135/irctc.co.in_cb_300x250_1']);
  //         }
  //       });
  //     });
  //   }
