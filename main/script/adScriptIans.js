...
// if(document.getElementById('newsbot-ads')){
  adUnits1 =
  {
      code: '/22153349741/ians.in_ub_320x50',
      mediaTypes: {
          banner: {
              sizes: div_1_sizes
          }
      ...
      bids: [
        { bidder: 'appnexus', params: { placementId: '22015293' } }, /* one placementId for all sizes  my appnexus bidder */
         	{ bidder: 'oftmedia', params: { placementId: '20846125' } },
         	{ bidder: '33across', params: { siteId : 'cpSPBqiEir7ikFaKj0P0Le', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
...
//   if(userStatusBM == ''){
//     var request = new XMLHttpRequest();
//     var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=ians';
//     request.open('GET', url, true);
//     request.onload = function() {
//       if (request.status >= 200 && request.status < 400) {
//         var data = request.responseText;
...
function googlePush(){
  ...
  mappings.adCode.push('/22153349741/ians.in_ub_320x50');
  mappings.sizes.push(div_1_sizes);
  mappings.adId.push('div-gpt-ad-1626772946328-0');
  apSlotTemp = {
  ...
  googletag.cmd.push(function() {
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1626772946328-0', ub_slot1, ['/22153349741/ians.in_ub_320x50']);
      }
    });
  });
    ...
    // });
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://www.ians.in/',
