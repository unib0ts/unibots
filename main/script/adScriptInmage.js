...
if(document.querySelectorAll('.image_listical')){
   inimagead_target('.image_listical', 'div-gpt-ad-1619515885003-0');
}
...
function inimagead_target(imagetargetdiv, adid) {
  ...
  for (i = 0; i < ub_targetimages.length; i++) {
    ...
    ubinimgage_adId.id = adid;
    document.querySelector('.ub_adinimge').appendChild(ubinimgage_adId)
  }
}
  ...
  googletag.cmd.push(function() {
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1619515885003-0', ub_slot1, ['/21928950349,22560027500/socialnews.xyz_ipl_320x50']);
      }
    });
  });
}
