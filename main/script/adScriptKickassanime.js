...
function mobileCheck() {
  ...
  if (document.querySelector('#UB_300x250')) {
    document.querySelector('#UB_300x250').innerHTML = "<div id='div-gpt-ad-1639404922001-0'></div>";
  }
  if (document.querySelector('#UB_300x250_2')) {
    document.querySelector('#UB_300x250_2').innerHTML = "<div id='div-gpt-ad-1639404945156-0'></div>";
  }
  if (document.querySelector('#UB_300x250_3')) {
    document.querySelector('#UB_300x250_3').innerHTML = "<div id='div-gpt-ad-1639404962277-0'></div>";
  }
  if (document.querySelector('#UB_728x90')) {
    document.querySelector('#UB_728x90').innerHTML = "<div id='div-gpt-ad-1639405037550-0'></div>";
  }
    ...
    ubpbjs.que.push(function () {
      ...
      // });
        ...
        ubpbjs.setConfig({
            ...
            publisherDomain: "https://www2.kickassanime.ro/",
...
var hb_full_common_bidders = [
    { bidder: "appnexus", params: { placementId: "23767648" } }, /* one placementId for all sizes  my appnexus bidder */,
    // { bidder: 'oftmedia', params: { placementId: '4168843' } },
    { bidder: '33across', params: { siteId : 'aCFoReyU4r7kjgrkHcnlKl', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
...
var mappings_full_hb_config_desktop = {
    adUnitNames: [
        "/21957769615/kickassanime.ro_pubfuture_300x250",
        "/21957769615/kickassanime.ro_pubfuture_300x250_2",
        "/21957769615/kickassanime.ro_pubfuture_300x250_3",
        "/21957769615/kickassanime.ro_pubfuture_728x90"
    ],
    adId: [
          "div-gpt-ad-1639404922001-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1639404945156-0", //'/22140546871/bongdaplus.vn_in-article_336x280',
          "div-gpt-ad-1639404962277-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1639405037550-0" //'/22140546871/bongdaplus.vn_in-article_336x280',
    ],
    sizes: [
        [300, 250],
        [300, 250],
