...
var adUnits = [
  {
      code: '/21928950349/kwttoday.com_nb_320x50_non-amp',
      mediaTypes: {
        native: {
          image: {
            // sizes: [300, 100],
  ...
  },
    {
        ...
        bids: [
        	{ bidder: 'appnexus', params: { placementId: '19028919', allowSmallerSizes: true } }, /* one placementId for all sizes  my appnexus bidder */
          ...
          { bidder: 'sovrn', params: {tagid: '714097'} },
          { bidder: 'criteo', params: {networkId: '4902'} },
          { bidder: 'openx', params: {unit: '541046615', delDomain: 'yieldbird-d.openx.net'} },
...
ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
     ...
     //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
      ...
      publisherDomain: 'https://kwttoday.com/',
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21928950349/kwttoday.com_nb_320x50_non-amp', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21928950349/kwttoday.com_nb_320x50_non-amp'],
