...
googletag.cmd.push(function() {
  slot1 = googletag.defineSlot('/21928950349/latestly.com_NB_320x50', sizes, 'div-ub-1')
  ...
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  bidsBackHandler: function() {
			  ubpbjs.setTargetingForGPTAsync(['/21928950349/latestly.com_NB_320x50']);
