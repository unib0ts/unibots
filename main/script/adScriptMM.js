...
adUnits1 = {
      code: '/21928950349,22623886349/maalaimalar.com_NB_320x50',
      mediaTypes: {
        native: {
          image: {
            // sizes: [300, 100],
...
adUnits1 = {
    ...
    bids: [
      ...
      { bidder: 'smartadserver', params: { siteId: '362127', pageId: '1289628', formatId: '93231', domain: 'https://prg8.smartadserver.com' }},
      ...
      { bidder: 'rubicon', params: {accountId: '23976', siteId: '400078', zoneId: '2265120'} }
    ]
  }
    adUnits.push(adUnits1);
...
mappings.adCode.push('/21928950349,22623886349/maalaimalar.com_NB_320x50');
...
googletag.cmd.push(function() {
  ...
  googletag.pubads().addEventListener('slotRenderEnded', function(event) {
    if (event.slot === ub_slot1) {
      ub_checkAdRendered('div-ub-1', ub_slot1, ['/21928950349,22623886349/maalaimalar.com_NB_320x50']);
    }
  });
});
