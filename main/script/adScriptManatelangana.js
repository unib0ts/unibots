...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/22126273586/manatelangana.news_320x50', div_1_sizes, 'div-gpt-ad-1633092882755-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/22126273586/manatelangana.news_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1633092882755-0';
