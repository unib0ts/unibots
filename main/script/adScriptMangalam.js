...
var adUnits = [
    {
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19056049', allowSmallerSizes: true } }, /* one placementId for all sizes  my appnexus bidder */
          { bidder: 'oftmedia', params: { placementId: '18677467', allowSmallerSizes: true } }
        ]
    },
    {
        code: '/21956916242/mangalam.com_nb_320x50',
        ...
        bids: [
        	{ bidder: 'appnexus', params: { placementId: '19056049', allowSmallerSizes: true } }, /* one placementId for all sizes  my appnexus bidder */
        	{ bidder: 'oftmedia', params: { placementId: '18677467', allowSmallerSizes: true } },
        	{ bidder: '33across', params: { siteId : 'a_OZjGBuar6PWLaKlId8sQ', productId: 'siab' } }, /*All sizes*/
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21956916242/mangalam.com_nb_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21956916242/mangalam.com_nb_320x50'],
