...
function mobileCheck() {
  ...
  if (document.querySelector('#UB_300x250')) {
    document.querySelector('#UB_300x250').innerHTML = "<div id='div-gpt-ad-1639405850040-0'></div>";
  }
  if (document.querySelector('#UB_300x250_2')) {
    document.querySelector('#UB_300x250_2').innerHTML = "<div id='div-gpt-ad-1639405869086-0'></div>";
  }
...
var mappings_full_hb_config_desktop = {
    ...
    bids: [
        hb_full_common_bidders.concat([
            ...
            { bidder: 'ucfunnel', params: { adid : 'ad-34B8342A2A792BBD03E379B744B93A78'} }
        ...
        hb_full_common_bidders.concat([
            ...
            { bidder: 'ucfunnel', params: { adid : 'ad-47B4872D2A644D330EE3ADB43A3BE346'} }
            // // // // //     { bidder: "kubient", params: { zoneid: "0cef49235ab77", server: "kssp.kbntx.ch"} },
            // // // // //     {bidder: 'coinzilla', params: {placementId: '23945aaa6cfc06141'} },
