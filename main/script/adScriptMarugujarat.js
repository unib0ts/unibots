...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21928950349/marugujarat.in_ipl_320x50', div_1_sizes, 'div-gpt-ad-1617875203945-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21928950349/marugujarat.in_ipl_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1617875203945-0';
