...
// if(document.getElementById('unibots-ad')){
  adUnits1 =
  {
      ...
      bids: [
        ...
        // { bidder: '33across', params: { siteId : 'dCLwaKNiqr64oSaKjGFx_2', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        ...
        // { bidder: 'openx', params: {unit: '544022768', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
        ...
        // { bidder: 'smartadserver', params: { siteId: '404705', pageId: '1370489', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"]},
