...
// if(document.getElementById('unibots-ad')){
  adUnits1 =
  {
      ...
      bids: [
        { bidder: 'appnexus', params: { placementId: '19199112' } }, /* one placementId for all sizes  my appnexus bidder */
        { bidder: 'oftmedia', params: { placementId: '23908985' } },
        { bidder: '33across', params: { siteId : 'drgJYGu30r7kDFrkHcnlxd', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        // { bidder: 'emx_digital', params: { tagid: '147570' } }, /* sizeless */
        // { bidder: 'sovrn', params: {tagid: '882929'} },
        { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '3579069'} },
        { bidder: 'openx', params: {unit: '545727791', delDomain: 'unibots-d.openx.net'}},
        // { bidder: 'rhythmone', params: { placementId: '205945'}}, /* one placementId for all sizes */
        // // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
        { bidder: 'nobid', params: { siteId : '22358104968'} },
        // { bidder: 'criteo', params: {networkId: '10542'} },
        // { bidder: 'criteointl', params: {networkId: '10545'} },
        { bidder: 'adyoulike', params: { placement: '2c2ca1653a87dd3ebe409bd5efbd611b'}, labelAll: ["US"] },
        // { bidder: 'smartadserver', params: { siteId: '404705', pageId: '1370489', formatId: '93231', domain: 'https://prg8.smartadserver.com' }},
...
//
//   slotID: 'div-gpt-ad-1617874903842-0',
//   slotName: '/21928950349,22560027500/marunadanmalayalee.com_ipl_320x50',
...
function ub_passback() {
  ...
  if (!mobileCheck()) {
      ...
      ub_passback.setAttribute("data-slot", "460187");
      ub_passback.setAttribute("id", "div-clmb-ctn-460187-1");
      ub_sticky = document.getElementById('adSmall');
      ub_sticky.appendChild(ub_passback);
  }else {
    ub_passback.setAttribute("data-ua", "M");
    ub_passback.setAttribute("data-slot", "460188");
    ub_passback.setAttribute("id", "div-clmb-ctn-460188-1");
    ub_sticky = document.getElementById('adSmall');
    ub_sticky.appendChild(ub_passback);
  }
}
...
// if(document.getElementById('unibots-ad')){
  ...
  mappings.adCode.push('/21928950349,22560027500/marunadanmalayalee.com_ipl_320x50');
  mappings.sizes.push(div_1_sizes);
  mappings.adId.push('div-gpt-ad-1617874903842-0');
  googletag.cmd.push(function() {
    // callAPStagBids(); //Ap part
    // callAPSAds(mappings.adCode, mappings.slots);
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1617874903842-0', ub_slot1, ['/21928950349,22560027500/marunadanmalayalee.com_ipl_320x50']);
      }
    });
  });
// }
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://marunadanmalayalee.com/',
