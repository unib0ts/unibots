...
googletag.cmd.push(function() {
  slot1 = googletag.defineSlot('/21956033520/mediaonetv.in_nb_320x50_new'', sizes, 'div-ub-1')
  ...
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  bidsBackHandler: function() {
			  ubpbjs.setTargetingForGPTAsync(['/21956033520/mediaonetv.in_nb_320x50_new'']);
