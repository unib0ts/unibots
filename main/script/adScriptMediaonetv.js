...
var adUnits = [{
  code: '/21956033520/mediaonetv.in_nb_320x50',
  mediaTypes: {
	  banner: {
		  sizes: sizes
	  }
...
ubpbjs.que.push(function() {
  ...
  ubpbjs.requestBids({
    ...
    adUnitCodes: ['/21956033520/mediaonetv.in_nb_320x50'],
...
googletag.cmd.push(function() {
  slot1 = googletag.defineSlot('/21956033520/mediaonetv.in_nb_320x50', sizes, 'div-ub-1')
  ...
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  bidsBackHandler: function() {
			  ubpbjs.setTargetingForGPTAsync(['/21956033520/mediaonetv.in_nb_320x50']);
