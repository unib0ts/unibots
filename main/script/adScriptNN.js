...
var adUnits = [{
  code: '/21928950349/nenow.in_NB_320x50',
  mediaTypes: {
	  banner: {
		  sizes: sizes
	  }
...
googletag.cmd.push(function() {
  slot1 = googletag.defineSlot('/21928950349/nenow.in_NB_320x50', sizes, 'div-ub-1')
  ...
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  bidsBackHandler: function() {
			  ubpbjs.setTargetingForGPTAsync(['/21928950349/nenow.in_NB_320x50']);
