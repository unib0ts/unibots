...
var adUnits = [{
  code: '/21957769615/nenow.in_NB_320x50',
  mediaTypes: {
	  banner: {
		  sizes: sizes
	  }
...
//    },
    ...
    {
    	bidder: '33across',
    	params: {siteId: 'bhgF8gBuar6PWLaKlId8sQ', productId: 'siab'}
//    },
//    {
//    	bidder: 'emx_digital',
//    	params: {tagid: '97488'}
...
ubpbjs.que.push(function() {
  ...
  ubpbjs.requestBids({
    ...
    adUnitCodes: ['/21957769615/nenow.in_NB_320x50'],
...
googletag.cmd.push(function() {
  slot1 = googletag.defineSlot('/21957769615/nenow.in_NB_320x50', sizes, 'div-ub-1')
	.addService(googletag.pubads());
  googletag.pubads().disableInitialLoad();
  googletag.pubads().enableSingleRequest();
  googletag.enableServices([slot1]);
  ...
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  bidsBackHandler: function() {
			  ubpbjs.setTargetingForGPTAsync(['/21957769615/nenow.in_NB_320x50']);
