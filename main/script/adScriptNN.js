...
var adUnits = [
  ...
  bids: [
    ...
    { bidder: 'openx', params: {unit: '541046195', delDomain: 'yieldbird-d.openx.net'} },
...
ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
     ...
     //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
      ...
      publisherDomain: 'https://nenow.in/',
...
var ub_slot1;
googletag.cmd.push(function() {
  ub_slot1 = googletag.defineSlot('/21957769615/nenow.in_NB_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
