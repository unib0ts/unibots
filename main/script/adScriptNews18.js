if(typeof customConfigObjectA === 'undefined'){
  unibot1 = '<div id="div-gpt-ad-1617187797231-0">';
  unibot2 = '<div id="div-gpt-ad-1617187825910-0">';
  ...
  if (document.getElementById('doto-mobile')) {
          adUnits1 =
          {
              code: '/21957769615/news18.com_quizbot_320x50',
              mediaTypes: {
                  banner: {
                      sizes: div_1_sizes
                  }
              ...
              bids: [
               { bidder: 'appnexus', params: { placementId: '21300067' } }, /* one placementId for all sizes  my appnexus bidder */
  ...
  if (document.getElementById('doto-desktop')) {
              adUnits1 =
              {
                  code: '/21957769615/news18.com_quizbot_468x60',
                  mediaTypes: {
                      banner: {
                          sizes: div_2_sizes
                      }
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://www.news18.com/',
  ...
  function googlePush(){
    ...
    if (document.getElementById('doto-mobile')) {
      ...
      mappings.adId.push('div-gpt-ad-1617187797231-0');
      googletag.cmd.push(function() {
        googletag.pubads().addEventListener('slotRenderEnded', function(event) {
          if (event.slot === ub_slot1) {
            ub_checkAdRendered('div-gpt-ad-1617187797231-0', ub_slot1, ['/21957769615/news18.com_quizbot_320x50']);
          }
        });
      });
    }
