...
var adUnits = [
    // {
    //     code: '/21956916242/outlookindia.com',
    //     mediaTypes: {
    //       native: {
    //         image: {
    //           // sizes: [300, 100],
    ...
    // },
    {
        ...
        bids: [
        	...
        	{ bidder: 'oftmedia', params: { placementId: '19679696' } },
        	{ bidder: '33across', params: { siteId : 'bHVc_UWuGr6PjyaKlId8sQ', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        	{ bidder: 'emx_digital', params: { tagid: '107923' } }, /* sizeless */
          ...
          { bidder: 'nobid', params: { siteId : '22049999713'} },
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21956916242/outlookindia.com', div_1_sizes, 'div-gpt-ad-1594109673364-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21956916242/outlookindia.com'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1594109673364-0';
