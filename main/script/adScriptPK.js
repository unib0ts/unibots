...
if (document.getElementById('unibots-ad')) {
  ...
  bids: [
    ...
    { bidder: 'openx', params: {unit: '543530457', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
    { bidder: 'oftmedia', params: { placementId: '20846125' } },
    { bidder: 'rhythmone', params: { placementId: '205945' } }, /* one placementId for all sizes */
    { bidder: 'ucfunnel', params: { adid : 'ad-273677B4D347E3E2CD986DB2DAA2333'} },
    // { bidder: 'criteo', params: {networkId: '10542'} },
    // { bidder: 'criteointl', params: {networkId: '10545'} },
    { bidder: 'nobid', params: { siteId : '22358104878'} },
    { bidder: 'smartadserver', params: { siteId: '362140', pageId: '1289641', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"] },
    //{ bidder: 'sonobi', params: { placement_id: 'e061c85c1bf277a0a913', ad_unit: 'ragalahari_NB_728x90' } },
    { bidder: 'onetag', params: { pubId: '60c32c42465aac2' } },
    { bidder: 'adkernel', params: {zoneId: '133842', host: 'cpm.fmlabsonline.com'} },
    { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '2996039'} },
...
apSlotTemp = {
  ...
  slotID: 'div-ub-1',
  slotName: '/21956916242/punjabkesari.in_NB_320x50',
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=punjabkesari';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
if (document.getElementById('unibots-ad')) {
 document.getElementById('unibots-ad').innerHTML = unibot1;
  ...
  mappings.adCode.push('/21956916242/punjabkesari.in_NB_320x50');
  ...
  googletag.cmd.push(function() {
    ...
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-ub-1', ub_slot1, ['/21956916242/punjabkesari.in_NB_320x50']);
      }
    });
  });
}
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://www.punjabkesari.in/',
