...
if (mobileCheck()) {
    ...
    z2.innerHTML =
        '<span class="mybotpopupCloseButton" id="mybotpopupCloseButton" onclick="mybotubPopadcls()" style="display:none">\u0078</span><div class="ub-popup-ad" id="div-gpt-ad-1640335573964-0"></div>';
    x2 = document.querySelector("body");
    x2.appendChild(z2);
}

if (document.querySelector('#UB_300x250')) {
    document.querySelector('#UB_300x250').innerHTML = "<div id='div-gpt-ad-1636457484324-0'></div>";
}
if (document.querySelector('#UB_336x280')) {
    document.querySelector('#UB_336x280').innerHTML = "<div id='div-gpt-ad-1636457512535-0'></div>";
}
    ...
    ubpbjs.que.push(function () {
      ...
      // });
        ...
        ubpbjs.setConfig({
            ...
            publisherDomain: "https://www.portal-islam.id/",
...
var hb_full_common_bidders = [
    ...
    { bidder: 'nobid', params: { siteId : '22657006298'} },
...
var mappings_full_hb_config_desktop = {
    adUnitNames: [
        "/21928950349/portal-islam.id_ub_300x250",
        "/21928950349/portal-islam.id_ub_336x280",
    ],
    adId: [
          "div-gpt-ad-1636457484324-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1636457512535-0", //'/22140546871/bongdaplus.vn_in-article_336x280',
    ],
    sizes: [
        [300, 250],
        [336, 280]
    ...
    bids: [
      hb_full_common_bidders.concat([
          { bidder: "pubmatic", params: { publisherId: "159448", adSlot: "4151361" } },
          { bidder: 'openx', params: {unit: '556412885', delDomain: 'unibots-d.openx.net'}},
          { bidder: 'ucfunnel', params: { adid : 'ad-D2347E93A2BE982EFD4383AE76299E4A'} },
          // // // // //     { bidder: "kubient", params: { zoneid: "0cef49235ab77", server: "kssp.kbntx.ch"} },
          // // // // //     {bidder: 'coinzilla', params: {placementId: '23945aaa6cfc06141'} },
              { bidder: 'sovrn', params: {tagid: '984635'} }
      ...
      hb_full_common_bidders.concat([
          { bidder: "pubmatic", params: { publisherId: "159448", adSlot: "4151362" } },
          { bidder: 'openx', params: {unit: '556412886', delDomain: 'unibots-d.openx.net'} },
          { bidder: 'ucfunnel', params: { adid : 'ad-D2347E93A4EAD444FDDB6744737D3D4D'} },
          // // // // //     { bidder: "kubient", params: { zoneid: "0cef49235ab77", server: "kssp.kbntx.ch"} },
          // // // // //     {bidder: 'coinzilla', params: {placementId: '23945aaa6cfc06141'} },
              { bidder: 'sovrn', params: {tagid: '984637'} }
...
var mappings_full_hb_config_mobile = {
  adUnitNames: [
      "/21928950349/portal-islam.id_ub_300x250",
      "/21928950349/portal-islam.id_ub_336x280",
      "/21928950349/portal-islam_popup",
  ],
  adId: [
        "div-gpt-ad-1636457484324-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
        "div-gpt-ad-1636457512535-0", //'/22140546871/bongdaplus.vn_in-article_336x280',
        "div-gpt-ad-1640335573964-0",
  ],
  sizes: [
      [300, 250],
      [336, 280],
  ...
  bids: [
      ...
      hb_full_common_bidders.concat([
          ...
          // // // // //     { bidder: "kubient", params: { zoneid: "0cef49235ab77", server: "kssp.kbntx.ch"} },
          // // // // //     {bidder: 'coinzilla', params: {placementId: '23945aaa6cfc06141'} },
              { bidder: 'sovrn', params: {tagid: '992254'} }
              // { bidder: 'oftmedia', params: { placementId: '4168844' } },
          // // // { bidder: 'smartadserver', params: { siteId: '399739', pageId: '1361921', formatId: '94418', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"] },
      ]),
  ],
...
if (mobileCheck()) {
  googletag.cmd.push(function () {
      googletag.pubads().addEventListener("slotRenderEnded", function (event) {
            if (event.slot.getAdUnitPath() ==="/21928950349/portal-islam_popup"){
              var nodes_anchr = document.getElementById("div-gpt-ad-1640335573964-0").childNodes[0].childNodes;
