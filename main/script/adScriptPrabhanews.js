...
var adUnits = [
    // {
    //     code: '/21928950349/prabhanews.com_ipl_320x50',
    //     mediaTypes: {
    //       native: {
    //         image: {
    //           // sizes: [300, 100],
    ...
    // },
    {
        ...
        bids: [
        	...
        	{ bidder: '33across', params: { siteId : 'd0wleQNiqr64oSaKjGFx_2', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        	// { bidder: 'emx_digital', params: { tagid: '107931' } }, /* sizeless */
          { bidder: 'sovrn', params: {tagid: '882927'} },
          { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '2945606'} },
          { bidder: 'openx', params: {unit: '544022766', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
        	// { bidder: 'rhythmone', params: { placementId: '205945'}}, /* one placementId for all sizes */
        	// // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
          { bidder: 'nobid', params: { siteId : '22358066081'} },
          // { bidder: 'criteo', params: {networkId: '10542'} },
          // { bidder: 'criteointl', params: {networkId: '10545'} },
          { bidder: 'adyoulike', params: { placement: '2c2ca1653a87dd3ebe409bd5efbd611b'}, labelAll: ["US"] },
          { bidder: 'smartadserver', params: { siteId: '404712', pageId: '1370496', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"]},
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21928950349/prabhanews.com_ipl_320x50', div_1_sizes, 'div-gpt-ad-1618059111605-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21928950349/prabhanews.com_ipl_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1618059111605-0';
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://prabhanews.com/',
