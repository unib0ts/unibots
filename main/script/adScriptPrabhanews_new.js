...
var adUnits = [
    // {
    //     code: '/21956916242/prabhanews.com_ub_320x50',
    //     mediaTypes: {
    //       native: {
    //         image: {
    //           // sizes: [300, 100],
    ...
    // },
    {
        ...
        bids: [
          ...
          { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '3910486'} },
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21956916242/prabhanews.com_ub_320x50', div_1_sizes, 'div-gpt-ad-1625486934846-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21956916242/prabhanews.com_ub_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1625486934846-0';
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://www.prabhanews.com/',
