...
var adUnits = [
    {
        ...
        bids: [
          ...
          { bidder: 'oftmedia', params: { placementId: '19095413' } }
        ]
    },
    {
        code: '/21957769615/prabhasakshi.com_nb_320x50',
        ...
        bids: [
          ...
          { bidder: 'openx', params: {unit: '543530439', delDomain: 'unibots-d.openx.net'} },
          ...
          { bidder: 'smartadserver', params: { siteId: '362139', pageId: '1289640', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAll: ["US", "CA"] },
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=prabhasakshi';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21957769615/prabhasakshi.com_nb_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21957769615/prabhasakshi.com_nb_320x50'],
