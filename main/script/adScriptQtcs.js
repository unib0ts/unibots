...
//   url = 'https://api.unibots.in/block?client=Dantri&page='+urlToCheck;
//
...
// }
  ...
  //             {
  //                asi:'aps.amazon.com',
  //                sid:'116', // Same seller_id for the publisher in sellers.json
  //                hp:1
  //              }
  //           ],
  //      }
...
if (mobileCheck()) {
  adUnits1 =
  {
      ...
      bids: [
        { bidder: 'appnexus', params: { placementId: '23738348' } }, /* one placementId for all sizes  my appnexus bidder */
        ...
        { bidder: 'openx', params: {unit: '556400377', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
