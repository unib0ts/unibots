...
var adUnits = [
    {
        ...
        bids: [
        	{ bidder: 'appnexus', params: { placementId: '19056632', allowSmallerSizes: true } }, /* one placementId for all sizes  my appnexus bidder */
        	{ bidder: 'oftmedia', params: { placementId: '18677503', allowSmallerSizes: true } },
          { bidder: '33across', params: { siteId : 'bKEogyBuar6PWLaKlId8sQ', productId: 'siab' } }, /*All sizes*/
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21956033520/raftaar.in_NB_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21956033520/raftaar.in_NB_320x50'],
...
var adUnits = [{
  ...
  bids: [
    ...
    {
    	bidder: '33across',
    	params: {siteId: 'bNbIJABuar6PWLaKlId8sQ', productId: 'siab'}
    },
    {
    	bidder: 'emx_digital',
    	params: {tagid: '97512'}
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21956033520/raftaar.in_NB_320x50'],
		  bidsBackHandler: function() {
			  ubpbjs.setTargetingForGPTAsync(['/21956033520/raftaar.in_NB_320x50']);
