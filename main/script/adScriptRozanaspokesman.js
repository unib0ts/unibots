...
if (botsiteurl=='www.rozanaspokesman.in') {
  adUnits1 =
  {
      ...
      bids: [
       ...
       { bidder: 'openx', params: {unit: '544026036', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
  ...
  adUnits1 =
  {
      ...
      bids: [
       ...
       // // // { bidder: 'emx_digital', params: { tagid: '97458' } }, /* sizeless */
       { bidder: 'openx', params: {unit: '544025963', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
       { bidder: 'rhythmone', params: { placementId: '205945'}}, /* one placementId for all sizes */
       // // // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
...
apSlotTemp = {
  ...
  slotID: 'div-gpt-ad-1618069044396-0',
  slotName: '/21956916242/rozanaspokesman_ipl_320x50',
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=rozanaspokesman';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
