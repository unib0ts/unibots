...
var adUnits = [];
  ...
  adUnits1 =
  {
      code: '/21928950349,22624158342/sandeshepaper.in_NB_320x50',
      mediaTypes: {
        native: {
          image: {
            // sizes: [300, 100],
  ...
  adUnits1 =
  {
        ...
        bids: [
        	{ bidder: 'appnexus', params: { placementId: '19057733' } }, /* one placementId for all sizes  my appnexus bidder */
        	{ bidder: 'oftmedia', params: { placementId: '20846125' } },
        	{ bidder: '33across', params: { siteId : 'au3uPAWuGr6PjyaKlId8sQ', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
          ...
          { bidder: 'smartadserver', params: { siteId: '362146', pageId: '1289647', formatId: '93231', domain: 'https://prg8.smartadserver.com' }},
...
//
//   slotID: 'div-ub-1',
//   slotName: '/21928950349,22624158342/sandeshepaper.in_NB_320x50',
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=sandeshepaper';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
mappings.adCode.push('/21928950349,22624158342/sandeshepaper.in_NB_320x50');
...
googletag.cmd.push(function() {
  ...
  googletag.pubads().addEventListener('slotRenderEnded', function(event) {
    if (event.slot === ub_slot1) {
      ub_checkAdRendered('div-ub-1', ub_slot1, ['/21928950349,22624158342/sandeshepaper.in_NB_320x50']);
    }
  });
});
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'http://sandeshepaper.in/',
