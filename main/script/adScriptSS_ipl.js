...
const customConfigObjectA = {
 "buckets" : [{
  ...
  if (document.getElementById('adsc_468')) {
    if (mobileCheck()) {
      adUnits1 =
      {
          code: '/21959913182/sakshi.com_sw_320x50',
          mediaTypes: {
              banner: {
                  sizes: div_1_sizes
              }
      ...
      adUnits1 =
      {
          code: '/21959913182/sakshi.com_sw_468x60',
          mediaTypes: {
              banner: {
                  sizes: div_2_sizes
              }
...
if (document.getElementById('adsc_468')) {
  if (mobileCheck()) {
    document.getElementById('adsc_468').innerHTML='<div id="div-gpt-ad-1618055651531-0"></div>';
    mappings.slotNumbers.push(1);
    mappings.adCode.push('/21959913182/sakshi.com_sw_320x50');
    mappings.sizes.push(div_1_sizes);
    mappings.adId.push('div-gpt-ad-1618055651531-0');
    googletag.cmd.push(function() {
      googletag.pubads().addEventListener('slotRenderEnded', function(event) {
        if (event.slot === ub_slot1) {
          ub_checkAdRendered('div-gpt-ad-1618055651531-0', ub_slot1, ['/21959913182/sakshi.com_sw_320x50']);
        }
      });
    });
  }
  else {
    document.getElementById('adsc_468').innerHTML='<div id="div-gpt-ad-1618055699124-0"></div>';
    mappings.slotNumbers.push(2);
    mappings.adCode.push('/21959913182/sakshi.com_sw_468x60');
    mappings.sizes.push(div_2_sizes);
    mappings.adId.push('div-gpt-ad-1618055699124-0');
    googletag.cmd.push(function() {
      googletag.pubads().addEventListener('slotRenderEnded', function(event) {
        if (event.slot === ub_slot2) {
          ub_checkAdRendered('div-gpt-ad-1618055699124-0', ub_slot2, ['/21959913182/sakshi.com_sw_468x60']);
        }
      });
    });
  }
