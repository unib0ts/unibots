...
//    },
    ...
    {
    	bidder: '33across',
    	params: {siteId: 'b0ax7GBuar6PWLaKlId8sQ', productId: 'siab'}
    },
    {
    	bidder: 'emx_digital',
    	params: {tagid: '97523'}
...
ubpbjs.que.push(function() {
  ...
  ubpbjs.requestBids({
    ...
    adUnitCodes: ['/21928950349/scoopwhoop.com_nb_320x50'],
  ...
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  bidsBackHandler: function() {
			  ubpbjs.setTargetingForGPTAsync(['/21928950349/scoopwhoop.com_nb_320x50']);
