...
var adUnits = [
    {
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19140450', allowSmallerSizes: true } }
        ]
    },
    {
        code: '/21956916242/shivpurisamachaar.com_nb_320x50',
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19140450', allowSmallerSizes: true } }, /* one placementId for all sizes  my appnexus bidder */
          ...
          { bidder: 'sovrn', params: {tagid: '718929'} },
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21956916242/shivpurisamachaar.com_nb_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21956916242/shivpurisamachaar.com_nb_320x50'],
