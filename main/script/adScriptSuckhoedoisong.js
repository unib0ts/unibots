...
// apSlots = []
  ...
  if (!mobileCheck() && (window.screen.availWidth > 1024)) {
          ...
          z1.innerHTML =
              '<span class="close_ub-sticky-addesk" id="close_ub-sticky-addesk" onclick="mybotubstickyadDesk()"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/close.svg"></span><div class="ub-sticky-adDesk" id="div-gpt-ad-1635827007959-0"></div';
  ...
  adUnits1 =
  {
      code: '/21928950349/suckhoedoisong.vn_balloon_300x250',
      mediaTypes: {
          banner: {
              sizes: div_1_sizes
          }
      ...
      bids: [
        // { bidder: 'appnexus', params: { placementId: '971611' } }, /* one placementId for all sizes  my appnexus bidder */
        ...
        { bidder: 'openx', params: {unit: '545739332', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
        { bidder: 'ucfunnel', params: { adid : 'ad-2736DAA49A6EE69AC8282DD4AA3497EB'} },
        // // // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
        // // // //{ bidder: 'adsolut', params: {zoneId: '107071', host: 'cpm.adsolut.in'} },
        // // { bidder: 'criteo', params: {networkId: '10542'} },
        // // { bidder: 'criteointl', params: {networkId: '10545'} },
        { bidder: 'onetag', params: { pubId: '60c32c42465aac2' } },
        { bidder: 'adyoulike', params: { placement: 'd4b280097ccedbab52c697d6d79e0d0e'}, labelAll: ["US"] },
      ]
  };
...
function mybotubScript() {
  ...
  setTimeout(function() {
    ...
    //
    //   slotID: 'div-gpt-ad-1635827007959-0',
    //   slotName: '/21928950349/suckhoedoisong.vn_balloon_300x250',
  ...
  if (!mobileCheck() && (window.screen.availWidth > 1024)) {
    ...
    mappings.adCode.push('/21928950349/suckhoedoisong.vn_balloon_300x250');
    mappings.sizes.push(div_1_sizes);
    mappings.adId.push('div-gpt-ad-1635827007959-0');
    googletag.cmd.push(function() {
      // callAPStagBids(); //Ap part
      // callAPSAds(mappings.adCode, mappings.slots);
      googletag.pubads().addEventListener('slotRenderEnded', function(event) {
        if (event.slot === ub_slot1) {
          ub_checkAdRendered('div-gpt-ad-1635827007959-0', ub_slot1, ['/21928950349/suckhoedoisong.vn_balloon_300x250']);
        }
      });
    });
    }
