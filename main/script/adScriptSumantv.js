...
var adUnits = [
    // {
    //     code: '/21928950349/sumantv.com_ub_320x50',
    //     mediaTypes: {
    //       native: {
    //         image: {
    //           // sizes: [300, 100],
    ...
    // },
    {
        ...
        bids: [
        	...
        	{ bidder: 'oftmedia', params: { placementId: '23909017' } },
          ...
          { bidder: 'sovrn', params: {tagid: '921911'} },
          { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '3796462'} },
          { bidder: 'openx', params: {unit: '544096396', delDomain: 'unibots-d.openx.net'}},
        	// // { bidder: 'rhythmone', params: { placementId: '205945'}}, /* one placementId for all sizes */
        	// // // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
          { bidder: 'nobid', params: { siteId : '22604972507'} },
          // // { bidder: 'criteo', params: {networkId: '10542'} },
          // // { bidder: 'criteointl', params: {networkId: '10545'} },
          { bidder: 'adyoulike', params: { placement: '2ae55db8a34b479636e7281b5665b0a6'}, labelAll: ["US"] },
          // { bidder: 'smartadserver', params: { siteId: '404710', pageId: '1370494', formatId: '93231', domain: 'https://prg8.smartadserver.com' }},
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21928950349/sumantv.com_ub_320x50', div_1_sizes, 'div-gpt-ad-1623754512664-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21928950349/sumantv.com_ub_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1623754512664-0';
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://sumantv.com/',
