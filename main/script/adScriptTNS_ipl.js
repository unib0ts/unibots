...
// if(document.getElementById('unibots-ad')){
  adUnits1 =
  {
      code: '/21928950349/twentyfournews.com_320x50_ipl',
      mediaTypes: {
          banner: {
              sizes: div_1_sizes
          }
      ...
      bids: [
        ...
        { bidder: '33across', params: { siteId : 'dW4bEUNiqr64oSaKjGFx_2', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        { bidder: 'emx_digital', params: { tagid: '147574' } }, /* sizeless */
        { bidder: 'sovrn', params: {tagid: '882926'} },
        { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '3579736'} },
        { bidder: 'openx', params: {unit: '544022763', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
...
apSlotTemp = {
  ...
  slotID: 'div-gpt-ad-1617895725745-0',
  slotName: '/21928950349/twentyfournews.com_320x50_ipl',
...
// if(document.getElementById('unibots-ad')){
  ...
  mappings.adCode.push('/21928950349/twentyfournews.com_320x50_ipl');
  mappings.sizes.push(div_1_sizes);
  mappings.adId.push('div-gpt-ad-1617895725745-0');
  googletag.cmd.push(function() {
    callAPStagBids(); //Ap part
    callAPSAds(mappings.adCode, mappings.slots);
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1617895725745-0', ub_slot1, ['/21928950349/twentyfournews.com_320x50_ipl']);
      }
    });
  });
// }
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://twentyfournews.com/',
