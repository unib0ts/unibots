...
function mobileCheck() {
  ...
  if (document.querySelector('#UB_300x250_1')) {
    document.querySelector('#UB_300x250_1').innerHTML = "<div id='div-gpt-ad-1639721218126-0'></div>";
  }
  if (document.querySelector('#UB_300x250_2')) {
    document.querySelector('#UB_300x250_2').innerHTML = "<div id='div-gpt-ad-1639721232111-0'></div>";
  }
  if (document.querySelector('#UB_160x600_1')) {
    document.querySelector('#UB_160x600_1').innerHTML = "<div id='div-gpt-ad-1639721167645-0'></div>";
  }
  if (document.querySelector('#UB_160x600_2')) {
    document.querySelector('#UB_160x600_2').innerHTML = "<div id='div-gpt-ad-1639721202647-0'></div>";
  }
    ...
    ubpbjs.que.push(function () {
      ...
      // });
        ...
        ubpbjs.setConfig({
            ...
            publisherDomain: "https://talkwithstranger.com/",
...
var hb_full_common_bidders = [
    { bidder: "appnexus", params: { placementId: "23852499" } }, /* one placementId for all sizes  my appnexus bidder */,
    { bidder: 'oftmedia', params: { placementId: '23909004' } },
    { bidder: '33across', params: { siteId : 'a2hjHIyU4r7kjgrkHcnlKl', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
    ...
    { bidder: 'nobid', params: { siteId : '22662778906'} },
...
var mappings_full_hb_config_desktop = {
    adUnitNames: [
        "/22126273586/talkwithstranger.com_bidgear_300x250_1",
        "/22126273586/talkwithstranger.com_bidgear_300x250_2",
        "/22126273586/talkwithstranger.com_bidgear_160x600_1",
        "/22126273586/talkwithstranger.com_bidgear_160x600_2"
        
    ],
    adId: [
          "div-gpt-ad-1639721218126-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1639721232111-0", //'/22140546871/bongdaplus.vn_in-article_336x280',
          "div-gpt-ad-1639721167645-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1639721202647-0" //'/22140546871/bongdaplus.vn_in-article_336x280',
    ],
    sizes: [
        [300, 250],
        [300, 250],
    ...
    bids: [
        ...
        hb_full_common_bidders.concat([
            { bidder: "pubmatic", params: { publisherId: "159448", adSlot: "4207245" } },
            // { bidder: 'openx', params: {unit: '556400374', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
            { bidder: 'ucfunnel', params: { adid : 'ad-8A2939A42DA87A89C97A6A6846E8D46'} },
            // // // // //     { bidder: "kubient", params: { zoneid: "0cef49235ab77", server: "kssp.kbntx.ch"} },
            // // // // //     {bidder: 'coinzilla', params: {placementId: '23945aaa6cfc06141'} },
                { bidder: 'sovrn', params: {tagid: '991136'} }
                // { bidder: 'oftmedia', params: { placementId: '4168844' } },
            // // // { bidder: 'smartadserver', params: { siteId: '399739', pageId: '1361921', formatId: '94418', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"] },
        ]),
        hb_full_common_bidders.concat([
            { bidder: "pubmatic", params: { publisherId: "159448", adSlot: "4207242" } },
            // { bidder: 'openx', params: {unit: '556400375', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
            { bidder: 'ucfunnel', params: { adid : 'ad-E2B4A427B48D79BE0ED32AB2D826B9E'} },
            // // // // //     { bidder: "kubient", params: { zoneid: "0cef49235ab77", server: "kssp.kbntx.ch"} },
            // // // // //     {bidder: 'coinzilla', params: {placementId: '23945aaa6cfc06141'} },
                { bidder: 'sovrn', params: {tagid: '991137'} }
                // { bidder: 'oftmedia', params: { placementId: '4168843' } },
                  // { bidder: 'oftmedia', params: { placementId: '4168843' } },
            // // // { bidder: 'smartadserver', params: { siteId: '399739', pageId: '1361921', formatId: '94418', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"] },
        ]),
        hb_full_common_bidders.concat([
            { bidder: "pubmatic", params: { publisherId: "159448", adSlot: "4207243" } },
            // { bidder: 'openx', params: {unit: '556400374', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
            { bidder: 'ucfunnel', params: { adid : 'ad-2736E67D3A34E2A3186729B6ADB2E363'} },
            // // // // //     { bidder: "kubient", params: { zoneid: "0cef49235ab77", server: "kssp.kbntx.ch"} },
            // // // // //     {bidder: 'coinzilla', params: {placementId: '23945aaa6cfc06141'} },
                { bidder: 'sovrn', params: {tagid: '991138'} }
                // { bidder: 'oftmedia', params: { placementId: '4168844' } },
            // // // { bidder: 'smartadserver', params: { siteId: '399739', pageId: '1361921', formatId: '94418', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"] },
        ]),
        hb_full_common_bidders.concat([
