...
var adUnits = [
    {
        code: '/21957769615/techz.vn_nb_320x50',
        mediaTypes: {
          native: {
            image: {
              // sizes: [300, 100],
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19425351' } },
         { bidder: 'oftmedia', params: { placementId: '19679697' } }
        ]
    },
    {
        code: '/21957769615/techz.vn_nb_320x50',
        ...
        bids: [
          ...
          { bidder: 'sovrn', params: {tagid: '735403'} },
          ...
          { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '3028644'} },
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21957769615/techz.vn_nb_320x50', div_1_sizes, 'div-gpt-ad-1591007091535-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21957769615/techz.vn_nb_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1591007091535-0';
