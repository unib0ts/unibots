...
mybotBlockedUrl = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/blocks/blocksTechz.json';
...
if(typeof mybotBlockedPagesFlag !== 'undefined' && mybotBlockedPagesFlag ==1){
  ...
  if (mobileCheck()) {
    adUnits1 =
    {
        code: '/22142075243/techz.vn_hb_300x100',
        mediaTypes: {
            banner: {
                sizes: div_1_sizes
            }
  ...
  apSlotTemp = {
    ...
    slotID: 'div-gpt-ad-1620990477801-0',
    slotName: '/22142075243/techz.vn_hb_300x100',
...
function mybotubScript() {
  ...
  s4.async = true;
  s4.setAttribute("id", "AV61388d7227e73a2a28598054");
  s4.type = "text/javascript";
  s4.src = "https://tg1.aniview.com/api/adserver/spt?AV_TAGID=61388d7227e73a2a28598054&AV_PUBLISHERID=5fd9c7d93f2f4c6ef13a1ec7";
  ...
  if (mobileCheck()) {
    ...
    mappings.adCode.push('/22142075243/techz.vn_hb_300x100');
    mappings.sizes.push(div_1_sizes);
    mappings.adId.push('div-gpt-ad-1620990477801-0');
    googletag.cmd.push(function() {
      callAPStagBids(); //Ap part
      callAPSAds(mappings.adCode, mappings.slots);
      googletag.pubads().addEventListener('slotRenderEnded', function(event) {
        if (event.slot === ub_slot1) {
          ub_checkAdRendered('div-gpt-ad-1620990477801-0', ub_slot1, ['/22142075243/techz.vn_hb_300x100']);
        }
      });
    });
