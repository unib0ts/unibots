...
var adUnits = [
  // {
  //     code: '/21956238066/teluguglobal.in_nb_320x50',
  //     mediaTypes: {
  //       native: {
  //         image: {
  //           // sizes: [300, 100],
  ...
  bids: [
    ...
    { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '4052955'} },
    { bidder: 'nobid', params: { siteId : '22052735863'} },
    // { bidder: 'rubicon', params: {accountId: '11734', siteId: '323618', zoneId: '1680026'} },
    { bidder: 'rhythmone', params: { placementId: '205377'}}, /* one placementId for all sizes */
    { bidder: 'openx', params: {unit: '543530292', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
    { bidder: 'smartadserver', params: { siteId: '362152', pageId: '1289653', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"] },
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=teluguglobal';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
var ub_slot1;
googletag.cmd.push(function() {
  ub_slot1 = googletag.defineSlot('/21956238066/teluguglobal.in_nb_320x50', div_1_sizes, 'div-gpt-ad-1593088751106-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21956238066/teluguglobal.in_nb_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1593088751106-0';
...
function mainHbRun(){
  ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
      ...
      publisherDomain: 'https://www.teluguglobal.in/',
