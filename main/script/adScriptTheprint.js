 ...
 "buckets" : [{
  ...
  adUnits1 =
  {
      ...
      bids: [
       ...
       { bidder: 'adyoulike', params: { placement: 'b128-0iEmr7kSQaKlKyvbs'}, labelAll: ["US"] },
       // // { bidder: 'criteo', params: {networkId: '10542'} },
       // // { bidder: 'criteointl', params: {networkId: '10545'} },
       { bidder: 'oftmedia', params: { placementId: '20846125' } },
       { bidder: 'adkernel', params: {zoneId: '133844', host: 'cpm.fmlabsonline.com'} },
       ...
       // // // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
        { bidder: 'nobid', params: { siteId : '22315894538'} },
...
ubpbjs.que.push(function() {
    ...
    ubpbjs.bidderSettings = {
      ...
      'adkernel': { bidCpmAdjustment: function(bidCpm){ let temp = bidCpm*1.00; temp = temp - 0.0323; return temp>0? temp: 0;} }
    };
    ubpbjs.setConfig({
      floors: {
        currency: 'USD',
     ...
     //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
      ...
      publisherDomain: 'https://theprint.in/',
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=theprint';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
