...
var adUnits = [{
  code: '/21928950349/timeskerala.com_NB_320x50',
  mediaTypes: {
	  banner: {
		  sizes: sizes
	  }
...
ubpbjs.que.push(function() {
  ...
  ubpbjs.requestBids({
    ...
    adUnitCodes: ['/21928950349/timeskerala.com_NB_320x50'],
  ...
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  bidsBackHandler: function() {
			  ubpbjs.setTargetingForGPTAsync(['/21928950349/timeskerala.com_NB_320x50']);
