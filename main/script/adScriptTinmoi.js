...
mybotBlockedUrl = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/blocks/blocksTinmoi.json';
mybotBlockedClientName = 'tinmoi';
...
// apSlots = []
  ...
  adUnits1 =
  {
      code: '/22126273586/tinmoi.vn_hb_300x250',
      mediaTypes: {
          banner: {
              sizes: div_1_sizes
          }
...
function mybotubScript() {
  ...
  setTimeout(function() {
    ...
    //
    //   slotID: 'div-gpt-ad-1631605123353-0',
    //   slotName: '/22126273586/tinmoi.vn_hb_300x250',
  ...
  if (!mobileCheck() && (window.screen.availWidth > 1024)) {
    ...
    mappings.adCode.push('/22126273586/tinmoi.vn_hb_300x250');
    mappings.sizes.push(div_1_sizes);
    mappings.adId.push('div-gpt-ad-1631605123353-0');
    googletag.cmd.push(function() {
      // callAPStagBids(); //Ap part
      // callAPSAds(mappings.adCode, mappings.slots);
      googletag.pubads().addEventListener('slotRenderEnded', function(event) {
        if (event.slot === ub_slot1) {
          ub_checkAdRendered('div-gpt-ad-1631605123353-0', ub_slot1, ['/22126273586/tinmoi.vn_hb_300x250']);
        }
      });
    });
    }
