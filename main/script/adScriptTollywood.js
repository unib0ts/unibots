...
var adUnits = [
    ...
    // },
    {
        ...
        bids: [
        	...
        	{ bidder: 'oftmedia', params: { placementId: '23909001' } },
        	{ bidder: '33across', params: { siteId : 'bQ3K0MiEmr7kSQaKlKyvbs', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        	// // { bidder: 'emx_digital', params: { tagid: '107931' } }, /* sizeless */
          { bidder: 'sovrn', params: {tagid: '970129'} },
          { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '4051398'} },
          { bidder: 'openx', params: {unit: '545727843', delDomain: 'unibots-d.openx.net'}},
        	// // // { bidder: 'rhythmone', params: { placementId: '205945'}}, /* one placementId for all sizes */
        	// // // // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
          { bidder: 'nobid', params: { siteId : '22656516391'} },
...
function ub_passback() {
  ...
  if (!mobileCheck()) {
      ...
      ub_passback.setAttribute("data-slot", "460169");
      ub_passback.setAttribute("id", "div-clmb-ctn-460169-1");
      ub_sticky = document.getElementById('adSmall');
      ub_sticky.appendChild(ub_passback);
  }else {
    ub_passback.setAttribute("data-ua", "M");
    ub_passback.setAttribute("data-slot", "460170");
    ub_passback.setAttribute("id", "div-clmb-ctn-460170-1");
    ub_sticky = document.getElementById('adSmall');
    ub_sticky.appendChild(ub_passback);
  }
}
