...
var div_2_sizes = [125, 125];
var adUnits = [];

  adUnits1 =
  {
        code: '/21928950349,22624317069/tupaki.com_ipl_300x100',
        mediaTypes: {
            banner: {
                sizes: div_1_sizes
            }
        ...
        bids: [
          ...
          { bidder: 'openx', params: {unit: '544022781', delDomain: 'unibots-d.openx.net'}},
          ...
          { bidder: 'smartadserver', params: { siteId: '404713', pageId: '1370497', formatId: '94416', domain: 'https://prg8.smartadserver.com' }},
          // //{ bidder: 'sonobi', params: { placement_id: 'e061c85c1bf277a0a913', ad_unit: 'ragalahari_NB_728x90' } },
          { bidder: 'onetag', params: { pubId: '60c32c42465aac2' } },
          { bidder: 'ucfunnel', params: { adid : 'ad-9A298627A99EDE4914B39687742A2336'} },
  ...
  // adUnits1 =
  // {
  //       code: '/21928950349,22624317069/tupaki.com_ipl_125x125',
  //       mediaTypes: {
  //           banner: {
  //               sizes: div_2_sizes
  //           }
  ...
  //         // // { bidder: 'sovrn', params: {tagid: '882932'} },
  //         // // { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '3581649'} },
  //         // // { bidder: 'openx', params: {unit: '544022781', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
  //       	// // { bidder: 'rhythmone', params: { placementId: '205945'}}, /* one placementId for all sizes */
  //       	// // // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
  //         // { bidder: 'nobid', params: { siteId : '22012436374'} },
  //         // // { bidder: 'criteo', params: {networkId: '10542'} },
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=tupaki';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
mappings.adCode.push('/21928950349,22624317069/tupaki.com_ipl_300x100');
mappings.sizes.push(div_1_sizes);
mappings.adId.push('div-gpt-ad-1617905562342-0');
// apSlotTemp = {
//   slotID: 'div-gpt-ad-1617905562342-0',
//   slotName: '/21928950349,22624317069/tupaki.com_ipl_300x100',
...
googletag.cmd.push(function() {
  googletag.pubads().addEventListener('slotRenderEnded', function(event) {
    if (event.slot === ub_slot1) {
      ub_checkAdRendered('div-gpt-ad-1617905562342-0', ub_slot1, ['/21928950349,22624317069/tupaki.com_ipl_300x100']);
    }
  });
});

// mappings.slotNumbers.push(2);
// mappings.adCode.push('/21928950349,22624317069/tupaki.com_ipl_125x125');
// mappings.sizes.push(div_2_sizes);
// mappings.adId.push('div-gpt-ad-1625226501905-0');
// apSlotTemp = {
//   slotID: 'div-gpt-ad-1625226501905-0',
//   slotName: '/21928950349,22624317069/tupaki.com_ipl_125x125',
//   sizes: mappings.sizes,
// }
// apSlots.push(apSlotTemp);
...
//       ub_checkAdRendered('div-gpt-ad-1625226501905-0', ub_slot2, ['/21928950349,22624317069/tupaki.com_ipl_125x125']);
//     }
//   });
// });
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://tupaki.com/',
