...
const customConfigObjectA = {
 "buckets" : [{
  ...
  adUnits1 =
  {
    code: '/21928950349/udayavani_cb_320x50',
    mediaTypes: {
      native: {
        image: {
          // sizes: [300, 100],
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=udayavani';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
function googlePush(){
  ...
  mappings.adCode.push('/21928950349/udayavani_cb_320x50');
  mappings.sizes.push(div_1_sizes);
  mappings.adId.push('div-gpt-ad-1637646219690-0');
  apSlotTemp = {
  ...
  googletag.cmd.push(function() {
    googletag.pubads().addEventListener('slotRenderEnded', function(event) {
      if (event.slot === ub_slot1) {
        ub_checkAdRendered('div-gpt-ad-1637646219690-0', ub_slot1, ['/21928950349/udayavani_cb_320x50']);
      }
    });
  });
