...
var adUnits = [
  {
      code: '/21928950349/uttarbangasambad.com_nb_320x50',
      mediaTypes: {
        native: {
          image: {
            // sizes: [300, 100],
      ...
      bids: [
        ...
        { bidder: 'appnexus', params: { placementId: '19057814' } }
      ]
  },
    {
        code: '/21928950349/uttarbangasambad.com_nb_320x50',
        ...
        bids: [
        	{ bidder: 'appnexus', params: { placementId: '19057814' } }, /* one placementId for all sizes  my appnexus bidder */
        	{ bidder: 'oftmedia', params: { placementId: '20846125' } },
        	{ bidder: '33across', params: { siteId : 'apmzH8WuGr6PjyaKlId8sQ', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        	//{ bidder: 'emx_digital', params: { tagid: '97448' } }, /* sizeless */
          { bidder: 'sovrn', params: {tagid: '714255'} },
          // { bidder: 'criteo', params: {networkId: '10542'} },
          // { bidder: 'criteointl', params: {networkId: '10545'} },
          { bidder: 'openx', params: {unit: '543530215', delDomain: 'unibots-d.openx.net'}},
          { bidder: 'nobid', params: { siteId : '22049999770'} },
          { bidder: 'smartadserver', params: { siteId: '362159', pageId: '1289660', formatId: '93231', domain: 'https://prg8.smartadserver.com' }},
          //{ bidder: 'sonobi', params: { placement_id: 'e061c85c1bf277a0a913', ad_unit: 'ragalahari_NB_728x90' } },
          { bidder: 'onetag', params: { pubId: '60c32c42465aac2' } },
          // { bidder: 'adkernel', params: {zoneId: '126378', host: 'cpm.fmlabsonline.com'} },
          { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '2996053'} },
          { bidder: 'adyoulike', params: { placement: '2c2ca1653a87dd3ebe409bd5efbd611b'}, labelAll: ["US"] },
          { bidder: 'ucfunnel', params: { adid : 'ad-34B844ED282B794DF3BD8A986B9A72E6'} },
          //{ bidder: 'adsolut', params: {zoneId: '107071', host: 'cpm.adsolut.in'} },
        	//{ bidder: 'rhythmone', params: { placementId: '205372' } }, /* one placementId for all sizes */
        	// { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
            { bidder: 'rubicon', params: {accountId: '23976', siteId: '400078', zoneId: '2265442'} }
        ]
    }
];
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=uttarbangasambad';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21928950349/uttarbangasambad.com_nb_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21928950349/uttarbangasambad.com_nb_320x50'],
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'uttarbangasambad.com/',
