...
var ub_slot1;
googletag.cmd.push(function() {
  ub_slot1 = googletag.defineSlot('/21957769615/webgiaitri.vn_nb_320x50', div_1_sizes, 'div-gpt-ad-1592499169435-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21957769615/webgiaitri.vn_nb_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1592499169435-0';
