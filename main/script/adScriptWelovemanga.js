...
function mobileCheck() {
  ...
  if (document.querySelector('#UB_300x250_1')) {
    document.querySelector('#UB_300x250_1').innerHTML = "<div id='div-gpt-ad-1639452969131-0'></div>";
  }
  if (document.querySelector('#UB_300x250_2')) {
    document.querySelector('#UB_300x250_2').innerHTML = "<div id='div-gpt-ad-1639453105845-0'></div>";
  }
    ...
    ubpbjs.que.push(function () {
      ...
      // });
        ...
        ubpbjs.setConfig({
            ...
            publisherDomain: "https://welovemanga.net/home",
...
var hb_full_common_bidders = [
    { bidder: "appnexus", params: { placementId: "23796968" } }, /* one placementId for all sizes  my appnexus bidder */,
    // { bidder: 'oftmedia', params: { placementId: '4168843' } },
    { bidder: '33across', params: { siteId : 'aJBjzkyU4r7kjgrkHcnlKl', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
    ...
    { bidder: 'nobid', params: { siteId : '22661303640'} },
...
var mappings_full_hb_config_desktop = {
    adUnitNames: [
        "/22126273586/welovemanga.net_pubfuture_300x250_1",
        "/22126273586/welovemanga.net_pubfuture_300x250_2"
    ],
    adId: [
          "div-gpt-ad-1639452969131-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1639453105845-0" //'/22140546871/bongdaplus.vn_in-article_336x280',
    ],
    sizes: [
        [300, 250],
        [300, 250]
    ...
    bids: [
        hb_full_common_bidders.concat([
            ...
            // // // // //     {bidder: 'coinzilla', params: {placementId: '23945aaa6cfc06141'} },
                { bidder: 'sovrn', params: {tagid: '991141'} }
                // { bidder: 'oftmedia', params: { placementId: '4168843' } },
                  // { bidder: 'oftmedia', params: { placementId: '4168843' } },
        ...
        hb_full_common_bidders.concat([
            ...
            // // // // //     { bidder: "kubient", params: { zoneid: "0cef49235ab77", server: "kssp.kbntx.ch"} },
            // // // // //     {bidder: 'coinzilla', params: {placementId: '23945aaa6cfc06141'} },
                { bidder: 'sovrn', params: {tagid: '991142'} }
