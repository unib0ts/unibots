...
var adUnits = [
    {
        code: '/21956916242/whatisyoga.in_nb_320x50',
        mediaTypes: {
          native: {
            image: {
              // sizes: [300, 100],
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19140489', allowSmallerSizes: true } }
        ]
    },
    {
        code: '/21956916242/whatisyoga.in_nb_320x50',
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19140489', allowSmallerSizes: true } }, /* one placementId for all sizes  my appnexus bidder */
          ...
          { bidder: 'sovrn', params: {tagid: '718931'} },
...
ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
     ...
     //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
      ...
      publisherDomain: 'https://whatisyoga.in/',
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21956916242/whatisyoga.in_nb_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21956916242/whatisyoga.in_nb_320x50'],
