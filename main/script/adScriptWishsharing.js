...
var mybotadTarget = '<script type="text/javascript">google_ad_client = "ca-pub-5200956238394958";google_ad_slot = "wishsharing.com_adx_320x50_1";google_ad_width = 320;google_ad_height = 50;</script><script type="text/javascript" src="//pagead2.googlesyndication.com/pagead/show_ads.js"></script>';
    ...
    var ub_adgebra=document.createElement('div');
    ub_adgebra.src='http://localhost/unibots/main/script/adgebra.html';
    document.getElementById('unibots-ad').appendChild(ub_adgebra)
     // var ad_scrpt3 = document.createElement('script');
     // ad_scrpt3.type = "text/javascript";
  	 // ad_scrpt3.setAttribute("google_ad_client", "ca-pub-5200956238394958");
     ...
     // ad_scrpt4.src = "https://pagead2.googlesyndication.com/pagead/show_ads.js";
