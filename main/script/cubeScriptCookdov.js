...
var mybotstyleSheet ="#div-clmb-ctn-466074-1{width: auto !important; z-index: 2147483647 !important;} #div-clmb-ctn-466075-1{width: auto !important;z-index: 2147483647 !important;} #ifr_466074-1{bottom: 135px !important;} #ifr_466075-1{bottom: 120px !important;}";
var css = document.createElement("style");
css.type = "text/css";
css.appendChild(document.createTextNode(mybotstyleSheet));
document.getElementsByTagName("head")[0].appendChild(css);

mybotGACode = 'G-0703STL603';
mybotgabywa = '<script async src="https://www.googletagmanager.com/gtag/js?id='+mybotGACode+'"></script><script>window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag("js", new Date());gtag("config", "'+mybotGACode+'");</script>';
  ...
  loadAd("gabywa");
   ...
   //   if (!mobileCheck()) {
   //      try{
   //      colombia.refresh('div-clmb-ctn-466074-1');
   //      cubespinnervisibility();
   //      }catch(e){}
   //  }else {
   //    try{
   //       colombia.refresh('div-clmb-ctn-466075-1');
   //       cubespinnervisibility();
   //    }catch(e){}
   //  }
   // }, 30000);
 ...
 function ub_passback1() {
       ...
       if (!mobileCheck()) {
           ...
           ub_passback.setAttribute("data-slot", "466074");
           ub_passback.setAttribute("id", "div-clmb-ctn-466074-1");
           document.getElementsByTagName("body")[0].appendChild(ub_passback);
       }else {
         ub_passback.setAttribute("data-ua", "M");
         ub_passback.setAttribute("data-slot", "466075");
         ub_passback.setAttribute("id", "div-clmb-ctn-466075-1");
         document.getElementsByTagName("body")[0].appendChild(ub_passback);
       }
 ...
 function cubespinnervisibility() {
   ...
   function clmbdiv() {
       if (!mobileCheck()) {
         if (document.querySelector('#div-clmb-ctn-466074-1').childNodes) {
           if (document.querySelector('#div-clmb-ctn-466074-1').childNodes[0]) {
                 ub_iframe = document.getElementById('ifr_466074-1');
         ...
         if (document.querySelector('#div-clmb-ctn-466075-1').childNodes) {
           if (document.querySelector('#div-clmb-ctn-466075-1').childNodes[0]) {
                 ub_iframe = document.getElementById('ifr_466075-1');
                 ub_innerDoc = (ub_iframe.contentDocument) ? ub_iframe.contentDocument : ub_iframe.contentWindow.document;
                 ub_innerDoc = ub_innerDoc.querySelector('.main_div_swiper');
