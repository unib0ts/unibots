...
var mybotstyleSheet ="#div-clmb-ctn-465593-1{width: auto !important;z-index: 2147483647 !important;} #div-clmb-ctn-465594-1{width: auto !important;z-index: 2147483647 !important;} #ifr_465593-1{bottom: 60px !important;} #ifr_465594-1{bottom: 60px !important;}";
...
mybotgabywa = '<script async src="https://www.googletagmanager.com/gtag/js?id='+mybotGACode+'"></script><script>window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag("js", new Date());gtag("config", "'+mybotGACode+'");</script>';
  ...
  z1.id = "div-gpt-ad-1636385700829-0";
  ...
  url = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/script/adScriptNtnews.js?cb='+cachebuster;
  ...
  document.body.appendChild(s2);
   ...
   //   if (!mobileCheck()) {
   //      try{
   //      colombia.refresh('div-clmb-ctn-465593-1');
 ...
 function ub_passback1() {
       ...
       if (!mobileCheck()) {
           ...
           ub_passback.setAttribute("data-slot", "465593");
           ub_passback.setAttribute("id", "div-clmb-ctn-465593-1");
           document.getElementsByTagName("body")[0].appendChild(ub_passback);
       }else {
         ub_passback.setAttribute("data-ua", "M");
         ub_passback.setAttribute("data-slot", "465594");
         ub_passback.setAttribute("id", "div-clmb-ctn-465594-1");
         document.getElementsByTagName("body")[0].appendChild(ub_passback);
       }
 ...
 function cubespinnervisibility() {
   ...
   function clmbdiv() {
       if (!mobileCheck()) {
         if (document.querySelector('#div-clmb-ctn-465593-1').childNodes) {
           if (document.querySelector('#div-clmb-ctn-465593-1').childNodes[0]) {
                 ub_iframe = document.getElementById('ifr_465593-1');
         ...
         if (document.querySelector('#div-clmb-ctn-465594-1').childNodes) {
           if (document.querySelector('#div-clmb-ctn-465594-1').childNodes[0]) {
                 ub_iframe = document.getElementById('ifr_465594-1');
                 ub_innerDoc = (ub_iframe.contentDocument) ? ub_iframe.contentDocument : ub_iframe.contentWindow.document;
                 ub_innerDoc = ub_innerDoc.querySelector('.main_div_swiper');
