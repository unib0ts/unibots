...
var mybotstyleSheet ="#div-clmb-ctn-466738-1{width: auto !important;z-index: 2147483646 !important;} #div-clmb-ctn-466739-1{width: auto !important;z-index: 2147483646 !important;} #ifr_466738-1{bottom: 0px !important; left: 130px !important;} #ifr_466739-1{bottom: 110px !important;height:172px !important;left: -20px !important;}";
...
//     }
//   }else {
//     if (document.getElementById('div-clmb-ctn-466739-1')) {
...
// function ubadScript() {
 ...
 function mybotScrollStart(){
 	if (100 <= (window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop)) {
    if (!mobileCheck()) {
        if (document.getElementById('div-clmb-ctn-466738-1')) {
            document.getElementById('div-clmb-ctn-466738-1').style.display = 'block';
        }
      }else {
        if (document.getElementById('div-clmb-ctn-466739-1')) {
           document.getElementById('div-clmb-ctn-466739-1').style.display = 'block';
        }
      }
 		// }
 	}else {
