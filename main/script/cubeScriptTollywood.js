...
var mybotstyleSheet ="#div-clmb-ctn-465701-1{width: auto !important;float:right !important;z-index: 2147483647 !important;} #div-clmb-ctn-465702-1{width: auto !important;float:right !important;z-index: 2147483647 !important;} #ifr_465701-1{right:0px !important;left: unset !important;bottom: 135px !important;} #ifr_465702-1{right:0px !important;left: unset !important;bottom: 55px !important;} .ub-close {pointer-events: all;cursor: pointer;width: 20px;position: absolute;top: -24px;left: 0;} .ub-cmpgn-ad {color: rgb(255,255,255);line-height: 11px;border-radius: 5px;font-size: 10px;width: 100px;position: absolute;bottom: -8px;text-align: center;right: 10px;background-repeat: no-repeat;  background-position: center;background-color: rgb(23,71,158);} .mybotbowl-imagelv{width:120px; height:160px;pointer-events: all;cursor: pointer;}";
...
if (!mobileCheck()) {
  z1.style = "width:320px;height:50px;float:right;text-align:center;position:fixed;bottom:130px;right:5px;z-index:99";
}else {
  z1.style = "width:320px;height:50px;float:right;text-align:center;position:fixed;bottom:0px !important;right:5px;z-index:99";
}
...
// function ubadScript() {
  ...
  z_ub = document.createElement("div");
  z_ub.id = "caricature-continer";
  z_ub.innerHTML = '<div id="ub-cmpgn-ad" href="https://unibots.in/?utm_source=unibots&utm_medium=cubeadwidget" class="ub-cmpgn-ad">Powered by Unibots</div><img class="mybotbowl-imagelv" src="https://cdn.unibots.in/coronaWidget/cmpgn_img/mastermahendran.png"><div class="ub-close" id="ub-close" style="right: 5px;" onclick="mybotcaricature()"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/close.svg"></div>';
  if (!mobileCheck()) {
    z_ub.style = "width:120px;float:right;text-align:center;position:fixed;bottom:190px;right:5px;z-index:99";
  }else {
    z_ub.style = "width:120px;transform: translateX(-50%);position:fixed;bottom:60px !important;left:50%;z-index:99";
  }
  x1 = document.querySelector("body");
  x1.appendChild(z_ub);
...
function mybotcaricature() {
  document.getElementById('div-gpt-ad-1632141731305-0').style.display = 'none';
  document.getElementById('caricature-continer').style.display = 'none';
}
   // ub_passback1();
 ...
 function loadAd(id, adUnits) {
  ...
  document.querySelector('.mybotbowl-imagelv').addEventListener('click', function() {
    window.open('https://bit.ly/3JbLEX3?utm_source=unibots&utm_medium=cmpgnwidget', '_blank');
   });
}
