...
document.getElementsByTagName("head")[0].appendChild(css);
  ...
  loadAd("gabywa");
   ...
   function cubespinnervisibility() {
     ...
     function clmbdiv() {
           ub_refresh("#div-clmb-ctn-465702-1", "ifr_465702-1", ub_clmb);
     }
   }
   ...
   function ub_refresh(clmbdiv_id, clmbiframe_id, ub_clmb ) {
     if (document.querySelector(clmbdiv_id) && document.querySelector(clmbdiv_id).childNodes && document.querySelector(clmbdiv_id).childNodes[0]) {
