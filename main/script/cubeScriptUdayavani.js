...
// }
 ...
 function ub_passback1() {
       ...
       if (!mobileCheck()) {
           ...
           ub_passback.setAttribute("data-slot", "466514");
           ub_passback.setAttribute("id", "div-clmb-ctn-466514-1");
           document.getElementsByTagName("body")[0].appendChild(ub_passback);
       }
       else {
         ub_passback.setAttribute("data-ua", "M");
         ub_passback.setAttribute("data-slot", "466515");
         ub_passback.setAttribute("id", "div-clmb-ctn-466515-1");
         document.getElementsByTagName("body")[0].appendChild(ub_passback);
       }
 ...
 function cubespinnervisibility() {
   ...
   function clmbdiv() {
       if (!mobileCheck()) {
         if (document.querySelector('#div-clmb-ctn-466514-1').childNodes) {
           if (document.querySelector('#div-clmb-ctn-466514-1').childNodes[0]) {
                 ub_iframe = document.getElementById('ifr_466514-1');
         ...
         if (document.querySelector('#div-clmb-ctn-466515-1').childNodes) {
           if (document.querySelector('#div-clmb-ctn-466515-1').childNodes[0]) {
                 ub_iframe = document.getElementById('ifr_466515-1');
                 ub_innerDoc = (ub_iframe.contentDocument) ? ub_iframe.contentDocument : ub_iframe.contentWindow.document;
                 ub_innerDoc = ub_innerDoc.querySelector('.main_div_swiper');
