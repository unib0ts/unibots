...
var adUnits = [
  // {
  //     code: '/21957769615/tt24h.vn_nb_320x50',
  //     mediaTypes: {
  //       native: {
  //         image: {
  //           // sizes: [300, 100],
  ...
  bids: [
    ...
    { bidder: 'appnexus', params: { placementId: '19518183' } }, /* one placementId for all sizes  my appnexus bidder */
    { bidder: 'sovrn', params: {tagid: '741304'} },
    ...
    { bidder: 'nobid', params: { siteId : '22045891289'} },
    { bidder: 'smartadserver', params: { siteId: '362158', pageId: '1289659', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"] },
...
var ub_slot1;
googletag.cmd.push(function() {
  ub_slot1 = googletag.defineSlot('/21957769615/tt24h.vn_nb_320x50', div_1_sizes, 'div-gpt-ad-1592498929902-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21957769615/tt24h.vn_nb_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1592498929902-0';
...
function mainHbRun(){
  ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
      ...
      publisherDomain: 'https://tt24h.vn/',
