...
var adUnits = [
    ...
    // },
    {
        ...
        bids: [
          ...
          { bidder: 'adyoulike', params: { placement: '2c2ca1653a87dd3ebe409bd5efbd611b'}, labelAll: ["US"] }, /* one placementId for all sizes */
          // { bidder: "kubient", params: { zoneid: "3752710459b1f", server: "kssp.kbntx.ch"} },
        	// { bidder: 'oftmedia', params: { placementId: '18671523' } },
        	{ bidder: '33across', params: { siteId : 'bW0ZA8WuGr6PjyaKlId8sQ', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        	// { bidder: 'emx_digital', params: { tagid: '97458' } }, /* sizeless */
          { bidder: 'sovrn', params: {tagid: '740650'} },
          { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '2970795'} },
          // { bidder: 'openx', params: {unit: '541046026', delDomain: 'yieldbird-d.openx.net'} },
        	// { bidder: 'rhythmone', params: { placementId: '205372'}}, /* one placementId for all sizes */
        	// { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
          { bidder: 'nobid', params: { siteId : '22045890851'} },
