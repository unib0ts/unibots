...
var adUnits = [
    ...
    },
    {
        ...
        bids: [
          ...
          { bidder: 'openx', params: {unit: '543851456', delDomain: 'unibots-d.openx.net'} },
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=almowaten';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
