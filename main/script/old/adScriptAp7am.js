...
var adUnits = [
    {
        code: '/21957769615/ap7am.com_NB_320x50',
        mediaTypes: {
          native: {
            image: {
              // sizes: [300, 100],
    ...
    },
    {
        ...
        bids: [
          ...
          //{ bidder: 'adsolut', params: {zoneId: '107071', host: 'cpm.adsolut.in'} },
        	{ bidder: 'oftmedia', params: { placementId: '19196682' } },
        	{ bidder: '33across', params: { siteId : 'cbf4RKOrar6OkfaKlId8sQ', productId: 'siab' } }, /*All sizes*/
        	// { bidder: 'emx_digital', params: { tagid: '97458' } }, /* sizeless */
          { bidder: 'sovrn', params: {tagid: '721731'} },
...
ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
     ...
     //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
      ...
      publisherDomain: 'https://www.ap7am.com/',
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21957769615/ap7am.com_NB_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21957769615/ap7am.com_NB_320x50'],
