...
var adUnits = [
    {
        code: '/21956033520/celebrityborn.com_nb_320x50',
        mediaTypes: {
          native: {
            image: {
              // sizes: [300, 100],
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19202082' } }
        ]
    },
    {
        code: '/21956033520/celebrityborn.com_nb_320x50',
        ...
        bids: [
        	...
        	{ bidder: '33across', params: { siteId : 'cI3rJeOrar6OkfaKlId8sQ', productId: 'siab' } }, /*All sizes*/
...
ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
     ...
     //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
      ...
      publisherDomain: 'https://www.celebrityborn.com/',
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21956033520/celebrityborn.com_nb_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21956033520/celebrityborn.com_nb_320x50'],
