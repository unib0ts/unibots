...
var adUnits = [
    {
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19056288' } }
        ]
    },
    {
        code: '/21956033520/prabhatkhabar.com_NB_320x50',
        ...
        bids: [
        	{ bidder: 'appnexus', params: { placementId: '19056288' } }, /* one placementId for all sizes  my appnexus bidder */
          ...
          { bidder: 'sovrn', params: {tagid: '716629'} },
          { bidder: 'openx', params: {unit: '541046233', delDomain: 'yieldbird-d.openx.net'} },
...
ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
     ...
     //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
      ...
      publisherDomain: 'https://www.prabhatkhabar.com/',
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21956033520/prabhatkhabar.com_NB_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
