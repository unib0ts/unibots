...
var adUnits = [{
  code: '/21928950349/stylecraze.com_nb_320x50',
  mediaTypes: {
	  banner: {
		  sizes: sizes
	  }
...
ubpbjs.que.push(function() {
  ...
  ubpbjs.requestBids({
    ...
    adUnitCodes: ['/21928950349/stylecraze.com_nb_320x50'],
...
googletag.cmd.push(function() {
  slot1 = googletag.defineSlot('/21928950349/stylecraze.com_nb_320x50', sizes, 'div-ub-1').addService(googletag.pubads());
  ...
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  bidsBackHandler: function() {
			  ubpbjs.setTargetingForGPTAsync(['/21928950349/stylecraze.com_nb_320x50']);
