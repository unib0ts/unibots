...
var adUnits = [
    {
        code: '/21957769615/suckhoedoisong.vn_nb_320x50',
        mediaTypes: {
          native: {
            image: {
              // sizes: [300, 100],
        ...
        bids: [
          { bidder: 'appnexus', params: { placementId: '19307550' } }
        ]
    },
    {
        code: '/21957769615/suckhoedoisong.vn_nb_320x50',
        ...
        bids: [
          ...
          { bidder: 'sovrn', params: {tagid: '730850'} },
...
ubpbjs.que.push(function() {
    ...
    ubpbjs.setConfig({
     ...
     //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
      ...
      publisherDomain: 'http://suckhoedoisong.vn',
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21957769615/suckhoedoisong.vn_nb_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21957769615/suckhoedoisong.vn_nb_320x50'],
