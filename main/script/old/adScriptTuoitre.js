...
var adUnits = [
  // {
  //     code: '/21957769615/tuoitre.vn_nb_336x280',
  //     mediaTypes: {
  //       native: {
  //         image: {
  //           // sizes: [300, 100],
  ...
  bids: [
    ...
    { bidder: 'smartadserver', params: { siteId: '362165', pageId: '1289667', formatId: '93418', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"] },
    ...
    { bidder: 'openx', params: {unit: '543530130', delDomain: 'unibots-d.openx.net'} },
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=tuoitre';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
var ub_slot1;
googletag.cmd.push(function() {
  ub_slot1 = googletag.defineSlot('/21957769615/tuoitre.vn_nb_336x280', div_1_sizes, 'div-gpt-ad-1594966245140-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  timeout: PREBID_TIMEOUT,
		  adUnitCodes: ['/21957769615/tuoitre.vn_nb_336x280'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1594966245140-0';
