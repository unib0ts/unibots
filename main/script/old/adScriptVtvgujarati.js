...
var adUnits = [
    ...
    },
    {
        ...
        bids: [
        	...
        	// { bidder: 'oftmedia', params: { placementId: '18671527' } },
        	{ bidder: '33across', params: { siteId : 'bB5BXWWuGr6PjyaKlId8sQ', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
        	// { bidder: 'emx_digital', params: { tagid: '97460' } }, /* sizeless */
          { bidder: 'sovrn', params: {tagid: '735400'} },
          { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '2945488'} },
          ...
          { bidder: 'smartadserver', params: { siteId: '362162', pageId: '1289663', formatId: '93231', domain: 'https://prg8.smartadserver.com' }, labelAny: ["US", "CA"] },
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=vtvgujarati';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21956033520/vtvgujarati.com_nb_320x50', div_1_sizes, 'div-gpt-ad-1591423019840-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21956033520/vtvgujarati.com_nb_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1591423019840-0';
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://www.vtvgujarati.com/',
