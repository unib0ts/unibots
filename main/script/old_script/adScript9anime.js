...
function mobileCheck() {
  ...
  if (document.querySelector('#UB_300x250_1')) {
    document.querySelector('#UB_300x250_1').innerHTML = "<div id='div-gpt-ad-1639722945561-0'></div>";
  }
  if (document.querySelector('#UB_300x250_2')) {
    document.querySelector('#UB_300x250_2').innerHTML = "<div id='div-gpt-ad-1639722977841-0'></div>";
  }
  if (document.querySelector('#UB_970x250_1')) {
    document.querySelector('#UB_970x250_1').innerHTML = "<div id='div-gpt-ad-1639722997431-0'></div>";
  }
    ...
    ubpbjs.que.push(function () {
      ...
      // });
        ...
        ubpbjs.setConfig({
            ...
            publisherDomain: "https://9anime.to/",
...
var hb_full_common_bidders = [
    { bidder: "appnexus", params: { placementId: "23852640" } }, /* one placementId for all sizes  my appnexus bidder */,
...
var mappings_full_hb_config_desktop = {
    adUnitNames: [
        "/22126273586/9anime.to_bidgear_300x250_1",
        "/22126273586/9anime.to_bidgear_300x250_2",
        "/22126273586/9anime.to_bidgear_970x250_1"
    ],
    adId: [
          "div-gpt-ad-1639722945561-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1639722977841-0", //'/22140546871/bongdaplus.vn_in-article_336x280',
          "div-gpt-ad-1639722997431-0" //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
    ],
    sizes: [
        [300, 250],
        [300, 250],
