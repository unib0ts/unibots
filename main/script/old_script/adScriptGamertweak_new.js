...
//   };
  ...
  ubslotdiv.id ="div-gpt-ad-1636976525804-0";
  ubslotdiv.innerHTML = "<script>googletag.cmd.push(function() {googletag.display('div-gpt-ad-1636976525804-0');});</script>"; // Id must be the same as slotName
  document.getElementById("unibots1").appendChild(ubslotdiv)
...
// function 	ub_ad() {
  ...
  googletag.cmd.push(function() {
        ...
        ubslot_1 = googletag.defineSlot('/21928950349,21806813315/gamertweak_ub_300x250_320x50_1', [300, 250], 'unibots1')
        ...
        googletag.enableServices();
          googletag.pubads().refresh([ubslot_1]);
      });
...
function ub_infinite() {
  ...
  // for(var i=0; i<mapping_hb.targetUnits.length; i++){
      ...
      targetUnit = document.querySelectorAll("unibots1");
      ...
      if (targetUnit != undefined && targetUnit.innerHTML == "") {
        ...
        googletag.cmd.push(function() {
          ...
          if (!mobileCheck()) {
             ubslotid =  googletag.defineSlot('/21928950349,21806813315/gamertweak_ub_300x250_320x50_1', [300, 250]);
          }else {
            ubslotid =  googletag.defineSlot('/21928950349,21806813315/gamertweak_ub_300x250_320x50_1', [320, 50]);
          }
          ubslotid.setTargeting("test","infinitescroll").addService(googletag.pubads());
          ubslotdiv = document.createElement('div');
          ubslotdiv.id = ubslotid.getSlotElementId(); //auto-generated by GPT
          targetUnit.appendChild(ubslotdiv);
          googletag.display(ubslotid);
