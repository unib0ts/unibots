...
var adUnits = [
    {
        code: '/21928950349/kesharinews24.com_320x50_ipl',
        mediaTypes: {
            banner: {
                sizes: div_1_sizes
            }
        ...
        bids: [
        	...
        	{ bidder: 'oftmedia', params: { placementId: '23909015' } },
        	{ bidder: '33across', params: { siteId : 'dctJ2eu30r7kDFrkHcnlxd', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
          ...
          { bidder: 'openx', params: {unit: '544022820', delDomain: 'unibots-d.openx.net'}},
        	// { bidder: 'rhythmone', params: { placementId: '205945'}}, /* one placementId for all sizes */
        	// // { bidder: 'eplanning', params: { ci: '2cfed', ml: '1' } },
          { bidder: 'nobid', params: { siteId : '22358066084'} },
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=kesharinews24';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21928950349/kesharinews24.com_320x50_ipl', div_1_sizes, 'div-gpt-ad-1617938388743-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21928950349/kesharinews24.com_320x50_ipl'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1617938388743-0';
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://kesharinews24.com/',
