...
var adUnits = [
    ...
    },
    {
        ...
        bids: [
        	{ bidder: 'appnexus', params: { placementId: '19056049' } }, /* one placementId for all sizes  my appnexus bidder */
        	{ bidder: 'oftmedia', params: { placementId: '23908990' } },
...
if(document.getElementById('unibot1')){
  ...
  adUnits1 = {
      ...
      bids: [
        ...
        { bidder: 'smartadserver', params: { siteId: '362130', pageId: '1289631', formatId: '93232', domain: 'https://prg8.smartadserver.com' }},
        // //{ bidder: 'adsolut', params: {zoneId: '107071', host: 'cpm.adsolut.in'} },
