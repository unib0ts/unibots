...
var adUnits = [
    // {
    //     code: '/21928950349/newsthen.com_ipl_320x50',
    //     mediaTypes: {
    //       native: {
    //         image: {
    //           // sizes: [300, 100],
    ...
    // },
    {
        ...
        bids: [
          ...
          { bidder: 'pubmatic', params: { publisherId : '159448', adSlot: '3586028'} },
          { bidder: 'openx', params: {unit: '544022775', delDomain: 'unibots-d.openx.net'}, labelAny: ["US", "CA"] },
...
function callBotman(){
  if(userStatusBM == ''){
    var request = new XMLHttpRequest();
    var url = 'https://ep7.10777.api.botman.ninja/ic2.php?m=AF&t=prebid&s=10777&b=10777&s15=newsthen';
    request.open('GET', url, true);
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        var data = request.responseText;
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/21928950349/newsthen.com_ipl_320x50', div_1_sizes, 'div-gpt-ad-1617896138065-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21928950349/newsthen.com_ipl_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1617896138065-0';
  ...
  ubpbjs.que.push(function() {
      ...
      ubpbjs.setConfig({
       ...
       //consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
        ...
        publisherDomain: 'https://www.reporterlive.com/',
