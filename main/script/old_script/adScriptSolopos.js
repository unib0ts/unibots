...
var adUnits = [
  {
      ...
      bids: [
        { bidder: 'appnexus', params: { placementId: '19054395' } },
        // { bidder: 'oftmedia', params: { placementId: '19095453' } }
      ]
  },
  {
  code: '/21956916242/solopos.com_nb_320x50',
  ...
  bids: [
    ...
    { bidder: 'appnexus', params: { placementId: '19054395' } }, /* one placementId for all sizes  my appnexus bidder */
    // { bidder: 'oftmedia', params: { placementId: '19095453' } },
    ...
    { bidder: 'smartadserver', params: { siteId: '362149', pageId: '1289650', formatId: '93231', domain: 'https://prg8.smartadserver.com' }},
...
var ub_slot1;
googletag.cmd.push(function() {
  ub_slot1 = googletag.defineSlot('/21956916242/solopos.com_nb_320x50', div_1_sizes, 'div-ub-1').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/21956916242/solopos.com_nb_320x50'],
