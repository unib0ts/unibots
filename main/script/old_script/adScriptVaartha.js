...
var adUnits = [
    // {
    //     code: '/22126273586/vaartha.in_ipl_320x50',
    //     mediaTypes: {
    //       native: {
    //         image: {
    //           // sizes: [300, 100],
    ...
    // },
    {
        ...
        bids: [
        	{ bidder: 'appnexus', params: { placementId: '22656896' } }, /* one placementId for all sizes  my appnexus bidder */
          ...
          { bidder: 'pubmatic', params: { publisherId : '866236', adSlot: '4051666'} },
...
var ub_slot1;
googletag.cmd.push(function() {
    ub_slot1 = googletag.defineSlot('/22126273586/vaartha.in_ipl_320x50', div_1_sizes, 'div-gpt-ad-1632141759605-0').addService(googletag.pubads());
...
function refreshBid() {
  ubpbjs.que.push(function() {
	  ubpbjs.requestBids({
		  ...
		  adUnitCodes: ['/22126273586/vaartha.in_ipl_320x50'],
...
function ub_checkAdRendered(){
	adId = 'div-gpt-ad-1632141759605-0';
