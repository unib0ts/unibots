...
function mobileCheck() {
  ...
  if (document.querySelector('#UB_300x250_1')) {
    document.querySelector('#UB_300x250_1').innerHTML = "<div id='div-gpt-ad-1639453275834-0'></div>";
  }
  if (document.querySelector('#UB_300x250_2')) {
    document.querySelector('#UB_300x250_2').innerHTML = "<div id='div-gpt-ad-1639453318591-0'></div>";
  }
    ...
    ubpbjs.que.push(function () {
      ...
      // });
        ...
        ubpbjs.setConfig({
            ...
            publisherDomain: "https://weloma.net/inhome",
...
var hb_full_common_bidders = [
    { bidder: "appnexus", params: { placementId: "23796970" } }, /* one placementId for all sizes  my appnexus bidder */,
    // { bidder: 'oftmedia', params: { placementId: '4168843' } },
    { bidder: '33across', params: { siteId : 'aNih_QyU4r7kjgrkHcnlKl', productId: 'siab' }, labelAll: ["US"] }, /*All sizes*/
...
var mappings_full_hb_config_desktop = {
    adUnitNames: [
        "/22126273586/weloma.net_pubfuture_300x250_1",
        "/22126273586/weloma.net_pubfuture_300x250_2"
    ],
    adId: [
          "div-gpt-ad-1639453275834-0", //'/22140546871/bongdaplus.vn_pc_balloon_hb_300x600'
          "div-gpt-ad-1639453318591-0" //'/22140546871/bongdaplus.vn_in-article_336x280',
    ],
    sizes: [
        [300, 250],
        [300, 250]
    ...
    bids: [
        hb_full_common_bidders.concat([
            ...
            // // // // //     {bidder: 'coinzilla', params: {placementId: '23945aaa6cfc06141'} },
                { bidder: 'sovrn', params: {tagid: '991139'} }
                // { bidder: 'oftmedia', params: { placementId: '4168843' } },
                  // { bidder: 'oftmedia', params: { placementId: '4168843' } },
        ...
        hb_full_common_bidders.concat([
            ...
            // // // // //     { bidder: "kubient", params: { zoneid: "0cef49235ab77", server: "kssp.kbntx.ch"} },
            // // // // //     {bidder: 'coinzilla', params: {placementId: '23945aaa6cfc06141'} },
                { bidder: 'sovrn', params: {tagid: '991140'} }
