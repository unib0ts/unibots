...
mybotspecialEvent = 0;
mybotMultiIconName = 'christmas/';
mybotMultiIconType = '.gif';
mybotMultiIconNumber = 20;

mybotProfileheight = 0;
mybotMultipleIconsStartepoch = 1577067478;
mybotMultipleIconsEndepoch = 1577298599;

mybotLoggedInUserName= false;
mybotSetUserName='';

mybotLoadAdDefault = 1;
mybotAuthEnabled = 0;
mybotClickLocation = '';
var botPosition = 'left';
var mybotClickCountEnabled = 1;
var mybotCloseEnabled = 0;

var myBotMenuCustomTopText='\u0d2e\u0d28\u0d4b\u0d30\u0d2e \u0d13\u0d7a\u0d32\u0d48\u0d7b \u0d35\u0d28\u0d3f\u0d24\u0d3e \u0d31\u0d3f\u0d2a\u0d4d\u0d2a\u0d4b\u0d7c\u0d1f\u0d4d\u0d1f\u0d3f\u0d32\u0d47\u0d15\u0d4d\u0d15\u0d4d \u0d38\u0d4d\u0d35\u0d3e\u0d17\u0d24\u0d02\u002e \u0d28\u0d3f\u0d19\u0d4d\u0d19\u0d7e\u0d15\u0d4d\u0d15\u0d4d \u0d07\u0d28\u0d4d\u0d28\u0d4d \u0d0f\u0d24\u0d4d \u0d24\u0d30\u0d02 \u0d05\u0d2a\u0d4d\u200c\u0d21\u0d47\u0d31\u0d4d\u0d31\u0d4d \u0d06\u0d35\u0d36\u0d4d\u0d2f\u0d2e\u0d3e\u0d23\u0d4d\u003f';
var myBotMenuCustomTopTextCats= '\u0d28\u0d3f\u0d19\u0d4d\u0d19\u0d7e\u0d15\u0d4d\u0d15\u0d4d \u0d24\u0d3f\u0d30\u0d1e\u0d4d\u0d1e\u0d46\u0d1f\u0d41\u0d15\u0d4d\u0d15\u0d3e\u0d28\u0d41\u0d33\u0d4d\u0d33 \u0d1a\u0d3f\u0d32 \u0d35\u0d3f\u0d2d\u0d3e\u0d17\u0d19\u0d4d\u0d19\u0d7e \u0d07\u0d24\u0d3e\u0021';
var mybotContextTitle = 'manoramaonlineshe';
var mybotSearchKey = 'AIzaSyACypoI-jiI9LnTHKy2-pEaURiB7QTw3VQ';
var mybotSearchcx = '004766516690456605208:wv6fxbukynd';
mybotLang = 'malayalam';
mybottlang = 'en';
botSearchDisplayText = '\u0d1e\u0d3e\u0d7b \u0d28\u0d3f\u0d19\u0d4d\u0d19\u0d7e\u0d15\u0d4d\u0d15\u0d3e\u0d2f\u0d3f \u0d15\u0d23\u0d4d\u0d1f\u0d46\u0d24\u0d4d\u0d24\u0d3f\u0d2f\u0d24\u0d4d \u0d07\u0d24\u0d3e\u0021';
botSearchDisplayTextNF = '\u0d06 \u0d1a\u0d4b\u0d26\u0d4d\u0d2f\u0d24\u0d4d\u0d24\u0d3f\u0d28\u0d4a\u0d2a\u0d4d\u0d2a\u0d02 \u0d1e\u0d19\u0d4d\u0d19\u0d7e\u0d15\u0d4d\u0d15\u0d4d \u0d12\u0d28\u0d4d\u0d28\u0d41\u0d02 \u0d15\u0d23\u0d4d\u0d1f\u0d46\u0d24\u0d4d\u0d24\u0d3e\u0d7b \u0d15\u0d34\u0d3f\u0d1e\u0d4d\u0d1e\u0d3f\u0d32\u0d4d\u0d32';
botSearchPlaceholder = '\u0d0e\u0d28\u0d4d\u0d28\u0d47\u0d3e\u0d1f\u0d4d \u0d0e\u0d28\u0d4d\u0d24\u0d41\u0d02 \u0d1a\u0d47\u0d3e\u0d26\u0d3f\u0d15\u0d4d\u0d15\u0d3e\u0d02\u002e\u002e\u002e';
botPosition = 'right';
imageSearchExp = 1;
mybotslickClose = 1;
mybotSearchSort = 'date';
...
mybotDisappearOnLoad = 1;
mybotSearchTitleField = 1;
mybotlinkAppend = '?utm_source=Unibots&utm_medium=Direct&utm_campaign=manoramaonlineshe';

mybotslickCloseText = "\u0d08 \u0d38\u0d4d\u0d32\u0d48\u0d21\u0d4d \u0d05\u0d1f\u0d2f\u0d4d\u200c\u0d15\u0d4d\u0d15\u0d41\u0d15";

mybotCat1 = '\u0d38\u0d4d\u0d24\u0d4d\u0d30\u0d40 \u0d35\u0d3e\u0d7c\u0d24\u0d4d\u0d24';
mybotCat2 = '\u0d1c\u0d4b\u0d32\u0d3f \u006e \u0d1c\u0d40\u0d35\u0d3f\u0d24\u0d02';
mybotCat3 = '\u0d2b\u0d3e\u0d2e\u0d3f\u0d32\u0d3f \u0d15\u0d4b\u0d7c\u0d23\u0d7c';
mybotCat4 = '\u0d05\u0d35\u0d7e \u0d32\u0d4b\u0d15\u0d02';
// mybotCat5 = '\u0d2c\u0d3e\u0d19\u0d4d\u0d15\u0d3f\u0d02\u0d17\u0d4d';
// mybotCat6 = '\u0d2c\u0d3f\u0d38\u0d3f\u0d28\u0d38\u0d4d\u0d38\u0d4d \u0034 \u0d28\u0d3f\u0d19\u0d4d\u0d19\u0d7e';
// mybotCatMore = '\u0d15\u0d42\u0d1f\u0d41\u0d24\u0d7d';

mybotGACode = 'UA-150843810-41';


function function1(){
openNewsCategoryWise('womennews',0,mybotLang,mybotCat1,mybotCat1);};
function function2(){
openNewsCategoryWise('worknlife',0,mybotLang,mybotCat2,mybotCat2);};
function function3(){
openNewsCategoryWise('familycorner',0,mybotLang,mybotCat3,mybotCat3);};
function function4(){
openNewsCategoryWise('sheworld',0,mybotLang,mybotCat4,mybotCat4);};
// function function5(){
// openNewsCategoryWise('banking',0,mybotLang,mybotCat5,mybotCat5);};
// function function6(){
// openNewsCategoryWise('business',0,mybotLang,mybotCat6,mybotCat6);};
// function function7(){
// changeNewsCategories();};

mybotBundle1 = '<div class="botSmartButton"><span class="botSmartButtonSpan" onclick="function1()">'+mybotCat1+'</span><span class="botSmartButtonSpan2" onclick="function2()">'+mybotCat2+'</span></div><div class="botSmartButton"><span class="botSmartButtonSpan" onclick="function3()">'+mybotCat3+'</span><span class="botSmartButtonSpan2" onclick="function4()">'+mybotCat4+'</span></div>';
...
mybotClosevar = '<img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/manoramaonlinesampadyam/close.svg">';
mybotCloseInVar = '<img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/manoramaonlinesampadyam/close.svg" style="width: 20px; display: block;">';

// mybotFace = '<img id="botfaceclosed" src="https://newsbot-images.s3.ap-south-1.amazonaws.com/MO/mano.gif" class="img-circle img-profile mybotimgprofile">';
//
// mybotFaceOpen = '<img id="botfaceopen" src="https://newsbot-images.s3.ap-south-1.amazonaws.com/MO/mano.gif" class="bot_p_img face">';

mybotFace = '<div class="mybotcard-container" id="botfaceclosed"><div class="card"><div class="front"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/manoramaonlinesampadyam/logo-01.svg" class="mybotimgprofile"></div><div class="back"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/manoramaonlinesampadyam/news-01.svg" class="mybotimgprofile"></div></div></div>';

mybotFaceOpen = '<div class="mybotcard-container bot_p_img" id="botfaceopen"><div class="card"><div class="front"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/manoramaonlinesampadyam/logo-01.svg"></div><div class="back"><img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots/manoramaonlinesampadyam/news-01.svg"></div></div></div>';
...
function callOnDocumentReady() {
	...
	if(typeof mybotMatchEnabled !== 'undefined' && mybotMatchEnabled ==1){
		...
		if(typeof mybotCloseInVar !== 'undefined'){
			...
			mybotClosevarIn = '<img src="https://api.warw.in/manoramaonlinesampadyam/img/close.svg" style="width: 20px; display: block;">';
		}
...
function mybotClickCount(count){
	if(mybotClickCountEnabled){
		...
		url = 'https://api.warw.in/manoramaonlinesampadyam/bot_open';
...
function botProfane(text, count, search, charCode) {
	...
	var request = new XMLHttpRequest();
	url = 'https://api.warw.in/manoramaonlinesampadyam/profane/'+text;
	request.open('GET', url, true);
	request.setRequestHeader('Auth-Token', AUTH_TOKEN);
	request.onload = function() {
		if (request.status >= 200 && request.status < 400) {
...
function mybotCategoryClickCount(title, count){
	...
	var request = new XMLHttpRequest();
	url = 'https://api.warw.in/manoramaonlinesampadyam/cat_click';
	request.open('POST', url, true);
	request.setRequestHeader('Auth-Token', AUTH_TOKEN);
...
function updateAuthToken(callback) {
	var request = new XMLHttpRequest();
	request.open('GET', 'https://api.warw.in/manoramaonlinesampadyam/get_token', true);
...
function openNewsCategoryWise(category, count, lang, buttonText, displayText) {
	...
	var request = new XMLHttpRequest();
	url = 'https://api.warw.in/manoramaonlinesampadyam/get_articles/'+cat;
	request.open('GET', url, true);
	request.setRequestHeader('Auth-Token', AUTH_TOKEN);
	request.onload = function() {
		if (request.status >= 200 && request.status < 400) {
			...
			if(data.error == true) {
				...
				for(var i=0; i<totalLength; i++) {
					...
					if(typeof noImageExp !== 'undefined' && noImageExp==1){
						...
						slideTrackBlockHTML = slideTrackBlockHTML.replace(/__IMAGE2__/g, '');
						slideTrackBlockHTML = slideTrackBlockHTML.replace(/__IMAGE__/g, image);
						slideTrackBlockHTML = slideTrackBlockHTML.replace(/__IMAGE__/g, thumbimg);
					}
...
function addReaction(position, reaction, count, skipRequest) {
	...
	if(skipRequest == false) {
		var request = new XMLHttpRequest();
		request.open('POST', 'https://api.warw.in/manoramaonlinesampadyam/add_reaction', true);
		request.setRequestHeader('Auth-Token', AUTH_TOKEN);
		request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		request.onload = function() {
			if (request.status >= 200 && request.status < 400) {
...
function mybotSearchStore(count, term){
	...
	var request = new XMLHttpRequest();
	url = 'https://api.warw.in/manoramaonlinesampadyam/search';
	request.open('POST', url, true);
	request.setRequestHeader('Auth-Token', AUTH_TOKEN);
	request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	request.onload = function() {
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/manoramaonlinesampadyam/fb_put_auth_token';
request.open('POST', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.withCredentials = true;
request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/manoramaonlinesampadyam/get_fb_details';
request.open('POST', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
request.onload = function() {
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/manoramaonlinesampadyam/get_fb_code';
request.open('POST', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
request.onload = function() {
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/manoramaonlinesampadyam/generate_quiz';
request.open('GET', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.withCredentials = true;
request.onload = function() {
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/manoramaonlinesampadyam/get_score';
request.open('POST', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.withCredentials = true;
request.setRequestHeader("Content-type", "application/json");
...
var request = new XMLHttpRequest();
url = 'https://api.warw.in/manoramaonlinesampadyam/leaderboard';
request.open('GET', url, true);
request.setRequestHeader('Auth-Token', AUTH_TOKEN);
request.withCredentials = true;
request.onload = function() {
...
function mybotClickCountPlayQuiz(count) {
  if(mybotClickCountEnabled){
		if(count >= 2) {
			return;
		}
		...
		var request = new XMLHttpRequest();
		url = 'https://api.warw.in/manoramaonlinesampadyam/bot_play_quiz';
		request.open('GET', url, true);
		request.setRequestHeader('Auth-Token', AUTH_TOKEN);
		request.onload = function() {
			if (request.status >= 200 && request.status < 400) {
...
function mybotClickCountFblogin(count) {
  if(mybotClickCountEnabled){
		...
		var request = new XMLHttpRequest();
		url = 'https://api.warw.in/manoramaonlinesampadyam/bot_fb_login';
		request.open('GET', url, true);
		request.setRequestHeader('Auth-Token', AUTH_TOKEN);
		request.onload = function() {
			if (request.status >= 200 && request.status < 400) {
...
function mybotClickCountStartQuiz(count) {
  if(mybotClickCountEnabled){
		...
		var request = new XMLHttpRequest();
		url = 'https://api.warw.in/manoramaonlinesampadyam/bot_start_quiz';
		request.open('GET', url, true);
		request.setRequestHeader('Auth-Token', AUTH_TOKEN);
		request.onload = function() {
			if (request.status >= 200 && request.status < 400) {
