  ...
  function initPlayer() {
    ...
    if(document.getElementById('unibots-video') || document.getElementById('unibots-video-sticky') || document.getElementById('unibots-video-homePC')){
        ...
        var adsArray = [
          {
            ads: [
              'https://pubads.g.doubleclick.net/gampad/ads?iu=/21928950349/amaze24x7_gpt1_preroll&description_url='+desc_url+'&tfcd=0&npa=0&sz=192x108%7C320x180%7C400x225%7C640x360&gdfp_req=1&output=xml_vast4&unviewed_position_start=1&env=vp&impl=s&vpos=preroll&hl=ben&adsafe=medium',
            ],
            type: 'preroll',
            delay: 1,
            src: 'gpt'
          ...
          {
            ads: [
              'https://pubads.g.doubleclick.net/gampad/ads?iu=/21928950349/amaze24x7_gpt2_preroll&description_url='+desc_url+'&tfcd=0&npa=0&sz=192x108%7C320x180%7C400x225%7C640x360&gdfp_req=1&output=xml_vast4&unviewed_position_start=1&env=vp&impl=s&vpos=preroll&hl=ben&adsafe=medium',
            ],
            type: 'preroll',
            delay: 5,
            src: 'adx'
          ...
          {
            ads: [
              'https://googleads.g.doubleclick.net/pagead/ads?client=ca-video-pub-2730263451308801&slotname=amaze24x7_adx1_preroll&ad_type=video&description_url='+desc_url+'&max_ad_duration=350000000&sdmax=350000000&videoad_start_delay=0&vpmute=0&vpa=auto&adsafe=medium&hl=ben',
            ],
            type: 'preroll',
            delay: 0,
            src: 'adx'
          ...
          {
            ads: [
              'https://googleads.g.doubleclick.net/pagead/ads?client=ca-video-pub-5200956238394958&slotname=amaze24x7_adx2_preroll&ad_type=video&description_url=' + desc_url + '&max_ad_duration=350000000&sdmax=350000000&videoad_start_delay=0&vpmute=0&vpa=auto&adsafe=medium&hl=ben',
            ],
            type: 'preroll',
            delay: 15,
            src: 'mixed'
