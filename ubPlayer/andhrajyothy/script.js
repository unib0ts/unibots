...
function initPlayer() {
  ...
  //  var isMobile = true;
      ...
      var myButton = ubPlayer.addChild("button");
      var myButtonDom = myButton.el();
      myButtonDom.classList.add = "vjs-customButton";
      myButtonDom.innerHTML = "Learn more";
  
      myButtonDom.onclick = function(){
        window.location.href = "https://unibots.in";
      }  
...
// function setLogo(){
//   let e = document.getElementById("ubVideo");
//   let i = document.createElement("a");
//   i.href = "https://unibots.in";
//   i.target = "_blank";
//   i.id = "ubp_banner_logo";
//   i.classList.add = "ubp_banner_logo";
//   i.innerHTML = '<img src="https://video.unibots.in/logo.svg" alt="Unibots.in" style="vertical-align:middle;height:11px">';
//   e.appendChild(i);
// }
