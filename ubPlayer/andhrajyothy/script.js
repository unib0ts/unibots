...
mybotBlockedUrl =
    "https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/ubvideoblocks/blocksAndhrajyothy.json";
...
function ubPlayer_scripts() {
    ...
    ubIma.onload = function () {
        ...
        // let target = document.body.querySelector('script[src="https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/ubPlayer/andhrajyothy/script.js"]').parentElement;
        // let z1 = document.createElement('div');
        // z1.id = 'unibots-video';
        // z1.innerHTML = myPlayer;
        // target.appendChild(z1);
    ...
    function initPlayer() {
        ...
        if (document.getElementById("unibots-video")) {
            ...
            ubPlayer.src({
                type: "video/mp4",
                src: "https://unibots.b-cdn.net/allegations_on_ap_financial_situation.mp4",
            });
            ...
            var imaOptions = {
                ...
                adTagUrl:
                    "https://video.unibots.in/clients/andhrajyothy/ads.xml",
