...
ubIma.onload = function () {
    ...
    let myPlayer =
        '<div id="ubVideo" class="ub-unloaded"><video id="content_video" class="video-js" controls="true" preload="auto"></video></div>';
...
function checkUnmutedAutoplaySupport() {
    canAutoplay.video({ timeout: 800, muted: false }).then(function (response) {
...
function checkMutedAutoplaySupport() {
    canAutoplay.video({ timeout: 800, muted: true }).then(function (response) {
        if (response.result === false) {
...
function initPlayer() {
    ...
    //  var isMobile = true;
    if (
        document.getElementById("unibots-video") ||
        document.getElementById("unibots-video-sticky") ||
        document.getElementById("unibots-video-mobile") ||
        document.getElementById("unibots-video-homePC")
    ) {
