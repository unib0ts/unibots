...
function showPlayer(){
  ...
  else if(document.getElementById('unibots-video-homePC')){
    document.getElementById("unibots-video-homePC").style.display = 'initial';
  }
  else if(document.getElementById("unibots-video-sticky")){
