...
let video_ub = () => {
    ...
    function initPlayer() {
        ...
        var imaOptions = {
            ...
            adTagUrl: "https://video.unibots.in/clients/businessworld/ads.xml",
...
window.ready(function () {
    ...
    var rule =
        "#videoBox{border:2px solid #212223;transition:0.5s}video{max-width:100%;vertical-align:bottom}#videoBox.ubsticky{position:fixed;bottom:0;right:0;width:400px;z-index:999;animation:an 0.8s}#ubVideo{border:4px solid #212223;transition:0.5s}.ubsticky{position:fixed;bottom:0;left:10px;width:400px;z-index:999;animation:an 0.8s}.video-js .vjs-control.vjs-close-button{right:-20px!important;top:-3em!important}.ub_player,#unibots-video{max-width:410px;margin:20px 0}.video-js .vjs-control.vjs-close-button .vjs-icon-placeholder:before,.vjs-icon-cancel:before{color:black!important}@media (max-width:481px){.ubsticky{width:256px!important}}";
