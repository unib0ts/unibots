...
loadDynamicStyles(
    "https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/ubPlayer/ub/css/videojs.css"
);
loadDynamicStyles(
...
ubIma.onload = function () {
    ...
    let myPlayer =
        '<div id="ubVideo" class="ub-unloaded"><video id="content_video" class="ub_video-js" playsinline controls="true" preload="auto"></video></div>';
    ...
    //   z1.innerHTML = '<div id="ubVideo ub-unloaded" class="ubsticky-left"><video id="content_video" class="ub_video-js" playsinline controls="true" preload="auto"></video></div>';
...
function initPlayer() {
    if (document.getElementById("unibots-video")) {
        ...
        ubPlayer.src({
            type: "video/mp4",
            src: "https://unibots.b-cdn.net/yoga.mp4",
        });

        if (
            window.location.href ==
            "https://docbao.vn/xa-hoi/trua-315-them-68-ca-mac-covid-19-bac-giang-va-bac-ninh-co-52-ca-tintuc761701"
        ) {
            xml_path = "https://video.unibots.in/clients/docbao/ads_normal.xml";
        } else {
            xml_path = "https://video.unibots.in/clients/docbao/ads.xml";
        }
...
function setLogo() {
    ...
    i.innerHTML =
        '<img src="https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/ubPlayer/ub/logo.svg" alt="Unibots.in" style="vertical-align:middle;height:11px">';
