...
function initPlayer() {
  ...
  if(document.getElementById('unibots-video')){
      ...
      ubPlayer.src({ type: "video/mp4", src: "https://video-library.s3.filebase.com/yoga.mp4"});
      ...
      if(!isMobile() && (window.screen.availWidth > 1024) && window.location.href != "https://docbao.vn/"){
          if(document.getElementById("unibots-video")){
