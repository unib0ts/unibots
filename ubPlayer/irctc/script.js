...
function load_player() {
    ...
    //for Sticky
    var myPlayer =
        '<div id="ubVideo" class="ubsticky"><a href="https://corover.ai/vlog" target="_blank"><video id="content_video" class="video-js" playsinline controls="true" preload="auto"></video></a></div>';
...
let video_ub = () => {
    ...
    function initPlayer() {
        ...
        ubPlayer.src({
            type: "video/mp4",
            src: "https://unibots.b-cdn.net/irctc.mp4",
        });
        ...
        video.onloadeddata = (event) => {
            document.getElementById("ubVideo").style.border =
                "4px solid #212223";
        };
...
window.ready(function () {
    ...
    var rule =
        "#videoBox{border:2px solid #212223;transition:0.5s}video{max-width:100%;vertical-align:bottom}#videoBox.ubsticky{position:fixed;bottom:0;right:0;width:400px;z-index:999;animation:an 0.8s}#ubVideo{transition:0.5s}.ubsticky{position:fixed;bottom:0;right:10px;width:320px;z-index:999999;animation:an 0.8s}.stikcy-out{max-width:640px}.video-js .vjs-control.vjs-close-button{right:-22px!important;top:-3em!important}.ub_player,#unibots-video{max-width:320px;margin:20px 0}.video-js .vjs-control.vjs-close-button .vjs-icon-placeholder:before,.vjs-icon-cancel:before{color:black!important}@media (max-width:481px){.ubsticky{width:320px!important}}";
