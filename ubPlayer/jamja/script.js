...
function initPlayer() {
    ...
    if (document.getElementById("unibots-video")) {
        ...
        var imaOptions = {
            ...
            adTagUrl: "https://video.unibots.in/clients/jamja/ads.xml",
