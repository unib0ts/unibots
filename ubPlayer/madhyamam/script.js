...
ubIma.onload = function () {
    ...
    let myPlayer =
        '<div id="ubVideo" class="ub-unloaded"><video id="content_video" class="video-js" playsinline controls="true" preload="auto"></video></div>';
...
var ubPlayer_src = [
    "https://unibots.b-cdn.net/madhyamam_2.mp4",
    "https://unibots.b-cdn.net/madhyamam_3.mp4",
    "https://unibots.b-cdn.net/madhyamam_4.mp4",
];
...
function initPlayer() {
    ...
    if (document.getElementById("unibots-video")) {
        ...
        var SbButton = videojs.extend(button, {
            ...
            handleClick: function () {
                window.open(
                    "https://www.youtube.com/channel/UCYMKYAtH2zhXgaCwYEmQE6A",
                    "_blank"
                );
            },
        });
        ...
        if (!isMobile()) {
            ...
            window.addEventListener("scroll", function () {
                ...
                if (isInViewport(currentPlayer)) {
                    ...
                    if (
                        !targetDiv.classList.contains("ubsticky") &&
                        Inread_view > 1
                    ) {
...
window.ready(function () {
    ...
    var rule =
        'video{max-width:100%;vertical-align:bottom}.ub-unloaded{display:none}.ub-loaded{display:flex;justify-content:center}.ubsticky{position:fixed;bottom:0;left:10px;z-index:999;animation:an 0.8s}.video-js .vjs-control.vjs-close-button{right:-19px!important;top:-28px!important}#unibots-video{margin:35px 0;justify-content:center;display:flex}.video-js .vjs-control.vjs-close-button .vjs-icon-placeholder:before,.vjs-icon-cancel:before{color:black!important}#ubp_logo{background:#fff;position:absolute;padding:2px 5px 2px 5px;right:0px!important;bottom:45px!important;width:40px!important;border-top-left-radius:8px;border-bottom-left-radius:8px;transition:bottom 0.4s ease-in-out;height:11px!important;font-size:10px;box-sizing:content-box!important;line-height:11px!important}#ubp_logo img{margin:-3px 0 0 0px!important;box-shadow:none!important;border-radius:0px!important;padding:0px!important;width:100%!important;height:11px!important;object-fit:unset!important;border:none!important}.ubp-cbutton::before{content:"Subscribe"}.ubp-cbutton{height:30px!important;border:solid 1px;width:26%!important;background-image:-webkit-linear-gradient(top,rgba(0,0,0,.8),rgba(0,0,0,.7) 40%,rgba(0,0,0,0) 99%)!important;color:#fff!important;cursor:pointer!important;display:inline-block!important;font-family:arial,sans-serif!important;font-weight:normal!important;font-size:14px!important;line-height:normal!important;padding:5px!important;top:0}@media (max-width:319){.ubsticky .content_video-dimensions{width:320px!important;height:180px!important}}@media only screen and (min-width:320px) and (max-width:399px){.ubsticky .content_video-dimensions{width:320px!important;height:180px!important}}@media only screen and (min-width:400px) and (max-width:426px){.ubsticky .content_video-dimensions{width:320px!important;height:180px!important}}@media only screen and (min-width:427px) and (max-width:639px){.ubsticky .content_video-dimensions{width:320px!important;height:180px!important}}@media (min-width:640px){.ubsticky .content_video-dimensions{width:320px!important;height:180px!important}}#unibots-video,#unibots-video *{font-family:"VideoJS"!important}#unibots-video div{margin-bottom:0px!important;color:#fff;font-size:12px;line-height:1}#unibots-video iframe{background:transparent!important}#unibots-video .ima-play-pause-div,#unibots-video .ima-mute-div,#unibots-video .ima-slider-div,#unibots-video .ima-fullscreen-div{font-size:1.5em;line-height:2}#unibots-video .vjs-time-control{font-size:1em;line-height:3em}';
