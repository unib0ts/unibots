...
mybotBlockedUrl = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/blocks/blocksNewzverse.json';
...
function ubPlayer_scripts() {
  ...
  function initPlayer() {
    ...
    if(document.getElementById('unibots-video')){
        ...
        ubPlayer.src({ type: "video/mp4", src: "https://video-library.s3.filebase.com/solo_trip.mp4"});
