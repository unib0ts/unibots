...
function initPlayer() {
  ...
  if(document.getElementById('unibots-video')){
      ...
      var adsArray = [
        ...
        {
          ads: [
            'https://pubads.g.doubleclick.net/gampad/ads?iu=/21928950349/bongtrend_gpt2_preroll&description_url=' + desc_url + '&tfcd=0&npa=0&sz=344x258%7C400x225%7C640x360&gdfp_req=1&output=xml_vast4&unviewed_position_start=1&env=vp&impl=s&vpos=preroll',
          ],
          type: 'preroll',
          delay: 5,
          src: 'adx'
