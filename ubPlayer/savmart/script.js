...
ubIma.onload = function () {
    ...
    let myPlayer = isMobile()
        ? '<div id="ubVideo" class="ub-unloaded"><video id="content_video" class="video-js" playsinline controls="true" preload="auto"></video></div>'
        : '<div id="ubVideo" class="ub-unloaded ubsticky"><video id="content_video" class="video-js" playsinline controls="true" preload="auto"></video></div>';
...
function initPlayer() {
    ...
    if (document.getElementById("unibots-video")) {
        ...
        ubPlayer.src({
            type: "video/mp4",
            src: "https://unibots.b-cdn.net/unibots_2.mp4",
        });

        var imaOptions = {
            id: "content_video",
            // adTagUrl: 'http://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/124319096/external/ad_rule_samples&ciu_szs=300x250&ad_rule=1&impl=s&gdfp_req=1&env=vp&output=xml_vmap1&unviewed_position_start=1&cust_params=sample_ar%3Dpremidpostpod%26deployment%3Dgmf-js&cmsid=496&vid=short_onecue&correlator=',
            adTagUrl: "https://video.unibots.in/clients/savmart/ads.xml",
...
window.ready(function () {
    ...
    var rule =
        'video{max-width:100%;vertical-align:bottom}.ub-unloaded{display:none}.ub-loaded{display:flex;justify-content:center}.ubsticky{position:fixed;bottom:0;right:5px;z-index:999;animation:an 0.8s}.video-js .vjs-control.vjs-close-button{right:-17px!important;top:-27px!important}#unibots-video{margin:35px 0}#ubVideo .content_video-dimensions{width:400px!important;height:225px!important}.video-js .vjs-control.vjs-close-button .vjs-icon-placeholder:before,.vjs-icon-cancel:before{color:black!important;font-size:20px!important}#ubp_logo{background:#fff;position:absolute;padding:3px 5px 2px 5px;right:0px!important;bottom:35px!important;width:40px!important;border-top-left-radius:8px;border-bottom-left-radius:8px;transition:bottom 0.4s ease-in-out;height:11px!important;font-size:10px;box-sizing:content-box!important;line-height:11px!important}#ubp_logo img{margin:0px!important;box-shadow:none!important;border-radius:0px!important;padding:0px!important;width:100%!important;height:11px!important;object-fit:unset!important;border:none!important}.vjs-customButton::before{content:"Subscribe"}.vjs-customButton{height:30px!important;border:solid 1px;width:26%!important;background-image:-webkit-linear-gradient(top,rgba(0,0,0,.8),rgba(0,0,0,.7) 40%,rgba(0,0,0,0) 99%)!important;color:#fff!important;cursor:pointer!important;display:inline-block!important;font-family:arial,sans-serif!important;font-weight:normal!important;font-size:14px!important;line-height:normal!important;padding:5px!important}@media (max-width:481px){#ubVideo{width:320px!important;height:180px!important}#ubVideo .content_video-dimensions{width:320px!important;height:180px!important}#unibots-video{display:flex;justify-content:center}}#unibots-video div{font-family:"VideoJS"!important;margin-bottom:0px!important}';
