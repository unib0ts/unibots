...
mybotBlockedUrl =
    "https://cdn.jsdelivr.net/gh/unib0ts/unibots@latest/main/ubvideoblocks/blocksTechz.json";
mybotBlockedClientName = "techz";

if (
    typeof mybotBlockedPagesFlag !== "undefined" &&
    mybotBlockedPagesFlag == 1
) {
    urlToCheck =
    ...
    function initPlayer() {
        if (document.getElementById("unibots-video")) {
            ...
            var imaOptions = {
                ...
                adTagUrl: "https://video.unibots.in/clients/techz/ads.xml",
