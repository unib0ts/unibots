var ub_interval_plyr_check = setInterval(() => {
  if (document.getElementById("unibots-video")) {
    ...
    myub_obj.id = "div-ub-tinmoi";

    clearInterval(ub_interval_plyr_check);
    if (document.getElementById("div-ub-tinmoi")) {
      ...
      ub_plyerinlineScript = document.createTextNode("window.unibots = window.unibots || { cmd: [] }; unibots.cmd.push(function(){unibotsPlayer('tinmoi');})");
