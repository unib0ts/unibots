...
function initPlayer() {
  ...
  if(document.getElementById('unibots-video')){
      ...
      var adsArray = [
        {
          ads: [
            'https://pubads.g.doubleclick.net/gampad/ads?iu=/22082859479/vtvgujarati_preroll_gpt1&description_url='+desc_url+'&tfcd=0&npa=0&sz=320x180%7C368x207%7C640x360%7C192x108&gdfp_req=1&output=xml_vast4&unviewed_position_start=1&env=vp&impl=s&vpos=preroll',
          ],
          type: 'preroll',
          delay: 1,
          src: 'gpt'
        ...
        {
          ads: [
            'https://pubads.g.doubleclick.net/gampad/ads?iu=/22082859479/vtvgujarati_preroll_gpt2&description_url=' + desc_url + '&tfcd=0&npa=0&sz=320x180%7C368x207%7C640x360%7C192x108&gdfp_req=1&output=xml_vast4&unviewed_position_start=1&env=vp&impl=s&vpos=preroll',
          ],
          type: 'preroll',
          delay: 5,
          src: 'adx'
        ...
        {
          ads: [
            'https://googleads.g.doubleclick.net/pagead/ads?client=ca-video-pub-5200956238394958&slotname=vtvgujarati_preroll_adx1&ad_type=video&description_url=' + desc_url + '&max_ad_duration=350000000&sdmax=350000000&videoad_start_delay=0&vpmute=0&vpa=auto&adsafe=medium&hl=ben',
          ],
          type: 'preroll',
          delay: 0,
          src: 'adx'
        ...
        {
          ads: [
            'https://googleads.g.doubleclick.net/pagead/ads?client=ca-video-pub-5200956238394958&slotname=vtvgujarati_preroll_adx2&ad_type=video&description_url=' + desc_url + '&max_ad_duration=350000000&sdmax=350000000&videoad_start_delay=0&vpmute=0&vpa=auto&adsafe=medium&hl=vn',
          ],
          type: 'preroll',
          delay: 15,
          src: 'mixed'
      ...
      //   playerandAdsShouldRuninViewport(true);
