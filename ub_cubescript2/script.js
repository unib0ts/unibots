...
function mybotCustomFunction() {
  ...
  // for (let i = 2; i < 4; i++) {
    ...
    ub_passback.src = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/abplive/image02.png';
    ub_passback.style = "width: 150px; height:150px;";
    ub_sticky = document.querySelector('.ub-roller2');
    ub_sticky.appendChild(ub_passback);
  // }

    if (window.location.hostname == "www.abplive.com" || window.location.hostname == "news.abplive.com") {
        ub_passback = document.createElement("img");
        ub_passback.src = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/abplive/image01.png';
        ub_passback.style = "width: 150px; height:150px;";
        ub_sticky = document.querySelector('.ub-roller1');
        ub_sticky.appendChild(ub_passback);

        document.querySelector('.ub-roller1').addEventListener('click', function() {
           if(mybotDragClick == false){
               window.open('https://www.youtube.com/channel/UC5ebo42ydvAayGn2Z4Lf9XA?sub_confirmation=1', '_blank');
           }
           setTimeout(function(){
    ...
    document.querySelector('.ub-roller2').addEventListener('click', function() {
       if(mybotDragClick == false){
         if (window.location.hostname == "tamil.abplive.com") {
           if (ub_iOS()) {
              window.open('https://apps.apple.com/in/app/abp-nadu-tamil-news/id1561962964', '_blank');
           }else {
             window.open('https://play.google.com/store/apps/details?id=com.abp.tamil', '_blank');
           }
         }else if (window.location.hostname == "telugu.abplive.com") {
           if (ub_iOS()) {
              window.open('https://apps.apple.com/in/app/abp-desam/id1572389100', '_blank');
           }else {
             window.open('https://play.google.com/store/apps/details?id=com.abp.telugu', '_blank');
           }
         }else {
           if (ub_iOS()) {
              window.open('https://apps.apple.com/in/app/abp-live-news/id811114904', '_blank');
           }else {
             window.open('https://play.google.com/store/apps/details?id=com.winit.starnews.hin', '_blank');
           }
         }
       }
       setTimeout(function(){
    ...
    document.querySelector('.ub-roller3').addEventListener('click', function() {
       if(mybotDragClick == false){
             ub_passback = document.createElement("img");
             ub_passback.style = "width: 150px; height:150px;";
             ub_sticky = document.querySelector('.ub-roller3');

             if (window.location.hostname == "www.abplive.com" || window.location.hostname == "localhost"){
                 ub_passback.src = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/abplive/hindi_abp.png';
                 ub_sticky.appendChild(ub_passback);

                window.open('https://www.youtube.com/c/abpnews', '_blank');
             }else if (window.location.hostname == "news.abplive.com") {
               ub_passback.src = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/abplive/news_abp.png';
               ub_sticky.appendChild(ub_passback);
                window.open('https://www.youtube.com/c/abpnews', '_blank');
             }
             else if (window.location.hostname == "punjabi.abplive.com") {
               ub_passback.src = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/abplive/punjabi_abp.png';
               ub_sticky.appendChild(ub_passback);
                window.open('https://www.youtube.com/c/abpsanjha', '_blank');
             }
             else if (window.location.hostname == "gujarati.abplive.com") {
               ub_passback.src = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/abplive/gujarati_abp.png';
               ub_sticky.appendChild(ub_passback);
                 window.open('https://www.youtube.com/c/ABPAsmitaTV', '_blank');
             }
             else if (window.location.hostname == "bengali.abplive.com") {
               ub_passback.src = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/abplive/bengali_abp.png';
               ub_sticky.appendChild(ub_passback);
                window.open('https://www.youtube.com/c/abpanandatv', '_blank');
             }
             else if (window.location.hostname == "marathi.abplive.com") {
               ub_passback.src = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/abplive/marathi_abp.png';
               ub_sticky.appendChild(ub_passback);
                window.open('https://www.youtube.com/c/abpmajhatv', '_blank');
             }
             else if (window.location.hostname == "tamil.abplive.com") {
               ub_passback.src = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/abplive/tamil_abp.png';
               ub_sticky.appendChild(ub_passback);
                 window.open('https://www.youtube.com/c/abpnadu', '_blank');
             }
             else if (window.location.hostname == "telugu.abplive.com") {
               ub_passback.src = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/abplive/telugu_abp.png';
               ub_sticky.appendChild(ub_passback);
                 window.open('https://www.youtube.com/c/abpdesam/', '_blank');
             }
             else if (window.location.href.split('https://www.abplive.com/states/up-uk').length == 2) {
               ub_passback.src = 'https://cdn.jsdelivr.net/gh/unib0ts/unibots/main/abplive/up_abp.png';
               ub_sticky.appendChild(ub_passback);

                 window.open('https://www.youtube.com/c/ABPGanga', '_blank');
             }
       }
       setTimeout(function(){
        mybotDragClick = false;
    ...
    // document.querySelector('.ub-roller4').addEventListener('click', function() {
    //    if(mybotDragClick == false){
    //        window.open('https://news.abplive.com/sports/cricket', '_blank');
    //    }
    //    setTimeout(function(){
    //     mybotDragClick = false;
    //    }, 200);
    ...
    // document.querySelector('#ub-banner-ad').addEventListener('click', function() {
    //    if(mybotDragClick == false){
    //        window.open('https://unibots.in/', '_blank');
    //    }
    //    setTimeout(function(){
    //     mybotDragClick = false;
    //    }, 200);
...
function ready(fn){if(document.readyState!='loading'){fn();}else if(document.addEventListener){document.addEventListener('DOMContentLoaded',fn);}else{document.attachEvent('onreadystatechange',function(){if(document.readyState!='loading');fn();});}}window.ready(function(){var html='<mybot> <div id="gabywa"></div> <div class="ub-roller-wrapper" id="ub-roller-wrapper"> <div class="ub-close" id="ub-close"> </div> <div class="ub-banner-ad" id="ub-banner-ad">  </div> <div class="ub-roller" id="ub-roller"> <div class="ub-roller1 ub-ur"> </div> <div class="ub-roller2 ub-ur"> </div> <div class="ub-roller3 ub-ur"> </div> <div class="ub-roller4 ub-ur"> <div class="ub_teamimages"> <span class="team1img"> <img src="https://flagcdn.com/32x24/in.png" alt=""> </span> <span class="ub_vstag">VS</span> <span class="team2img"> <img src="https://flagcdn.com/32x24/nz.png" alt=""> </span> </div> <div class="ub_heading" id="ub-crick-heading"> <div class="summaryText"> <div class="row1"> IND </div> <div class="t1inn1 summarydetail"> 325 </div> <div class="t1inn2 summarydetail"> 276/7d </div> </div> <div class="inningnum"> <br> <span>1st</span> <span>2nd</span> </div> <div class="summaryText"> <div class="row2"> NZ </div> <div class="t2inn1 summarydetail"> 62 </div> <div class="t2inn2 summarydetail"> 167 </div> </div> </div> <div class="summaryText3UCB" id="botSummary"> India won by 372 runs </div> </div> </div> <div class="ub-sticky-ad" id="adsmall"> </div> </div></mybot>';var element=document.querySelector('body');var child=document.createElement('div');child.innerHTML=html;element.appendChild(child);var rule='mybot .ub-roller{transform-origin:70px 0 0px!important}mybot .ub-roller1{background-color:#fff;border-radius:10px;box-shadow:inset 0 0 15px grey;transform:translateZ(70px)!important}.ub-roller4>div{margin:6px;text-align:center}mybot .summaryText{display:flex;flex-direction:column;justify-content:center}mybot .summarydetail{padding:0 10px;font-size:16px;font-weight:600}mybot .ub_heading{font-weight:600;display:flex;flex-direction:row;line-height:18px;font-size:16px}mybot .ub_vstag{font-weight:600}mybot .ub_teamimages{word-spacing:8px}mybot .summaryText1UCB{font-weight:600;font-size:15px}mybot .summaryText2UCB{font-weight:600;font-size:15px}mybot .summaryText3UCB{line-height:16px;font-size:15px}mybot .ub-roller2{background-color:#fff;border-radius:10px;box-shadow:inset 0 0 15px grey;transform:rotateY(90deg) translateZ(70px)!important}mybot .ub-roller3{background-color:#fff;border-radius:10px;box-shadow:inset 0 0 15px grey;transform:rotateY(180deg) translateZ(70px)!important}mybot .ub-roller4{background-color:#fff;border-radius:10px;box-shadow:inset 0 0 15px grey;display:flex;flex-direction:column;transform:rotateY(270deg) translateZ(70px)!important}mybot .ub-roller-wrapper{transform:scale(.8)}@media screen and (max-width:635px){mybot .ub-roller-wrapper{transform:scale(.6)}}';var rule_common='@import url(https://fonts.googleapis.com/css2?family=Montserrat&display=swap);@import url(https://fonts.googleapis.com/css?family=Helvetica);mybot .ub-roller-wrapper{width:150px;height:150px;bottom:60px;left:5px;margin:auto;position:fixed;z-index:2147483640}mybot .ub-ur{cursor:pointer;pointer-events:all;position:absolute;width:150px;height:150px}mybot .ub-roller{animation-name:ub-roller;animation-timing-function:ease-in-out;animation-iteration-count:infinite;animation-duration:20s;transform-style:preserve-3d;-webkit-perspective:30000;-moz-perspective:30000;-ms-perspective:30000;perspective:30000;-webkit-box-shadow:0 0 20px 0 rgba(0,0,0,.25);-moz-box-shadow:0 0 20px 0 rgba(0,0,0,.25);box-shadow:0 0 20px 0 rgba(0,0,0,.75);transform-origin:75px 0 0}mybot .ub-roller1{backface-visibility:hidden;transform:translateZ(75px);background-size:150px}mybot .ub-roller2{backface-visibility:hidden;transform:rotateY(90deg) translateZ(75px);background-size:150px}mybot .ub-roller3{backface-visibility:hidden;transform:rotateY(180deg) translateZ(75px);background-size:150px}mybot .ub-roller4{backface-visibility:hidden;transform:rotateY(270deg) translateZ(75px);background-size:150px}@keyframes ub-roller{0%{transform:rotateY(0deg)}18%{transform:rotateY(0deg)}25%{transform:rotateY(-90deg)}42%{transform:rotateY(-90deg)}50%{transform:rotateY(-180deg)}68%{transform:rotateY(-180deg)}75%{transform:rotateY(-270deg)}93%{transform:rotateY(-270deg)}100%{transform:rotateY(-360deg)}}mybot .ub-banner-ad{pointer-events:all;cursor:pointer;color:#fff;line-height:11px;border-radius:5px;font-size:10px;width:130px;position:absolute;top:-15px;text-align:center;right:18px;background-repeat:no-repeat;background-position:center;background-color:#17479e}mybot .ub-close{pointer-events:all;cursor:pointer;width:16px;position:absolute;top:-24px;right:-10px}mybot .ub-sticky-ad{position:fixed;bottom:0}';var css=document.createElement('style');css.type='text/css';if(css.styleSheet){css.styleSheet.cssText=rule+rule_common;}else{css.appendChild(document.createTextNode(rule));css.appendChild(document.createTextNode(rule_common));}document.getElementsByTagName('head')[0].appendChild(css);callOnDocumentReadyCube();});